...
(let _161_25 = (FStar_All.pipe_right tys (FStar_List.map (fun _65_52 -> (match (_65_52) with
| (x, _65_51) -> begin
x
end))))
in (FStar_All.pipe_right _161_25 (FStar_Util.for_some (fun _65_1 -> (match (_65_1) with
