...
let args_to_string = (fun args -> (let _152_137 = (FStar_All.pipe_right args (FStar_List.map (fun _56_116 -> (match (_56_116) with
| (x, _56_115) -> begin
...
in {attempting = _152_152; wl_deferred = _56_127.wl_deferred; ctr = _56_127.ctr; defer_ok = false; smt_ok = _56_127.smt_ok; tcenv = _56_127.tcenv})))
...
in (let _152_209 = (new_uvar FStar_Range.dummyRange scope FStar_Syntax_Util.ktype0)
...
in (let _152_219 = (next_pid ())
in (let _152_218 = (new_uvar FStar_Range.dummyRange scope FStar_Syntax_Util.ktype0)
in {FStar_TypeChecker_Common.pid = _152_219; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = _152_218; FStar_TypeChecker_Common.scope = scope; FStar_TypeChecker_Common.reason = (reason)::[]; FStar_TypeChecker_Common.loc = loc; FStar_TypeChecker_Common.rank = None}))))


let problem_using_guard = (fun orig lhs rel rhs elt reason -> (let _152_226 = (next_pid ())
in {FStar_TypeChecker_Common.pid = _152_226; FStar_TypeChecker_Common.lhs = lhs; FStar_TypeChecker_Common.relation = rel; FStar_TypeChecker_Common.rhs = rhs; FStar_TypeChecker_Common.element = elt; FStar_TypeChecker_Common.logical_guard = (p_guard orig); FStar_TypeChecker_Common.scope = (p_scope orig); FStar_TypeChecker_Common.reason = (reason)::(p_reason orig); FStar_TypeChecker_Common.loc = (p_loc orig); FStar_TypeChecker_Common.rank = None}))
...
(let _152_238 = (FStar_All.pipe_left FStar_Range.string_of_range (p_loc d))
in (let _152_237 = (prob_to_string env d)
in (let _152_236 = (FStar_All.pipe_right (p_reason d) (FStar_String.concat "\n\t>"))
in (FStar_Util.format4 "(%s) Failed to solve the sub-problem\n%s\nWhich arose because:\n\t%s\nFailed because:%s\n" _152_238 _152_237 _152_236 s))))
end else begin
(
...
(let _152_240 = (FStar_TypeChecker_Normalize.term_to_string env tp.FStar_TypeChecker_Common.lhs)
in (let _152_239 = (FStar_TypeChecker_Normalize.term_to_string env tp.FStar_TypeChecker_Common.rhs)
in ((_152_240), (_152_239))))
end
| FStar_TypeChecker_Common.CProb (cp) -> begin
(let _152_242 = (FStar_TypeChecker_Normalize.comp_to_string env cp.FStar_TypeChecker_Common.lhs)
in (let _152_241 = (FStar_TypeChecker_Normalize.comp_to_string env cp.FStar_TypeChecker_Common.rhs)
...
let whnf : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _152_261 = (let _152_260 = (FStar_Syntax_Util.unmeta t)
in (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.WHNF)::[]) env _152_260))
in (FStar_Syntax_Subst.compress _152_261)))


let sn : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun env t -> (let _152_266 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env t)
in (FStar_Syntax_Subst.compress _152_266)))


let norm_arg = (fun env t -> (let _152_269 = (sn env (Prims.fst t))
in ((_152_269), ((Prims.snd t)))))
...
let _56_294 = x
in (let _152_275 = (sn env x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _56_294.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_294.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _152_275}))
in ((_152_276), (imp)))
end)))))
...
(let _152_283 = (aux u)
in FStar_Syntax_Syntax.U_succ (_152_283))
end
| FStar_Syntax_Syntax.U_max (us) -> begin
(let _152_284 = (FStar_List.map aux us)
in FStar_Syntax_Syntax.U_max (_152_284))
end
| _56_306 -> begin
u
end)))
in (let _152_285 = (aux u)
in (FStar_TypeChecker_Normalize.normalize_universe wl.tcenv _152_285))))
...
| tt -> begin
(let _152_299 = (let _152_298 = (FStar_Syntax_Print.term_to_string tt)
in (let _152_297 = (FStar_Syntax_Print.tag_of_term tt)
in (FStar_Util.format2 "impossible: Got %s ... %s\n" _152_298 _152_297)))
in (FStar_All.failwith _152_299))
end)
end
end
...
in (match ((let _152_300 = (FStar_Syntax_Subst.compress t1')
...
(let _152_303 = (let _152_302 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_301 = (FStar_Syntax_Print.tag_of_term t1)
in (FStar_Util.format2 "impossible (outer): Got %s ... %s\n" _152_302 _152_301)))
in (FStar_All.failwith _152_303))
end))
in (let _152_304 = (whnf env t1)
in (aux false _152_304))))


let unrefine : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ = (fun env t -> (let _152_309 = (base_and_refinement env (empty_worklist env) t)
in (FStar_All.pipe_right _152_309 Prims.fst)))


let trivial_refinement : FStar_Syntax_Syntax.term  ->  (FStar_Syntax_Syntax.bv * FStar_Syntax_Syntax.term) = (fun t -> (let _152_312 = (FStar_Syntax_Syntax.null_bv t)
in ((_152_312), (FStar_Syntax_Util.t_true))))
...
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _152_325 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _152_324 = (let _152_321 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (FStar_Syntax_Print.term_to_string _152_321))
in (let _152_323 = (let _152_322 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Syntax_Print.term_to_string _152_322))
in (FStar_Util.format4 "%s: %s  (%s)  %s" _152_325 _152_324 (rel_to_string p.FStar_TypeChecker_Common.relation) _152_323))))
end
| FStar_TypeChecker_Common.CProb (p) -> begin
(let _152_328 = (FStar_Util.string_of_int p.FStar_TypeChecker_Common.pid)
in (let _152_327 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _152_326 = (FStar_TypeChecker_Normalize.comp_to_string wl.tcenv p.FStar_TypeChecker_Common.rhs)
in (FStar_Util.format4 "%s: %s  (%s)  %s" _152_328 _152_327 (rel_to_string p.FStar_TypeChecker_Common.relation) _152_326))))
end))


let wl_to_string : worklist  ->  Prims.string = (fun wl -> (let _152_334 = (let _152_333 = (let _152_332 = (FStar_All.pipe_right wl.wl_deferred (FStar_List.map (fun _56_422 -> (match (_56_422) with
| (_56_418, _56_420, x) -> begin
x
end))))
in (FStar_List.append wl.attempting _152_332))
in (FStar_List.map (wl_prob_to_string wl) _152_333))
in (FStar_All.pipe_right _152_334 (FStar_String.concat "\n\t"))))
...
let _56_443 = (match ((let _152_341 = (FStar_Syntax_Subst.compress k)
in _152_341.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_arrow (bs, c) -> begin
if ((FStar_List.length bs) = (FStar_List.length ys)) then begin
(let _152_342 = (FStar_Syntax_Subst.open_comp bs c)
in ((((ys), (t))), (_152_342)))
end else begin
(
...
| (ys', t, _56_433) -> begin
(let _152_343 = (FStar_Syntax_Util.arrow_formals_comp k)
in (((((FStar_List.append ys ys')), (t))), (_152_343)))
end))
end
end
| _56_436 -> begin
(let _152_345 = (let _152_344 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_152_344)))
in ((((ys), (t))), (_152_345)))
end)
...
let c = (let _152_346 = (FStar_Syntax_Util.rename_binders xs ys)
in (FStar_Syntax_Subst.subst_comp _152_346 c))
in (let _152_350 = (let _152_349 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _152_347 -> FStar_Util.Inl (_152_347)))
in (FStar_All.pipe_right _152_349 (fun _152_348 -> Some (_152_348))))
in (FStar_Syntax_Util.abs ys t _152_350)))
end
end)))
...
let _56_468 = (match ((let _152_361 = (FStar_Syntax_Subst.compress uv)
in _152_361.FStar_Syntax_Syntax.n)) with
...
(let _152_364 = (FStar_Util.string_of_int (p_pid prob))
in (let _152_363 = (FStar_Syntax_Print.term_to_string uv)
in (let _152_362 = (FStar_Syntax_Print.term_to_string phi)
in (FStar_Util.print3 "Solving %s (%s) with formula %s\n" _152_364 _152_363 _152_362))))
end else begin
()
end
...
(let _152_373 = (FStar_Util.string_of_int pid)
in (let _152_372 = (let _152_371 = (FStar_List.map (uvi_to_string wl.tcenv) sol)
in (FStar_All.pipe_right _152_371 (FStar_String.concat ", ")))
...
(let _152_386 = (FStar_Syntax_Util.mk_conj t f)
in Some (_152_386))
end))
in (

let _56_503 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug wl.tcenv) (FStar_Options.Other ("RelCheck"))) then begin
(let _152_389 = (FStar_All.pipe_left FStar_Util.string_of_int (p_pid prob))
in (let _152_388 = (let _152_387 = (FStar_List.map (uvi_to_string wl.tcenv) uvis)
in (FStar_All.pipe_right _152_387 (FStar_String.concat ", ")))
in (FStar_Util.print2 "Solving %s: with %s\n" _152_389 _152_388)))
end else begin
()
end
...
let rec occurs = (fun wl uk t -> (let _152_399 = (let _152_397 = (FStar_Syntax_Free.uvars t)
in (FStar_All.pipe_right _152_397 FStar_Util.set_elements))
in (FStar_All.pipe_right _152_399 (FStar_Util.for_some (fun _56_512 -> (match (_56_512) with
| (uv, _56_511) -> begin
...
(let _152_406 = (let _152_405 = (FStar_Syntax_Print.uvar_to_string (Prims.fst uk))
in (let _152_404 = (FStar_Syntax_Print.term_to_string t)
in (FStar_Util.format2 "occurs-check failed (%s occurs in %s)" _152_405 _152_404)))
in Some (_152_406))
end
in ((occurs_ok), (msg)))))
...
| (occurs_ok, msg) -> begin
(let _152_412 = (FStar_Util.set_is_subset_of fvs_t fvs)
in ((occurs_ok), (_152_412), (((msg), (fvs), (fvs_t)))))
end))))
...
if (let _152_421 = (FStar_Util.set_mem x v1_set)
in (FStar_All.pipe_left Prims.op_Negation _152_421)) then begin
((isect), (isect_set))
end else begin
(
...
(let _152_422 = (FStar_Util.set_add x isect_set)
in (((((x), (imp)))::isect), (_152_422)))
end else begin
((isect), (isect_set))
end)
end
...
(let _152_437 = (FStar_All.pipe_left FStar_Syntax_Print.term_to_string (Prims.fst hd))
...
let is_flex : FStar_Syntax_Syntax.term  ->  Prims.bool = (fun t -> (match ((let _152_440 = (FStar_Syntax_Subst.compress t)
...
(let _152_476 = (head_matches env f g)
in (FStar_All.pipe_right _152_476 head_match))
end
...
(let _152_477 = (head_matches env x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (FStar_All.pipe_right _152_477 head_match))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _56_765), _56_769) -> begin
(let _152_478 = (head_matches env x.FStar_Syntax_Syntax.sort t2)
in (FStar_All.pipe_right _152_478 head_match))
end
| (_56_772, FStar_Syntax_Syntax.Tm_refine (x, _56_775)) -> begin
(let _152_479 = (head_matches env t1 x.FStar_Syntax_Syntax.sort)
...
(let _152_480 = (head_matches env head head')
in (FStar_All.pipe_right _152_480 head_match))
end
| (FStar_Syntax_Syntax.Tm_app (head, _56_806), _56_810) -> begin
(let _152_481 = (head_matches env head t2)
in (FStar_All.pipe_right _152_481 head_match))
end
| (_56_813, FStar_Syntax_Syntax.Tm_app (head, _56_816)) -> begin
(let _152_482 = (head_matches env t1 head)
in (FStar_All.pipe_right _152_482 head_match))
end
| _56_821 -> begin
(let _152_485 = (let _152_484 = (delta_depth_of_term env t1)
in (let _152_483 = (delta_depth_of_term env t2)
in ((_152_484), (_152_483))))
in MisMatch (_152_485))
end))))
...
| (head, _56_830) -> begin
(match ((let _152_492 = (FStar_Syntax_Util.un_uinst head)
in _152_492.FStar_Syntax_Syntax.n)) with
| FStar_Syntax_Syntax.Tm_fvar (fv) -> begin
if (let _152_493 = (FStar_TypeChecker_Env.lookup_definition ((FStar_TypeChecker_Env.Eager_unfolding_only)::[]) env fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)
in (FStar_All.pipe_right _152_493 FStar_Option.isSome)) then begin
(let _152_495 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::(FStar_TypeChecker_Normalize.Eager_unfolding)::[]) env t)
in (FStar_All.pipe_right _152_495 (fun _152_494 -> Some (_152_494))))
end else begin
None
end
end
...
(match ((let _152_515 = (maybe_inline t1)
in (let _152_514 = (maybe_inline t2)
in ((_152_515), (_152_514))))) with
| (None, None) -> begin
(fail r)
end
| (Some (t1), None) -> begin
...
in (let _152_516 = (normalize_refinement ((FStar_TypeChecker_Normalize.UnfoldUntil (d1))::(FStar_TypeChecker_Normalize.WHNF)::[]) env wl t2)
in ((t1), (_152_516))))
end
...
| (t, _56_915) -> begin
(let _152_587 = (new_uvar r binders t)
in (Prims.fst _152_587))
end)))


let kind_type : FStar_Syntax_Syntax.binders  ->  FStar_Range.range  ->  FStar_Syntax_Syntax.typ = (fun binders r -> (let _152_592 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _152_592 Prims.fst)))
...
in (let _152_654 = (decompose [] bs)
in ((rebuild), (matches), (_152_654)))))
end)))
end
| _56_1000 -> begin
(
...
in (let _152_686 = (let _152_685 = (mk_problem scope orig gi_ps (vary_rel rel variance) ti None "type subterm")
in (FStar_All.pipe_left (fun _152_684 -> FStar_TypeChecker_Common.TProb (_152_684)) _152_685))
in ((T (((gi_xs), (mk_kind)))), (_152_686))))
end)))
end
...
(let _152_699 = (let _152_698 = (FStar_Syntax_Syntax.mk_Total' gi_xs uopt)
in (FStar_All.pipe_left (fun _152_697 -> C (_152_697)) _152_698))
in ((_152_699), ((prob)::[])))
end
| _56_1089 -> begin
(FStar_All.failwith "impossible")
...
(let _152_706 = (let _152_705 = (FStar_Syntax_Syntax.mk_GTotal' gi_xs uopt)
in (FStar_All.pipe_left (fun _152_704 -> C (_152_704)) _152_705))
in ((_152_706), ((prob)::[])))
end
| _56_1113 -> begin
(FStar_All.failwith "impossible")
...
let _56_1134 = (let _152_712 = (FStar_List.map (sub_prob scope args) components)
in (FStar_All.pipe_right _152_712 FStar_List.unzip))
in (match (_56_1134) with
| (tcs, sub_probs) -> begin
(

let gi_xs = (let _152_717 = (let _152_716 = (let _152_713 = (FStar_List.hd tcs)
in (FStar_All.pipe_right _152_713 un_T))
in (let _152_715 = (let _152_714 = (FStar_List.tl tcs)
in (FStar_All.pipe_right _152_714 (FStar_List.map arg_of_tc)))
in {FStar_Syntax_Syntax.comp_univs = c.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = c.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _152_716; FStar_Syntax_Syntax.effect_args = _152_715; FStar_Syntax_Syntax.flags = c.FStar_Syntax_Syntax.flags}))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Comp _152_717))
...
(let _152_719 = (let _152_718 = (FStar_Syntax_Util.arg_of_non_null_binder b)
in (_152_718)::args)
in ((Some (b)), ((b)::scope), (_152_719)))
end
| _56_1152 -> begin
((None), (scope), (args))
end)
...
| None -> begin
(let _152_722 = (let _152_721 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (f)::_152_721)
in (FStar_Syntax_Util.mk_conj_l _152_722))
end
| Some (b) -> begin
(let _152_726 = (let _152_725 = (FStar_Syntax_Util.mk_forall (Prims.fst b) f)
in (let _152_724 = (FStar_All.pipe_right probs (FStar_List.map (fun prob -> (FStar_All.pipe_right (p_guard prob) Prims.fst))))
in (_152_725)::_152_724))
in (FStar_Syntax_Util.mk_conj_l _152_726))
end)
...
let _56_1220 = p
in (let _152_748 = (whnf wl.tcenv p.FStar_TypeChecker_Common.lhs)
in (let _152_747 = (whnf wl.tcenv p.FStar_TypeChecker_Common.rhs)
in {FStar_TypeChecker_Common.pid = _56_1220.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _152_748; FStar_TypeChecker_Common.relation = _56_1220.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _152_747; FStar_TypeChecker_Common.element = _56_1220.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _56_1220.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _56_1220.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _56_1220.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _56_1220.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _56_1220.FStar_TypeChecker_Common.rank}))))


let compress_prob : worklist  ->  FStar_TypeChecker_Common.prob  ->  FStar_TypeChecker_Common.prob = (fun wl p -> (match (p) with
| FStar_TypeChecker_Common.TProb (p) -> begin
(let _152_754 = (compress_tprob wl p)
in (FStar_All.pipe_right _152_754 (fun _152_753 -> FStar_TypeChecker_Common.TProb (_152_753))))
end
...
let prob = (let _152_759 = (compress_prob wl pr)
in (FStar_All.pipe_right _152_759 maybe_invert_p))
in (match (prob) with
| FStar_TypeChecker_Common.TProb (tp) -> begin
(
...
let _56_1274 = tp
in (let _152_760 = (force_refinement ((b), (ref_opt)))
in {FStar_TypeChecker_Common.pid = _56_1274.FStar_TypeChecker_Common.pid; FStar_TypeChecker_Common.lhs = _56_1274.FStar_TypeChecker_Common.lhs; FStar_TypeChecker_Common.relation = _56_1274.FStar_TypeChecker_Common.relation; FStar_TypeChecker_Common.rhs = _152_760; FStar_TypeChecker_Common.element = _56_1274.FStar_TypeChecker_Common.element; FStar_TypeChecker_Common.logical_guard = _56_1274.FStar_TypeChecker_Common.logical_guard; FStar_TypeChecker_Common.scope = _56_1274.FStar_TypeChecker_Common.scope; FStar_TypeChecker_Common.reason = _56_1274.FStar_TypeChecker_Common.reason; FStar_TypeChecker_Common.loc = _56_1274.FStar_TypeChecker_Common.loc; FStar_TypeChecker_Common.rank = _56_1274.FStar_TypeChecker_Common.rank}))
in ((rank), (_152_761))))
end)
end))
end
...
(let _152_847 = (let _152_846 = (FStar_Syntax_Print.univ_to_string u1)
in (let _152_845 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Unable to unify universes: %s and %s" _152_846 _152_845)))
in UFailed (_152_847))
end
end
...
| _56_1399 -> begin
(let _152_854 = (let _152_853 = (FStar_Syntax_Print.univ_to_string u1)
in (let _152_852 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Unable to unify universes: %s and %s (%s)" _152_853 _152_852 msg)))
in UFailed (_152_854))
end))
in (match (((u1), (u2))) with
...
(let _152_857 = (let _152_856 = (FStar_Syntax_Print.univ_to_string u1)
in (let _152_855 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format2 "Impossible: found an de Bruijn universe variable or unknown universe: %s, %s" _152_856 _152_855)))
in (FStar_All.failwith _152_857))
end
...
(let _152_860 = (let _152_859 = (FStar_Syntax_Print.univ_to_string (FStar_Syntax_Syntax.U_unif (v1)))
in (let _152_858 = (FStar_Syntax_Print.univ_to_string u)
in (FStar_Util.format2 "Failed occurs check: %s occurs in %s" _152_859 _152_858)))
in (try_umax_components u1 u2 _152_860))
end else begin
(let _152_861 = (extend_solution orig ((UNIV (((v1), (u))))::[]) wl)
in USolved (_152_861))
end)
end
...
(let _152_915 = (wl_to_string probs)
...
(match (attempt) with
| [] -> begin
(let _152_918 = (FStar_List.map (fun _56_1543 -> (match (_56_1543) with
| (_56_1540, x, y) -> begin
((x), (y))
...
let _56_1546 = probs
in (let _152_920 = (FStar_All.pipe_right attempt (FStar_List.map (fun _56_1553 -> (match (_56_1553) with
| (_56_1549, _56_1551, y) -> begin
y
end))))
in {attempting = _152_920; wl_deferred = rest; ctr = _56_1546.ctr; defer_ok = _56_1546.defer_ok; smt_ok = _56_1546.smt_ok; tcenv = _56_1546.tcenv}))
in (solve env _152_921))
end)
end))
end)
end)))
...
| USolved (wl) -> begin
(let _152_927 = (solve_prob orig None [] wl)
in (solve env _152_927))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _152_943 = (prob_to_string env orig)
...
(let _152_947 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
| Some (t1, t2) -> begin
(let _152_953 = (FStar_Syntax_Subst.compress t1)
in (let _152_952 = (FStar_Syntax_Subst.compress t2)
in ((_152_953), (_152_952))))
end
| None -> begin
(let _152_955 = (FStar_Syntax_Subst.compress t1)
in (let _152_954 = (FStar_Syntax_Subst.compress t2)
in ((_152_955), (_152_954))))
end)
in (match (_56_1670) with
| (t1, t2) -> begin
(

let eq_prob = (fun t1 t2 -> (let _152_961 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "meeting refinements")
in (FStar_All.pipe_left (fun _152_960 -> FStar_TypeChecker_Common.TProb (_152_960)) _152_961)))
in (match (((t1.FStar_Syntax_Syntax.n), (t2.FStar_Syntax_Syntax.n))) with
| (FStar_Syntax_Syntax.Tm_refine (x, phi1), FStar_Syntax_Syntax.Tm_refine (y, phi2)) -> begin
(let _152_968 = (let _152_967 = (let _152_964 = (let _152_963 = (let _152_962 = (FStar_Syntax_Util.mk_disj phi1 phi2)
in ((x), (_152_962)))
in FStar_Syntax_Syntax.Tm_refine (_152_963))
in (FStar_Syntax_Syntax.mk _152_964 None t1.FStar_Syntax_Syntax.pos))
in (let _152_966 = (let _152_965 = (eq_prob x.FStar_Syntax_Syntax.sort y.FStar_Syntax_Syntax.sort)
in (_152_965)::[])
in ((_152_967), (_152_966))))
in Some (_152_968))
end
| (_56_1684, FStar_Syntax_Syntax.Tm_refine (x, _56_1687)) -> begin
(let _152_971 = (let _152_970 = (let _152_969 = (eq_prob x.FStar_Syntax_Syntax.sort t1)
in (_152_969)::[])
in ((t1), (_152_970)))
in Some (_152_971))
end
| (FStar_Syntax_Syntax.Tm_refine (x, _56_1693), _56_1697) -> begin
(let _152_974 = (let _152_973 = (let _152_972 = (eq_prob x.FStar_Syntax_Syntax.sort t2)
in (_152_972)::[])
in ((t2), (_152_973)))
in Some (_152_974))
end
...
(match ((let _152_975 = (FStar_Syntax_Util.un_uinst head1)
in _152_975.FStar_Syntax_Syntax.n)) with
...
(match ((let _152_982 = (whnf env hd.FStar_TypeChecker_Common.lhs)
in (disjoin bound _152_982))) with
...
in (match ((let _152_984 = (let _152_983 = (whnf env tp.FStar_TypeChecker_Common.lhs)
in ((_152_983), ([])))
in (make_lower_bound _152_984 lower_bounds))) with
| None -> begin
(
...
in (let _152_985 = (wl_to_string wl')
...
(let _152_991 = (FStar_Util.string_of_int tp.FStar_TypeChecker_Common.pid)
...
(let _152_1003 = (let _152_1002 = (let _152_1001 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _152_1000 -> FStar_TypeChecker_Common.TProb (_152_1000)) _152_1001))
in (_152_1002)::[])
in Some (_152_1003))
end
end else begin
...
(let _152_1007 = (let _152_1006 = (let _152_1005 = (new_problem env t1 FStar_TypeChecker_Common.EQ t2 None t1.FStar_Syntax_Syntax.pos "joining refinements")
in (FStar_All.pipe_left (fun _152_1004 -> FStar_TypeChecker_Common.TProb (_152_1004)) _152_1005))
in (_152_1006)::[])
in Some (_152_1007))
end
end else begin
...
in (let _152_1014 = (let _152_1013 = (let _152_1012 = (FStar_Syntax_Util.mk_conj phi1 phi2)
in (FStar_Syntax_Util.refine x _152_1012))
in ((_152_1013), (m)))
in Some (_152_1014))))))
end))
end
...
| (u', _56_1896) -> begin
(match ((let _152_1016 = (whnf env u')
in _152_1016.FStar_Syntax_Syntax.n)) with
...
| (FStar_TypeChecker_Common.TProb (hd))::tl -> begin
(match ((let _152_1021 = (whnf env hd.FStar_TypeChecker_Common.rhs)
in (conjoin bound _152_1021))) with
| Some (bound, sub) -> begin
...
in (match ((let _152_1023 = (let _152_1022 = (whnf env tp.FStar_TypeChecker_Common.rhs)
in ((_152_1022), ([])))
in (make_upper_bound _152_1023 upper_bounds))) with
| None -> begin
(
...
in (let _152_1024 = (wl_to_string wl')
...
(let _152_1052 = (prob_to_string env rhs_prob)
...
let _56_1989 = hd1
in (let _152_1053 = (FStar_Syntax_Subst.subst subst hd1.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _56_1989.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1989.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _152_1053}))
in (

let hd2 = (

let _56_1992 = hd2
in (let _152_1054 = (FStar_Syntax_Subst.subst subst hd2.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _56_1992.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _56_1992.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _152_1054}))
in (

let prob = (let _152_1057 = (let _152_1056 = (FStar_All.pipe_left invert_rel (p_rel orig))
in (mk_problem scope orig hd1.FStar_Syntax_Syntax.sort _152_1056 hd2.FStar_Syntax_Syntax.sort None "Formal parameter"))
in (FStar_All.pipe_left (fun _152_1055 -> FStar_TypeChecker_Common.TProb (_152_1055)) _152_1057))
in (

let hd1 = (FStar_Syntax_Syntax.freshen_bv hd1)
in (

let subst = (let _152_1058 = (FStar_Syntax_Subst.shift_subst (Prims.parse_int "1") subst)
in (FStar_Syntax_Syntax.DB ((((Prims.parse_int "0")), (hd1))))::_152_1058)
in (
...
let phi = (let _152_1060 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (let _152_1059 = (FStar_Syntax_Util.close_forall ((((hd1), (imp)))::[]) phi)
in (FStar_Syntax_Util.mk_conj _152_1060 _152_1059)))
in (

let _56_2004 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1062 = (FStar_Syntax_Print.term_to_string phi)
in (let _152_1061 = (FStar_Syntax_Print.bv_to_string hd1)
...
and solve_t : FStar_TypeChecker_Env.env  ->  tprob  ->  worklist  ->  solution = (fun env problem wl -> (let _152_1066 = (compress_tprob wl problem)
in (solve_t' env _152_1066 wl)))
...
in (let _152_1095 = (let _152_1094 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_Syntax_Util.mk_has_type t1 _152_1094 t2))
in (FStar_Syntax_Util.mk_forall x _152_1095)))
end))
...
in (let _152_1096 = (solve_prob orig (Some (guard)) [] wl)
in (solve env _152_1096)))
end else begin
...
(let _152_1100 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1099 = (FStar_Syntax_Print.tag_of_term t1)
in (let _152_1098 = (FStar_Syntax_Print.term_to_string t2)
in (let _152_1097 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.print4 "Head matches: %s (%s) and %s (%s)\n" _152_1100 _152_1099 _152_1098 _152_1097)))))
end else begin
()
end
in (
...
(let _152_1105 = (let _152_1104 = (FStar_Syntax_Print.term_to_string head1)
in (let _152_1103 = (args_to_string args1)
in (let _152_1102 = (FStar_Syntax_Print.term_to_string head2)
in (let _152_1101 = (args_to_string args2)
in (FStar_Util.format4 "unequal number of arguments: %s[%s] and %s[%s]" _152_1104 _152_1103 _152_1102 _152_1101)))))
in (giveup env _152_1105 orig))
end else begin
if ((nargs = (Prims.parse_int "0")) || (eq_args args1 args2)) then begin
(match ((solve_maybe_uinsts env orig head1 head2 wl)) with
| USolved (wl) -> begin
(let _152_1106 = (solve_prob orig None [] wl)
in (solve env _152_1106))
end
| UFailed (msg) -> begin
(giveup env msg orig)
end
...
(let _152_1110 = (mk_problem (p_scope orig) orig a FStar_TypeChecker_Common.EQ a' None "index")
in (FStar_All.pipe_left (fun _152_1109 -> FStar_TypeChecker_Common.TProb (_152_1109)) _152_1110))
end)) args1 args2)
in (

let formula = (let _152_1112 = (FStar_List.map (fun p -> (Prims.fst (p_guard p))) subprobs)
in (FStar_Syntax_Util.mk_conj_l _152_1112))
in (
...
let im = (let _152_1127 = (h gs_xs)
in (let _152_1126 = (let _152_1125 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _152_1123 -> FStar_Util.Inl (_152_1123)))
in (FStar_All.pipe_right _152_1125 (fun _152_1124 -> Some (_152_1124))))
in (FStar_Syntax_Util.abs xs _152_1127 _152_1126)))
in (

let _56_2149 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1134 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _152_1133 = (FStar_Syntax_Print.comp_to_string c)
in (let _152_1132 = (FStar_Syntax_Print.term_to_string im)
in (let _152_1131 = (FStar_Syntax_Print.tag_of_term im)
in (let _152_1130 = (let _152_1128 = (FStar_List.map (prob_to_string env) sub_probs)
in (FStar_All.pipe_right _152_1128 (FStar_String.concat ", ")))
in (let _152_1129 = (FStar_TypeChecker_Normalize.term_to_string env formula)
in (FStar_Util.print6 "Imitating  binders are {%s}, comp=%s\n\t%s (%s)\nsub_probs = %s\nformula=%s\n" _152_1134 _152_1133 _152_1132 _152_1131 _152_1130 _152_1129)))))))
end else begin
()
end
in (
...
| (gi_xs', gi_ps') -> begin
(let _152_1164 = (let _152_1161 = (FStar_Syntax_Syntax.as_arg gi_xs)
in (_152_1161)::gi_xs')
in (let _152_1163 = (let _152_1162 = (FStar_Syntax_Syntax.as_arg gi_ps)
in (_152_1162)::gi_ps')
in ((_152_1164), (_152_1163))))
end)))))
end)))
end))
in (aux [] bs))
end)))
in if (let _152_1165 = (matches pi)
in (FStar_All.pipe_left Prims.op_Negation _152_1165)) then begin
None
end else begin
(
...
let proj = (let _152_1170 = (FStar_Syntax_Syntax.mk_Tm_app xi g_xs None r)
in (let _152_1169 = (let _152_1168 = (FStar_All.pipe_right (FStar_Syntax_Util.lcomp_of_comp c) (fun _152_1166 -> FStar_Util.Inl (_152_1166)))
in (FStar_All.pipe_right _152_1168 (fun _152_1167 -> Some (_152_1167))))
in (FStar_Syntax_Util.abs xs _152_1170 _152_1169)))
in (

let sub = (let _152_1176 = (let _152_1175 = (FStar_Syntax_Syntax.mk_Tm_app proj ps None r)
in (let _152_1174 = (let _152_1173 = (FStar_List.map (fun _56_2221 -> (match (_56_2221) with
| (_56_2217, _56_2219, y) -> begin
y
end)) qs)
in (FStar_All.pipe_left h _152_1173))
in (mk_problem (p_scope orig) orig _152_1175 (p_rel orig) _152_1174 None "projection")))
in (FStar_All.pipe_left (fun _152_1171 -> FStar_TypeChecker_Common.TProb (_152_1171)) _152_1176))
in (

let _56_2223 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1178 = (FStar_Syntax_Print.term_to_string proj)
in (let _152_1177 = (prob_to_string env sub)
...
let wl = (let _152_1180 = (let _152_1179 = (FStar_All.pipe_left Prims.fst (p_guard sub))
in Some (_152_1179))
in (solve_prob orig _152_1180 ((TERM (((u), (proj))))::[]) wl))
in (let _152_1182 = (solve env (attempt ((sub)::[]) wl))
in (FStar_All.pipe_left (fun _152_1181 -> Some (_152_1181)) _152_1182)))))))
end))
end)
end))
end)))
...
(let _152_1206 = (let _152_1205 = (decompose env t2)
in ((((((uv), (k_uv))), (xs), (c))), (ps), (_152_1205)))
in Some (_152_1206))
end else begin
(
...
let rec elim = (fun k args -> (match ((let _152_1212 = (let _152_1211 = (FStar_Syntax_Subst.compress k)
in _152_1211.FStar_Syntax_Syntax.n)
in ((_152_1212), (args)))) with
| (_56_2249, []) -> begin
(let _152_1214 = (let _152_1213 = (FStar_Syntax_Syntax.mk_Total k)
in (([]), (_152_1213)))
in Some (_152_1214))
end
...
| (uv, uv_args) -> begin
(match ((let _152_1215 = (FStar_Syntax_Subst.compress uv)
in _152_1215.FStar_Syntax_Syntax.n)) with
...
let xs = (FStar_All.pipe_right args (FStar_List.map (fun _56_2275 -> (let _152_1221 = (let _152_1220 = (let _152_1219 = (let _152_1218 = (let _152_1217 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _152_1217 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _152_1218))
in (Prims.fst _152_1219))
in (FStar_Syntax_Syntax.new_bv (Some (k.FStar_Syntax_Syntax.pos)) _152_1220))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_binder _152_1221)))))
in (

let c = (let _152_1225 = (let _152_1224 = (let _152_1223 = (let _152_1222 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _152_1222 Prims.fst))
in (new_uvar k.FStar_Syntax_Syntax.pos scope _152_1223))
in (Prims.fst _152_1224))
in (FStar_Syntax_Syntax.mk_Total _152_1225))
in (

let k' = (FStar_Syntax_Util.arrow xs c)
in (

let uv_sol = (let _152_1231 = (let _152_1230 = (let _152_1229 = (let _152_1228 = (let _152_1227 = (let _152_1226 = (FStar_Syntax_Util.type_u ())
in (FStar_All.pipe_right _152_1226 Prims.fst))
in (FStar_Syntax_Syntax.mk_Total _152_1227))
in (FStar_All.pipe_left FStar_Syntax_Util.lcomp_of_comp _152_1228))
in FStar_Util.Inl (_152_1229))
in Some (_152_1230))
in (FStar_Syntax_Util.abs scope k' _152_1231))
in (
...
(let _152_1233 = (FStar_Syntax_Subst.open_comp xs c)
in (FStar_All.pipe_right _152_1233 (fun _152_1232 -> Some (_152_1232))))
end else begin
...
| (xs, c) -> begin
(let _152_1235 = (elim (FStar_Syntax_Util.comp_result c) rest)
in (FStar_Util.bind_opt _152_1235 (fun _56_2302 -> (match (_56_2302) with
| (xs', c) -> begin
...
in (let _152_1238 = (let _152_1236 = (FStar_Syntax_Syntax.mk_Total t)
in (FStar_Syntax_Subst.open_comp xs _152_1236))
in (FStar_All.pipe_right _152_1238 (fun _152_1237 -> Some (_152_1237)))))
end))
end
end))
end
| _56_2308 -> begin
(let _152_1242 = (let _152_1241 = (FStar_Syntax_Print.uvar_to_string uv)
in (let _152_1240 = (FStar_Syntax_Print.term_to_string k)
in (let _152_1239 = (FStar_Syntax_Print.term_to_string k_uv)
in (FStar_Util.format3 "Impossible: ill-typed application %s : %s\n\t%s" _152_1241 _152_1240 _152_1239))))
in (FStar_All.failwith _152_1242))
end))
in (let _152_1280 = (elim k_uv ps)
in (FStar_Util.bind_opt _152_1280 (fun _56_2311 -> (match (_56_2311) with
| (xs, c) -> begin
(let _152_1279 = (let _152_1278 = (decompose env t2)
in ((((((uv), (k_uv))), (xs), (c))), (ps), (_152_1278)))
in Some (_152_1279))
end))))))
end
end)))
...
(let _152_1291 = (names_to_string fvs_hd)
in (FStar_Util.print1 "Free variables are %s" _152_1291))
end else begin
()
end
in false)
...
let fvs_hd = (let _152_1295 = (let _152_1294 = (FStar_Syntax_Util.head_and_args t2)
in (FStar_All.pipe_right _152_1294 Prims.fst))
in (FStar_All.pipe_right _152_1295 FStar_Syntax_Free.names))
...
(let _152_1297 = (let _152_1296 = (FStar_Option.get msg)
in (Prims.strcat "occurs-check failed: " _152_1296))
in (giveup_or_defer orig _152_1297))
end else begin
...
(let _152_1298 = (subterms args_lhs)
in (imitate' orig env wl _152_1298))
end else begin
(

let _56_2366 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1301 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1300 = (names_to_string fvs1)
in (let _152_1299 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s succeeded fvar check: %s\n" _152_1301 _152_1300 _152_1299))))
end else begin
()
end
in (
...
| _56_2370 -> begin
(let _152_1302 = (sn_binders env vars)
in (u_abs k_uv _152_1302 t2))
end)
in (
...
(let _152_1305 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1304 = (names_to_string fvs1)
in (let _152_1303 = (names_to_string fvs2)
in (FStar_Util.print3 "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n" _152_1305 _152_1304 _152_1303))))
end else begin
()
end
in (let _152_1306 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _152_1306 (~- ((Prims.parse_int "1"))))))
end else begin
...
if (let _152_1307 = (FStar_Syntax_Free.names t1)
in (check_head _152_1307 t2)) then begin
(
...
(let _152_1308 = (FStar_Syntax_Print.term_to_string t1)
in (FStar_Util.print2 "Not a pattern (%s) ... %s\n" _152_1308 (if (im_ok < (Prims.parse_int "0")) then begin
"imitating"
end else begin
"projecting"
end)))
...
in (let _152_1309 = (subterms args_lhs)
in (imitate_or_project (FStar_List.length args_lhs) _152_1309 im_ok))))
end else begin
...
| (x, imp) -> begin
(let _152_1331 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_152_1331), (imp)))
end))))
in (
...
| (t, _56_2413) -> begin
(let _152_1332 = (new_uvar t.FStar_Syntax_Syntax.pos pattern_vars t)
in (Prims.fst _152_1332))
end))
in (
...
let sol = (let _152_1334 = (let _152_1333 = (u_abs k all_formals t')
in ((((u), (k))), (_152_1333)))
in TERM (_152_1334))
in (
...
(let _152_1336 = (FStar_Util.set_add (Prims.fst formal) pattern_var_set)
in (aux ((y)::pat_args) ((formal)::pattern_vars) _152_1336 formals tl))
end)
end)
end)
end
...
in (let _152_1337 = (FStar_Syntax_Syntax.new_bv_set ())
in (aux [] [] _152_1337 all_formals args))))
end))
end))
in (
...
(let _152_1346 = (solve_prob orig None [] wl)
in (solve env _152_1346))
end else begin
(
...
(let _152_1351 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _152_1350 = (FStar_Syntax_Print.binders_to_string ", " ys)
in (let _152_1349 = (FStar_Syntax_Print.binders_to_string ", " zs)
in (let _152_1348 = (FStar_Syntax_Print.term_to_string k1)
in (let _152_1347 = (FStar_Syntax_Print.term_to_string k2)
in (FStar_Util.print5 "Flex-flex patterns: intersected %s and %s; got %s\n\tk1=%s\n\tk2=%s\n" _152_1351 _152_1350 _152_1349 _152_1348 _152_1347))))))
end else begin
()
end
in (
...
(let _152_1361 = (let _152_1360 = (FStar_Syntax_Print.term_to_string k)
in (let _152_1359 = (FStar_Syntax_Print.binders_to_string ", " xs)
in (let _152_1358 = (FStar_Syntax_Print.args_to_string args)
in (FStar_Util.format3 "k=%s\nxs=%s\nargs=%s\nIll-formed substitutution" _152_1360 _152_1359 _152_1358))))
in (FStar_All.failwith _152_1361))
end)))
in (

let _56_2507 = (

let _56_2475 = (let _152_1362 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env k1)
in (FStar_Syntax_Util.arrow_formals _152_1362))
in (match (_56_2475) with
| (bs, k1') -> begin
(

let _56_2478 = (let _152_1363 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Beta)::[]) env k2)
in (FStar_Syntax_Util.arrow_formals _152_1363))
in (match (_56_2478) with
| (cs, k2') -> begin
(

let k1'_xs = (let _152_1364 = (subst_of_list k1 bs args1)
in (FStar_Syntax_Subst.subst _152_1364 k1'))
in (

let k2'_ys = (let _152_1365 = (subst_of_list k2 cs args2)
in (FStar_Syntax_Subst.subst _152_1365 k2'))
in (

let sub_prob = (let _152_1367 = (mk_problem (p_scope orig) orig k1'_xs FStar_TypeChecker_Common.EQ k2'_ys None "flex-flex kinding")
in (FStar_All.pipe_left (fun _152_1366 -> FStar_TypeChecker_Common.TProb (_152_1366)) _152_1367))
in (match ((let _152_1371 = (let _152_1368 = (FStar_Syntax_Subst.compress k1')
in _152_1368.FStar_Syntax_Syntax.n)
in (let _152_1370 = (let _152_1369 = (FStar_Syntax_Subst.compress k2')
in _152_1369.FStar_Syntax_Syntax.n)
in ((_152_1371), (_152_1370))))) with
...
let kprob = (let _152_1373 = (mk_problem (p_scope orig) orig k1'_xs FStar_TypeChecker_Common.EQ k_zs None "flex-flex kinding")
in (FStar_All.pipe_left (fun _152_1372 -> FStar_TypeChecker_Common.TProb (_152_1372)) _152_1373))
...
let _56_2511 = (let _152_1379 = (let _152_1374 = (new_uvar r zs k_u')
in (FStar_All.pipe_left Prims.fst _152_1374))
in (let _152_1378 = (let _152_1375 = (FStar_Syntax_Syntax.mk_Total k_u')
in (FStar_Syntax_Util.arrow xs _152_1375))
in (let _152_1377 = (let _152_1376 = (FStar_Syntax_Syntax.mk_Total k_u')
in (FStar_Syntax_Util.arrow ys _152_1376))
in ((_152_1379), (_152_1378), (_152_1377)))))
...
(let _152_1385 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1384 = (FStar_Syntax_Print.term_to_string t2)
...
(let _152_1390 = (let _152_1388 = (FStar_Syntax_Syntax.bv_to_name a)
in (mk_problem (p_scope orig) orig _152_1388 FStar_TypeChecker_Common.EQ t2 None "flex-flex index"))
in (FStar_All.pipe_right _152_1390 (fun _152_1389 -> FStar_TypeChecker_Common.TProb (_152_1389))))
end)) xs args2)
in (

let guard = (let _152_1392 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _152_1392))
in (
...
let sol = (let _152_1394 = (let _152_1393 = (u_abs k1 xs t2)
in ((((u1), (k1))), (_152_1393)))
in TERM (_152_1394))
in (
...
(let _152_1395 = (uvi_to_string env sol)
...
(let _152_1397 = (solve_prob orig None [] wl)
in (solve env _152_1397))
end else begin
(
...
(let _152_1399 = (FStar_Util.string_of_int problem.FStar_TypeChecker_Common.pid)
...
(let _152_1433 = (let _152_1430 = (mk_cod1 [])
in ((bs1), (_152_1430)))
in (let _152_1432 = (let _152_1431 = (mk_cod2 [])
in ((bs2), (_152_1431)))
in ((_152_1433), (_152_1432))))
end else begin
if (l1 > l2) then begin
(let _152_1436 = (curry l2 bs1 mk_cod1)
in (let _152_1435 = (let _152_1434 = (mk_cod2 [])
in ((bs2), (_152_1434)))
in ((_152_1436), (_152_1435))))
end else begin
(let _152_1439 = (let _152_1437 = (mk_cod1 [])
in ((bs1), (_152_1437)))
in (let _152_1438 = (curry l1 bs2 mk_cod2)
in ((_152_1439), (_152_1438))))
end
end)))
end))
in (match (((t1.FStar_Syntax_Syntax.n), (t2.FStar_Syntax_Syntax.n))) with
...
| bs -> begin
(let _152_1444 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_arrow (((bs), (c)))) None c.FStar_Syntax_Syntax.pos)
in (FStar_Syntax_Syntax.mk_Total _152_1444))
end))
in (
...
in (let _152_1451 = (mk_problem scope orig c1 rel c2 None "function co-domain")
in (FStar_All.pipe_left (fun _152_1450 -> FStar_TypeChecker_Common.CProb (_152_1450)) _152_1451)))))))
end)))
end
...
(solve_binders env bs1 bs2 orig wl (fun scope env subst -> (let _152_1466 = (let _152_1465 = (FStar_Syntax_Subst.subst subst tbody1)
in (let _152_1464 = (FStar_Syntax_Subst.subst subst tbody2)
in (mk_problem scope orig _152_1465 problem.FStar_TypeChecker_Common.relation _152_1464 None "lambda co-domain")))
in (FStar_All.pipe_left (fun _152_1463 -> FStar_TypeChecker_Common.TProb (_152_1463)) _152_1466))))
end)))
end
...
in (match ((let _152_1472 = (maybe_eta t1)
in (let _152_1471 = (maybe_eta t2)
in ((_152_1472), (_152_1471))))) with
...
(let _152_1473 = (destruct_flex_pattern env not_abs)
in (solve_t_flex_rigid true orig _152_1473 t_abs wl))
end else begin
...
let base_prob = (let _152_1475 = (mk_problem (p_scope orig) orig x1.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.relation x2.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "refinement base type")
in (FStar_All.pipe_left (fun _152_1474 -> FStar_TypeChecker_Common.TProb (_152_1474)) _152_1475))
in (
...
let mk_imp = (fun imp phi1 phi2 -> (let _152_1492 = (imp phi1 phi2)
in (FStar_All.pipe_right _152_1492 (guard_on_element problem x1))))
in (
...
let guard = (let _152_1495 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _152_1495 impl))
in (
...
let ref_prob = (let _152_1499 = (let _152_1498 = (let _152_1497 = (FStar_Syntax_Syntax.mk_binder x1)
in (_152_1497)::(p_scope orig))
in (mk_problem _152_1498 orig phi1 FStar_TypeChecker_Common.EQ phi2 None "refinement formula"))
in (FStar_All.pipe_left (fun _152_1496 -> FStar_TypeChecker_Common.TProb (_152_1496)) _152_1499))
in (match ((solve env (
...
let guard = (let _152_1502 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (let _152_1501 = (let _152_1500 = (FStar_All.pipe_right (p_guard ref_prob) Prims.fst)
in (FStar_All.pipe_right _152_1500 (guard_on_element problem x1)))
in (FStar_Syntax_Util.mk_conj _152_1502 _152_1501)))
in (
...
(let _152_1504 = (destruct_flex_t t1)
in (let _152_1503 = (destruct_flex_t t2)
in (flex_flex orig _152_1504 _152_1503)))
end
...
(let _152_1505 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid false orig _152_1505 t2 wl))
end
...
in if (let _152_1506 = (is_top_level_prob orig)
in (FStar_All.pipe_left Prims.op_Negation _152_1506)) then begin
(let _152_1509 = (FStar_All.pipe_left (fun _152_1507 -> FStar_TypeChecker_Common.TProb (_152_1507)) (
...
in (let _152_1508 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid false _152_1509 _152_1508 t2 wl)))
end else begin
(
...
(match (ref_opt) with
| None -> begin
(let _152_1512 = (FStar_All.pipe_left (fun _152_1510 -> FStar_TypeChecker_Common.TProb (_152_1510)) (
...
in (let _152_1511 = (destruct_flex_pattern env t1)
in (solve_t_flex_rigid false _152_1512 _152_1511 t_base wl)))
end
| Some (y, phi) -> begin
(
...
let base_prob = (let _152_1514 = (mk_problem problem.FStar_TypeChecker_Common.scope orig t1 new_rel y.FStar_Syntax_Syntax.sort problem.FStar_TypeChecker_Common.element "flex-rigid: base type")
in (FStar_All.pipe_left (fun _152_1513 -> FStar_TypeChecker_Common.TProb (_152_1513)) _152_1514))
in (

let guard = (let _152_1515 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _152_1515 impl))
in (
...
let t2 = (let _152_1516 = (base_and_refinement env wl t2)
in (FStar_All.pipe_left force_refinement _152_1516))
in (solve_t env (
...
let t1 = (let _152_1517 = (base_and_refinement env wl t1)
...
let head1 = (let _152_1518 = (FStar_Syntax_Util.head_and_args t1)
in (FStar_All.pipe_right _152_1518 Prims.fst))
in (

let head2 = (let _152_1519 = (FStar_Syntax_Util.head_and_args t2)
...
(let _152_1521 = (FStar_Syntax_Util.mk_eq FStar_Syntax_Syntax.tun FStar_Syntax_Syntax.tun t1 t2)
in (FStar_All.pipe_left (fun _152_1520 -> Some (_152_1520)) _152_1521))
end
in (let _152_1522 = (solve_prob orig guard [] wl)
in (solve env _152_1522)))
end else begin
...
(let _152_1525 = (let _152_1524 = (FStar_Syntax_Print.tag_of_term t1)
in (let _152_1523 = (FStar_Syntax_Print.tag_of_term t2)
in (FStar_Util.format2 "Impossible: %s and %s" _152_1524 _152_1523)))
in (FStar_All.failwith _152_1525))
end
| _56_3186 -> begin
...
(let _152_1540 = (sub_prob a1 FStar_TypeChecker_Common.EQ a2 "effect arg")
in (FStar_All.pipe_left (fun _152_1539 -> FStar_TypeChecker_Common.TProb (_152_1539)) _152_1540))
end)) c1_comp.FStar_Syntax_Syntax.effect_args c2_comp.FStar_Syntax_Syntax.effect_args)
in (

let guard = (let _152_1542 = (FStar_List.map (fun p -> (FStar_All.pipe_right (p_guard p) Prims.fst)) sub_probs)
in (FStar_Syntax_Util.mk_conj_l _152_1542))
in (
...
| _56_3228 -> begin
(let _152_1550 = (let _152_1549 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid c1.FStar_Syntax_Syntax.effect_name))
in (FStar_Util.format1 "Unexpected number of indices on a normalized effect (%s)" _152_1549))
in (FStar_All.failwith _152_1550))
end)
in (

let c1 = (let _152_1553 = (let _152_1552 = (let _152_1551 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wp)
in (FStar_Syntax_Syntax.as_arg _152_1551))
in (_152_1552)::[])
in {FStar_Syntax_Syntax.comp_univs = c1.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = c2.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = c1.FStar_Syntax_Syntax.result_typ; FStar_Syntax_Syntax.effect_args = _152_1553; FStar_Syntax_Syntax.flags = c1.FStar_Syntax_Syntax.flags})
in (solve_eq c1 c2)))
end else begin
(
...
| _56_3254 -> begin
(let _152_1557 = (let _152_1556 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _152_1555 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "Got effects %s and %s, expected normalized effects" _152_1556 _152_1555)))
in (FStar_All.failwith _152_1557))
end)
in (match (_56_3257) with
| (wpc1, wpc2) -> begin
if (FStar_Util.physical_equality wpc1 wpc2) then begin
(let _152_1558 = (problem_using_guard orig c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ None "result type")
in (solve_t env _152_1558 wl))
end else begin
(
...
in (let _152_1568 = (let _152_1567 = (let _152_1566 = (let _152_1560 = (let _152_1559 = (env.FStar_TypeChecker_Env.universe_of env c1.FStar_Syntax_Syntax.result_typ)
in (_152_1559)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _152_1560 env c2_decl c2_decl.FStar_Syntax_Syntax.trivial))
in (let _152_1565 = (let _152_1564 = (FStar_Syntax_Syntax.as_arg c1.FStar_Syntax_Syntax.result_typ)
in (let _152_1563 = (let _152_1562 = (let _152_1561 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _152_1561))
in (_152_1562)::[])
in (_152_1564)::_152_1563))
in ((_152_1566), (_152_1565))))
in FStar_Syntax_Syntax.Tm_app (_152_1567))
in (FStar_Syntax_Syntax.mk _152_1568 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r)))
end else begin
(let _152_1580 = (let _152_1579 = (let _152_1578 = (let _152_1570 = (let _152_1569 = (env.FStar_TypeChecker_Env.universe_of env c2.FStar_Syntax_Syntax.result_typ)
in (_152_1569)::[])
in (FStar_TypeChecker_Env.inst_effect_fun_with _152_1570 env c2_decl c2_decl.FStar_Syntax_Syntax.stronger))
in (let _152_1577 = (let _152_1576 = (FStar_Syntax_Syntax.as_arg c2.FStar_Syntax_Syntax.result_typ)
in (let _152_1575 = (let _152_1574 = (FStar_Syntax_Syntax.as_arg wpc2)
in (let _152_1573 = (let _152_1572 = (let _152_1571 = (edge.FStar_TypeChecker_Env.mlift c1.FStar_Syntax_Syntax.result_typ wpc1)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _152_1571))
in (_152_1572)::[])
in (_152_1574)::_152_1573))
in (_152_1576)::_152_1575))
in ((_152_1578), (_152_1577))))
in FStar_Syntax_Syntax.Tm_app (_152_1579))
in (FStar_Syntax_Syntax.mk _152_1580 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) r))
end
in (

let base_prob = (let _152_1582 = (sub_prob c1.FStar_Syntax_Syntax.result_typ problem.FStar_TypeChecker_Common.relation c2.FStar_Syntax_Syntax.result_typ "result type")
in (FStar_All.pipe_left (fun _152_1581 -> FStar_TypeChecker_Common.TProb (_152_1581)) _152_1582))
in (

let wl = (let _152_1586 = (let _152_1585 = (let _152_1584 = (FStar_All.pipe_right (p_guard base_prob) Prims.fst)
in (FStar_Syntax_Util.mk_conj _152_1584 g))
in (FStar_All.pipe_left (fun _152_1583 -> Some (_152_1583)) _152_1585))
in (solve_prob orig _152_1586 [] wl))
in (solve env (attempt ((base_prob)::[]) wl))))))
end
end)))
end))
in if (FStar_Util.physical_equality c1 c2) then begin
(let _152_1587 = (solve_prob orig None [] wl)
in (solve env _152_1587))
end else begin
(

let _56_3264 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1589 = (FStar_Syntax_Print.comp_to_string c1)
in (let _152_1588 = (FStar_Syntax_Print.comp_to_string c2)
in (FStar_Util.print3 "solve_c %s %s %s\n" _152_1589 (rel_to_string problem.FStar_TypeChecker_Common.relation) _152_1588)))
end else begin
()
end
in (

let _56_3268 = (let _152_1591 = (FStar_TypeChecker_Normalize.ghost_to_pure env c1)
in (let _152_1590 = (FStar_TypeChecker_Normalize.ghost_to_pure env c2)
in ((_152_1591), (_152_1590))))
...
(let _152_1592 = (problem_using_guard orig t1 problem.FStar_TypeChecker_Common.relation t2 None "result type")
in (solve_t env _152_1592 wl))
end
...
(let _152_1600 = (problem_using_guard orig (FStar_Syntax_Util.comp_result c1) problem.FStar_TypeChecker_Common.relation (FStar_Syntax_Util.comp_result c2) None "result type")
in (solve_t env _152_1600 wl))
end else begin
(
...
| None -> begin
if (((FStar_Syntax_Util.is_ghost_effect c1.FStar_Syntax_Syntax.effect_name) && (FStar_Syntax_Util.is_pure_effect c2.FStar_Syntax_Syntax.effect_name)) && (let _152_1601 = (FStar_TypeChecker_Normalize.normalize ((FStar_TypeChecker_Normalize.Eager_unfolding)::(FStar_TypeChecker_Normalize.UnfoldUntil (FStar_Syntax_Syntax.Delta_constant))::[]) env c2.FStar_Syntax_Syntax.result_typ)
in (FStar_Syntax_Util.non_informative _152_1601))) then begin
(
...
(let _152_1606 = (let _152_1605 = (FStar_Syntax_Print.lid_to_string c1.FStar_Syntax_Syntax.effect_name)
in (let _152_1604 = (FStar_Syntax_Print.lid_to_string c2.FStar_Syntax_Syntax.effect_name)
in (FStar_Util.format2 "incompatible monad ordering: %s </: %s" _152_1605 _152_1604)))
in (giveup env _152_1606 orig))
end
end
| Some (edge) -> begin
...
let print_pending_implicits : FStar_TypeChecker_Env.guard_t  ->  Prims.string = (fun g -> (let _152_1610 = (FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits (FStar_List.map (fun _56_3379 -> (match (_56_3379) with
| (_56_3369, _56_3371, u, _56_3374, _56_3376, _56_3378) -> begin
(FStar_Syntax_Print.uvar_to_string u)
end))))
in (FStar_All.pipe_right _152_1610 (FStar_String.concat ", "))))
...
let carry = (let _152_1616 = (FStar_List.map (fun _56_3394 -> (match (_56_3394) with
| (_56_3392, x) -> begin
(prob_to_string env x)
end)) g.FStar_TypeChecker_Env.deferred)
in (FStar_All.pipe_right _152_1616 (FStar_String.concat ",\n")))
in (
...
let _56_3428 = g
in (let _152_1636 = (let _152_1635 = (let _152_1634 = (let _152_1628 = (FStar_Syntax_Syntax.mk_binder x)
in (_152_1628)::[])
in (let _152_1633 = (let _152_1632 = (let _152_1631 = (let _152_1629 = (FStar_Syntax_Syntax.mk_Total FStar_Syntax_Util.ktype0)
in (FStar_All.pipe_right _152_1629 FStar_Syntax_Util.lcomp_of_comp))
in (FStar_All.pipe_right _152_1631 (fun _152_1630 -> FStar_Util.Inl (_152_1630))))
in Some (_152_1632))
in (FStar_Syntax_Util.abs _152_1634 f _152_1633)))
in (FStar_All.pipe_left (fun _152_1627 -> FStar_TypeChecker_Common.NonTrivial (_152_1627)) _152_1635))
in {FStar_TypeChecker_Env.guard_f = _152_1636; FStar_TypeChecker_Env.deferred = _56_3428.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_3428.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _56_3428.FStar_TypeChecker_Env.implicits}))
in Some (_152_1637)))
end))
...
let _56_3435 = g
in (let _152_1648 = (let _152_1647 = (let _152_1646 = (let _152_1645 = (let _152_1644 = (let _152_1643 = (FStar_Syntax_Syntax.as_arg e)
in (_152_1643)::[])
in ((f), (_152_1644)))
in FStar_Syntax_Syntax.Tm_app (_152_1645))
in (FStar_Syntax_Syntax.mk _152_1646 (Some (FStar_Syntax_Util.ktype0.FStar_Syntax_Syntax.n)) f.FStar_Syntax_Syntax.pos))
in (FStar_All.pipe_left (fun _152_1642 -> FStar_TypeChecker_Common.NonTrivial (_152_1642)) _152_1647))
in {FStar_TypeChecker_Env.guard_f = _152_1648; FStar_TypeChecker_Env.deferred = _56_3435.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_3435.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _56_3435.FStar_TypeChecker_Env.implicits}))
end))
...
(let _152_1655 = (FStar_Syntax_Util.mk_conj f1 f2)
in FStar_TypeChecker_Common.NonTrivial (_152_1655))
end))
...
let binop_guard : (FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula  ->  FStar_TypeChecker_Common.guard_formula)  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t  ->  FStar_TypeChecker_Env.guard_t = (fun f g1 g2 -> (let _152_1678 = (f g1.FStar_TypeChecker_Env.guard_f g2.FStar_TypeChecker_Env.guard_f)
in {FStar_TypeChecker_Env.guard_f = _152_1678; FStar_TypeChecker_Env.deferred = (FStar_List.append g1.FStar_TypeChecker_Env.deferred g2.FStar_TypeChecker_Env.deferred); FStar_TypeChecker_Env.univ_ineqs = (FStar_List.append g1.FStar_TypeChecker_Env.univ_ineqs g2.FStar_TypeChecker_Env.univ_ineqs); FStar_TypeChecker_Env.implicits = (FStar_List.append g1.FStar_TypeChecker_Env.implicits g2.FStar_TypeChecker_Env.implicits)}))
...
let _56_3485 = g
in (let _152_1693 = (let _152_1692 = (FStar_Syntax_Util.close_forall binders f)
in (FStar_All.pipe_right _152_1692 (fun _152_1691 -> FStar_TypeChecker_Common.NonTrivial (_152_1691))))
in {FStar_TypeChecker_Env.guard_f = _152_1693; FStar_TypeChecker_Env.deferred = _56_3485.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_3485.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _56_3485.FStar_TypeChecker_Env.implicits}))
end))
...
(let _152_1701 = (FStar_TypeChecker_Normalize.term_to_string env lhs)
in (let _152_1700 = (FStar_TypeChecker_Normalize.term_to_string env rhs)
in (FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" _152_1701 (rel_to_string rel) _152_1700)))
end else begin
"TOP"
end
in (
...
let x = (let _152_1712 = (let _152_1711 = (FStar_TypeChecker_Env.get_range env)
in (FStar_All.pipe_left (fun _152_1710 -> Some (_152_1710)) _152_1711))
in (FStar_Syntax_Syntax.new_bv _152_1712 t1))
in (

let env = (FStar_TypeChecker_Env.push_bv env x)
in (

let p = (let _152_1716 = (let _152_1714 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left (fun _152_1713 -> Some (_152_1713)) _152_1714))
in (let _152_1715 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 rel t2 _152_1716 _152_1715)))
...
(let _152_1728 = (explain env d s)
in (FStar_All.pipe_left FStar_Util.print_string _152_1728))
end else begin
()
end
in (err ((d), (s)))))
...
(let _152_1733 = (FStar_Syntax_Print.term_to_string f)
...
let f = (match ((let _152_1735 = (FStar_Syntax_Util.unmeta f)
in _152_1735.FStar_Syntax_Syntax.n)) with
...
| Some (d) -> begin
(let _152_1747 = (let _152_1746 = (let _152_1745 = (let _152_1744 = (FStar_All.pipe_right (p_guard prob) Prims.fst)
in (FStar_All.pipe_right _152_1744 (fun _152_1743 -> FStar_TypeChecker_Common.NonTrivial (_152_1743))))
in {FStar_TypeChecker_Env.guard_f = _152_1745; FStar_TypeChecker_Env.deferred = d; FStar_TypeChecker_Env.univ_ineqs = []; FStar_TypeChecker_Env.implicits = []})
in (simplify_guard env _152_1746))
in (FStar_All.pipe_left (fun _152_1742 -> Some (_152_1742)) _152_1747))
end))
...
(let _152_1755 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1754 = (FStar_Syntax_Print.term_to_string t2)
...
let prob = (let _152_1758 = (let _152_1757 = (FStar_TypeChecker_Env.get_range env)
in (new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None _152_1757))
in (FStar_All.pipe_left (fun _152_1756 -> FStar_TypeChecker_Common.TProb (_152_1756)) _152_1758))
in (

let g = (let _152_1760 = (solve_and_commit env (singleton env prob) (fun _56_3551 -> None))
in (FStar_All.pipe_left (with_guard env prob) _152_1760))
in g))))
...
| None -> begin
(let _152_1770 = (let _152_1769 = (let _152_1768 = (FStar_TypeChecker_Errors.basic_type_error env None t2 t1)
in (let _152_1767 = (FStar_TypeChecker_Env.get_range env)
in ((_152_1768), (_152_1767))))
in FStar_Syntax_Syntax.Error (_152_1769))
in (Prims.raise _152_1770))
end
| Some (g) -> begin
(

let _56_3560 = if (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env) (FStar_Options.Other ("Rel"))) then begin
(let _152_1773 = (FStar_Syntax_Print.term_to_string t1)
in (let _152_1772 = (FStar_Syntax_Print.term_to_string t2)
in (let _152_1771 = (guard_to_string env g)
in (FStar_Util.print3 "teq of %s and %s succeeded with guard %s\n" _152_1773 _152_1772 _152_1771))))
end else begin
()
end
in g)
...
(let _152_1783 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _152_1782 = (FStar_TypeChecker_Normalize.term_to_string env t2)
...
let g = (let _152_1785 = (solve_and_commit env (singleton' env prob smt_ok) (fun _56_3572 -> None))
in (FStar_All.pipe_left (with_guard env prob) _152_1785))
in (
...
(let _152_1789 = (FStar_TypeChecker_Normalize.term_to_string env t1)
in (let _152_1788 = (FStar_TypeChecker_Normalize.term_to_string env t2)
in (let _152_1787 = (let _152_1786 = (FStar_Util.must g)
in (guard_to_string env _152_1786))
in (FStar_Util.print3 "try_subtype succeeded: %s <: %s\n\tguard is %s\n" _152_1789 _152_1788 _152_1787))))
end else begin
()
end
...
let subtype_fail : FStar_TypeChecker_Env.env  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.typ  ->  FStar_Syntax_Syntax.typ  ->  Prims.unit = (fun env e t1 t2 -> (let _152_1805 = (FStar_TypeChecker_Env.get_range env)
in (let _152_1804 = (FStar_TypeChecker_Errors.basic_type_error env (Some (e)) t2 t1)
in (FStar_TypeChecker_Errors.report _152_1805 _152_1804))))
...
(let _152_1813 = (FStar_Syntax_Print.comp_to_string c1)
in (let _152_1812 = (FStar_Syntax_Print.comp_to_string c2)
...
let prob = (let _152_1816 = (let _152_1815 = (FStar_TypeChecker_Env.get_range env)
in (new_problem env c1 rel c2 None _152_1815 "sub_comp"))
in (FStar_All.pipe_left (fun _152_1814 -> FStar_TypeChecker_Common.CProb (_152_1814)) _152_1816))
in (let _152_1818 = (solve_and_commit env (singleton env prob) (fun _56_3591 -> None))
in (FStar_All.pipe_left (with_guard env prob) _152_1818))))))
...
in (let _152_1836 = (let _152_1835 = (let _152_1834 = (let _152_1832 = (FStar_Syntax_Print.univ_to_string u1)
in (let _152_1831 = (FStar_Syntax_Print.univ_to_string u2)
in (FStar_Util.format3 "Universe %s and %s are incompatible%s" _152_1832 _152_1831 msg)))
in (let _152_1833 = (FStar_TypeChecker_Env.get_range env)
in ((_152_1834), (_152_1833))))
in FStar_Syntax_Syntax.Error (_152_1835))
in (Prims.raise _152_1836)))))
in (
...
(let _152_1848 = (insert uv u1 out)
in (group_by _152_1848 rest))
end)
end
| _56_3631 -> begin
None
...
(let _152_1869 = (wl_to_string wl)
in (let _152_1868 = (FStar_Util.string_of_int (FStar_List.length g.FStar_TypeChecker_Env.implicits))
...
(let _152_1886 = (FStar_TypeChecker_Env.get_range env)
in (let _152_1885 = (let _152_1884 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Before normalization VC=\n%s\n" _152_1884))
in (FStar_TypeChecker_Errors.diag _152_1886 _152_1885)))
end else begin
()
end
in (
...
(let _152_1889 = (FStar_TypeChecker_Env.get_range env)
in (let _152_1888 = (let _152_1887 = (FStar_Syntax_Print.term_to_string vc)
in (FStar_Util.format1 "Checking VC=\n%s\n" _152_1887))
in (FStar_TypeChecker_Errors.diag _152_1889 _152_1888)))
end else begin
()
end
...
(let _152_1905 = (FStar_Syntax_Print.uvar_to_string u)
in (let _152_1904 = (FStar_Syntax_Print.term_to_string tm)
in (let _152_1903 = (FStar_Syntax_Print.term_to_string k)
in (FStar_Util.print3 "Checking uvar %s resolved to %s at type %s\n" _152_1905 _152_1904 _152_1903))))
end else begin
()
end
in (
...
let _56_3783 = g
in (let _152_1909 = (until_fixpoint (([]), (false)) g.FStar_TypeChecker_Env.implicits)
in {FStar_TypeChecker_Env.guard_f = _56_3783.FStar_TypeChecker_Env.guard_f; FStar_TypeChecker_Env.deferred = _56_3783.FStar_TypeChecker_Env.deferred; FStar_TypeChecker_Env.univ_ineqs = _56_3783.FStar_TypeChecker_Env.univ_ineqs; FStar_TypeChecker_Env.implicits = _152_1909})))))


let force_trivial_guard : FStar_TypeChecker_Env.env  ->  FStar_TypeChecker_Env.guard_t  ->  Prims.unit = (fun env g -> (

let g = (let _152_1914 = (solve_deferred_constraints env g)
in (FStar_All.pipe_right _152_1914 resolve_implicits))
in (match (g.FStar_TypeChecker_Env.implicits) with
| [] -> begin
(let _152_1915 = (discharge_guard env g)
in (FStar_All.pipe_left Prims.ignore _152_1915))
end
| ((reason, _56_3793, _56_3795, e, t, r))::_56_3790 -> begin
(let _152_1918 = (let _152_1917 = (FStar_Syntax_Print.term_to_string t)
in (let _152_1916 = (FStar_Syntax_Print.term_to_string e)
in (FStar_Util.format3 "Failed to resolve implicit argument of type \'%s\' introduced in %s because %s" _152_1917 _152_1916 reason)))
in (FStar_TypeChecker_Errors.report r _152_1918))
end)))
