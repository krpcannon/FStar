...
(let _160_183 = (let _160_182 = (let _160_181 = (FStar_Syntax_Syntax.fvar source_lid FStar_Syntax_Syntax.Delta_constant None)
in ((_160_181), (false)))
...
in (FStar_Syntax_Syntax.fvar source_lid FStar_Syntax_Syntax.Delta_constant _160_184))
in ((_160_185), (false)))
...
in (let _160_190 = (let _160_189 = (let _160_188 = (FStar_Syntax_Syntax.fvar source_lid fv.FStar_Syntax_Syntax.fv_delta fv.FStar_Syntax_Syntax.fv_qual)
in ((_160_188), (false)))
...
(let _160_202 = (let _160_201 = (let _160_200 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range l (FStar_Ident.range_of_lid lid)) dd None)
in ((_160_200), (false)))
in Term_name (_160_201))
in Some (_160_202))
end else begin
None
end
...
in (let _160_238 = (FStar_Syntax_Syntax.fvar lid fv.FStar_Syntax_Syntax.fv_delta fv.FStar_Syntax_Syntax.fv_qual)
in Some (_160_238)))
end
| _64_390 -> begin
None
...
(let _160_265 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant None)
in Some (_160_265))
end else begin
None
end
...
(let _160_266 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in Some (_160_266))
end
| _64_459 -> begin
None
...
| () -> begin
(let _160_288 = (let _160_287 = (let _160_285 = (FStar_ST.read record_cache)
in (FStar_List.hd _160_285))
in (let _160_286 = (FStar_ST.read record_cache)
in (_160_287)::_160_286))
in (FStar_ST.op_Colon_Equals record_cache _160_288))
end))
in (

let pop = (fun _64_491 -> (match (()) with
| () -> begin
(let _160_292 = (let _160_291 = (FStar_ST.read record_cache)
in (FStar_List.tl _160_291))
...
| () -> begin
(let _160_295 = (FStar_ST.read record_cache)
in (FStar_List.hd _160_295))
end))
in (

let insert = (fun r -> (let _160_302 = (let _160_301 = (let _160_298 = (peek ())
in (r)::_160_298)
in (let _160_300 = (let _160_299 = (FStar_ST.read record_cache)
in (FStar_List.tl _160_299))
in (_160_301)::_160_300))
in (FStar_ST.op_Colon_Equals record_cache _160_302)))
in (
...
(match ((let _160_405 = (find_dc dc)
in (FStar_All.pipe_left FStar_Util.must _160_405))) with
...
(let _160_409 = (let _160_408 = (let _160_407 = if is_rec then begin
(FStar_Syntax_Util.unmangle_field_name x.FStar_Syntax_Syntax.ppname)
end else begin
x.FStar_Syntax_Syntax.ppname
end
in (qual constrname _160_407))
in ((_160_408), (x.FStar_Syntax_Syntax.sort)))
in (_160_409)::[])
end
end))))
in (
...
| (ns, fieldname) -> begin
(let _160_425 = (peek_record_cache ())
in (FStar_Util.find_map _160_425 (fun record -> (
...
(match ((let _160_477 = (FStar_Syntax_Util.lids_of_sigelt se)
in (FStar_Util.find_opt (FStar_Ident.lid_equals l) _160_477))) with
| Some (l) -> begin
...
in (let _160_480 = (let _160_479 = (let _160_478 = (FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" (FStar_Ident.text_of_lid l) r)
in ((_160_478), ((FStar_Ident.range_of_lid l))))
...
(let _160_484 = (FStar_List.map (fun se -> (let _160_483 = (FStar_Syntax_Util.lids_of_sigelt se)
in ((_160_483), (se)))) ses)
in ((env), (_160_484)))
end
| _64_776 -> begin
(let _160_487 = (let _160_486 = (let _160_485 = (FStar_Syntax_Util.lids_of_sigelt s)
in ((_160_485), (s)))
in (_160_486)::[])
in ((env), (_160_487)))
end)
...
(let _160_497 = (let _160_496 = (let _160_495 = (FStar_Util.format1 "Namespace %s cannot be found" (FStar_Ident.text_of_lid ns))
in ((_160_495), ((FStar_Ident.range_of_lid ns))))
in FStar_Syntax_Syntax.Error (_160_496))
in (Prims.raise _160_497))
end))
...
(let _160_507 = (let _160_506 = (let _160_505 = (FStar_Util.format1 "Module %s is already defined" x.FStar_Ident.idText)
in ((_160_505), (x.FStar_Ident.idRange)))
in FStar_Syntax_Syntax.Error (_160_506))
in (Prims.raise _160_507))
end else begin
(
...
(let _160_511 = (let _160_510 = (let _160_509 = (FStar_Util.format1 "Module %s cannot be found" (FStar_Ident.text_of_lid l))
in ((_160_509), ((FStar_Ident.range_of_lid l))))
...
let _64_819 = (let _160_517 = (let _160_516 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid l))
in (let _160_515 = (FStar_Syntax_Print.lid_to_string l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _160_516 _160_515)))
in (FStar_Util.print_string _160_517))
...
(FStar_All.pipe_right lbs (FStar_List.iter (fun lb -> (let _160_528 = (let _160_527 = (let _160_526 = (let _160_525 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _160_525.FStar_Syntax_Syntax.fv_name)
in _160_526.FStar_Syntax_Syntax.v)
in _160_527.FStar_Ident.str)
in (FStar_Util.smap_remove (sigmap env) _160_528)))))
end else begin
()
end
...
let lid = (let _160_531 = (let _160_530 = (FStar_Util.right lb.FStar_Syntax_Syntax.lbname)
in _160_530.FStar_Syntax_Syntax.fv_name)
in _160_531.FStar_Syntax_Syntax.v)
in (
...
let _64_900 = (let _160_581 = (let _160_580 = (FStar_ST.read stack)
in (env)::_160_580)
in (FStar_ST.op_Colon_Equals stack _160_581))
in (

let _64_902 = env
in (let _160_582 = (FStar_Util.smap_copy (sigmap env))
in {curmodule = _64_902.curmodule; modules = _64_902.modules; open_namespaces = _64_902.open_namespaces; modul_abbrevs = _64_902.modul_abbrevs; sigaccum = _64_902.sigaccum; localbindings = _64_902.localbindings; recbindings = _64_902.recbindings; sigmap = _160_582; default_result_effect = _64_902.default_result_effect; iface = _64_902.iface; admitted_iface = _64_902.admitted_iface; expect_typ = _64_902.expect_typ})))))
in (
...
(let _160_622 = (let _160_621 = (let _160_620 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in ((_160_620), ((FStar_Ident.range_of_lid mname))))
in FStar_Syntax_Syntax.Error (_160_621))
in (Prims.raise _160_622))
end else begin
()
end
in (let _160_624 = (let _160_623 = (push env)
in (prep _160_623))
in ((_160_624), (true))))
end)))
...
let module_of_the_lid = (let _160_640 = (FStar_Ident.path_of_ns lid.FStar_Ident.ns)
in (FStar_Ident.text_of_path _160_640))
in (
...
| _64_1021 -> begin
(let _160_645 = (let _160_644 = (let _160_643 = (let _160_642 = (FStar_Ident.path_of_ns lid.FStar_Ident.ns)
in (FStar_Ident.text_of_path _160_642))
in (FStar_Util.format3 "Hint: %s belongs to module %s, which does not belong to the list of modules in scope, namely %s" (FStar_Ident.text_of_lid lid) _160_643 (FStar_String.concat ", " opened_modules)))
in (Prims.strcat "\n" _160_644))
in (Prims.strcat msg _160_645))
end)
