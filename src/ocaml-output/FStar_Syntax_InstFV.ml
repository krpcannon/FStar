...
in {FStar_Syntax_Syntax.ppname = _38_52.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _38_52.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _134_19}))
in ((_134_20), (imp)))
end))))
in (
...
in {FStar_Syntax_Syntax.ppname = _38_63.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _38_63.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _134_25}))
in ((_134_26), (imp)))
end))))
in (
...
in {FStar_Syntax_Syntax.ppname = _38_71.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _38_71.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _134_27}))
in (
...
in {FStar_Syntax_Syntax.lbname = _38_110.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _38_110.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _134_49; FStar_Syntax_Syntax.lbeff = _38_110.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _134_48}))))))
...
in (let _134_78 = (FStar_All.pipe_right ct.FStar_Syntax_Syntax.flags (FStar_List.map (fun _38_1 -> (match (_38_1) with
...
in {FStar_Syntax_Syntax.comp_univs = _38_146.FStar_Syntax_Syntax.comp_univs; FStar_Syntax_Syntax.effect_name = _38_146.FStar_Syntax_Syntax.effect_name; FStar_Syntax_Syntax.result_typ = _134_80; FStar_Syntax_Syntax.effect_args = _134_79; FStar_Syntax_Syntax.flags = _134_78}))))
...
in {FStar_Syntax_Syntax.eff_name = _38_163.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _134_85; FStar_Syntax_Syntax.cflags = _38_163.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _38_165 -> (match (()) with
| () -> begin
