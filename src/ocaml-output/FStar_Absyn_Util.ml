...
let _32_36 = (let _128_8 = (let _128_7 = (FStar_Range.string_of_range r)
...
let subst_to_string = (fun s -> (let _128_174 = (FStar_All.pipe_right s (FStar_List.map (fun _32_4 -> (match (_32_4) with
...
in (let _128_233 = (FStar_List.map (fun _32_8 -> (match (_32_8) with
...
in {FStar_Absyn_Syntax.effect_name = _32_382.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = _128_234; FStar_Absyn_Syntax.effect_args = _128_233; FStar_Absyn_Syntax.flags = _128_232}))))
end))
...
in {FStar_Absyn_Syntax.v = _32_423.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _128_264; FStar_Absyn_Syntax.p = _32_423.FStar_Absyn_Syntax.p}))
...
in {FStar_Absyn_Syntax.v = _32_429.FStar_Absyn_Syntax.v; FStar_Absyn_Syntax.sort = _128_267; FStar_Absyn_Syntax.p = _32_429.FStar_Absyn_Syntax.p}))
...
in {FStar_Absyn_Syntax.effect_name = _32_566.FStar_Absyn_Syntax.effect_name; FStar_Absyn_Syntax.result_typ = t; FStar_Absyn_Syntax.effect_args = args; FStar_Absyn_Syntax.flags = _128_383}))
...
in {FStar_Absyn_Syntax.ftvs = _128_1023; FStar_Absyn_Syntax.fxvs = _32_1495.FStar_Absyn_Syntax.fxvs}))
...
in {FStar_Absyn_Syntax.uvars_k = _32_1501.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _128_1026; FStar_Absyn_Syntax.uvars_e = _32_1501.FStar_Absyn_Syntax.uvars_e}))
...
in {FStar_Absyn_Syntax.uvars_k = _128_1076; FStar_Absyn_Syntax.uvars_t = _32_1682.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _32_1682.FStar_Absyn_Syntax.uvars_e}))
in ((fvs), (_128_1077)))
in (cont _128_1078))
end)))
end
...
in {FStar_Absyn_Syntax.uvars_k = _32_1742.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _32_1742.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _128_1089}))
...
in {FStar_Absyn_Syntax.ftvs = _32_1746.FStar_Absyn_Syntax.ftvs; FStar_Absyn_Syntax.fxvs = _128_1092}))
...
in {FStar_Absyn_Syntax.uvars_k = _128_1210; FStar_Absyn_Syntax.uvars_t = _32_1917.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _32_1917.FStar_Absyn_Syntax.uvars_e}))
end)) FStar_Absyn_Syntax.no_uvs)))
in (

let out = (let _128_1216 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_t)
in (FStar_All.pipe_right _128_1216 (FStar_List.fold_left (fun out _32_1923 -> (match (_32_1923) with
| (u, t) -> begin
...
in {FStar_Absyn_Syntax.uvars_k = _32_1928.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _128_1215; FStar_Absyn_Syntax.uvars_e = _32_1928.FStar_Absyn_Syntax.uvars_e}))
end)
end)) out)))
in (

let out = (let _128_1221 = (FStar_Util.set_elements uvs.FStar_Absyn_Syntax.uvars_e)
in (FStar_All.pipe_right _128_1221 (FStar_List.fold_left (fun out _32_1934 -> (match (_32_1934) with
| (u, t) -> begin
(match ((FStar_Unionfind.find u)) with
...
in {FStar_Absyn_Syntax.uvars_k = _32_1939.FStar_Absyn_Syntax.uvars_k; FStar_Absyn_Syntax.uvars_t = _32_1939.FStar_Absyn_Syntax.uvars_t; FStar_Absyn_Syntax.uvars_e = _128_1220}))
end)
end)) out)))
in (
...
in out)))))
and uvars_in_kind : (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun k -> (let _128_1224 = (vs_kind k true (fun _32_1956 -> (match (_32_1956) with
| (_32_1954, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumKind (k))) _128_1224)))
and uvars_in_typ : (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun t -> (let _128_1227 = (vs_typ t true (fun _32_1961 -> (match (_32_1961) with
| (_32_1959, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumType (t))) _128_1227)))
and uvars_in_exp : (FStar_Absyn_Syntax.exp', (FStar_Absyn_Syntax.typ', (FStar_Absyn_Syntax.knd', Prims.unit) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun e -> (let _128_1230 = (vs_exp e true (fun _32_1966 -> (match (_32_1966) with
| (_32_1964, x) -> begin
x
end)))
in (FStar_All.pipe_left (update_uvars (SynSumExp (e))) _128_1230)))
and uvars_in_comp : (FStar_Absyn_Syntax.comp', Prims.unit) FStar_Absyn_Syntax.syntax  ->  FStar_Absyn_Syntax.uvars = (fun c -> (let _128_1233 = (vs_comp c true (fun _32_1971 -> (match (_32_1971) with
| (_32_1969, x) -> begin
x
end)))
...
| (t, args) -> begin
(let _128_1574 = (FStar_All.pipe_right args (FStar_List.map (fun _32_26 -> (match (_32_26) with
| (FStar_Util.Inl (t), imp) -> begin
