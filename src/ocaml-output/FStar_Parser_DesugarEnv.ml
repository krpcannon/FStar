...
let qual : FStar_Ident.lident  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun lid id -> (let _158_230 = (FStar_Ident.lid_of_ids (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::(id)::[])))
in (FStar_Ident.set_lid_range _158_230 id.FStar_Ident.idRange)))


let qualify : env  ->  FStar_Ident.ident  ->  FStar_Ident.lident = (fun env id -> (let _158_235 = (current_module env)
in (qual _158_235 id)))
...
in (let _158_240 = (FStar_Ident.lid_of_ids (FStar_List.append cur.FStar_Ident.ns (FStar_List.append ((cur.FStar_Ident.ident)::[]) (FStar_List.append lid.FStar_Ident.ns ((lid.FStar_Ident.ident)::[])))))
in (FStar_Ident.set_lid_range _158_240 (FStar_Ident.range_of_lid lid)))))
...
| () -> begin
(let _158_245 = (let _158_244 = (new_sigmap ())
in (_158_244)::[])
in {curmodule = None; modules = []; open_namespaces = []; modul_abbrevs = []; sigaccum = []; localbindings = []; recbindings = []; phase = FStar_Parser_AST.Un; sigmap = _158_245; default_result_effect = FStar_Absyn_Util.ml_comp; iface = false; admitted_iface = false})
end))
...
(let _158_261 = (FStar_Absyn_Util.bvd_to_typ (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Ident.idRange) FStar_Absyn_Syntax.kun)
in Some (_158_261))
end
| _62_128 -> begin
None
...
in (let _158_272 = (let _158_271 = (current_module env)
in (_158_271)::env.open_namespaces)
in (aux _158_272))))
...
let resolve_in_open_namespaces = (fun env lid finder -> (let _158_288 = (expand_module_abbrevs env lid)
in (resolve_in_open_namespaces' env _158_288 finder)))
...
(let _158_292 = (FStar_Ident.lid_of_path (("Prims")::(y)::[]) id.FStar_Ident.idRange)
in Some (_158_292))
end else begin
None
end
...
| Some (l) -> begin
(let _158_298 = (let _158_297 = (FStar_Absyn_Syntax.mk_Exp_fvar (((FStar_Absyn_Util.fv l)), (None)) None id.FStar_Ident.idRange)
in ((l), (_158_297)))
in Some (_158_298))
end
| _62_171 -> begin
...
(let _158_303 = (let _158_302 = (let _158_301 = (FStar_Ident.lid_of_ids ((id')::[]))
in (let _158_300 = (FStar_Absyn_Util.bvd_to_exp (FStar_Absyn_Util.set_bvd_range bvd id.FStar_Ident.idRange) FStar_Absyn_Syntax.tun)
in ((_158_301), (_158_300))))
in FStar_Util.Inr (_158_302))
in Some (_158_303))
end
| _62_185 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _158_321 = (sigmap env)
in (FStar_Util.smap_try_find _158_321 lid.FStar_Ident.str))) with
...
(let _158_324 = (let _158_323 = (let _158_322 = (FStar_Absyn_Util.ftv lid FStar_Absyn_Syntax.kun)
in ((OSig (se)), (_158_322)))
in Typ_name (_158_323))
in Some (_158_324))
end
...
(let _158_328 = (let _158_327 = (let _158_326 = (let _158_325 = (fv_qual_of_se se)
in (FStar_Absyn_Util.fvar _158_325 lid (FStar_Ident.range_of_lid lid)))
in ((OSig (se)), (_158_326)))
in Exp_name (_158_327))
in Some (_158_328))
end
| FStar_Absyn_Syntax.Sig_let (_62_275) -> begin
(let _158_331 = (let _158_330 = (let _158_329 = (FStar_Absyn_Util.fvar None lid (FStar_Ident.range_of_lid lid))
in ((OSig (se)), (_158_329)))
in Exp_name (_158_330))
in Some (_158_331))
end
...
(let _158_336 = (let _158_335 = (let _158_334 = (let _158_333 = (fv_qual_of_se se)
in (FStar_Absyn_Util.fvar _158_333 lid (FStar_Ident.range_of_lid lid)))
in ((OSig (se)), (_158_334)))
in Exp_name (_158_335))
in Some (_158_336))
end else begin
None
end
...
(let _158_340 = (let _158_339 = (let _158_338 = (FStar_Absyn_Util.fvar None recname (FStar_Ident.range_of_lid recname))
in ((ORec (l)), (_158_338)))
in Exp_name (_158_339))
in Some (_158_340))
end
| Binding_tycon (l) when (FStar_Ident.lid_equals l recname) -> begin
(let _158_343 = (let _158_342 = (let _158_341 = (FStar_Absyn_Util.ftv recname FStar_Absyn_Syntax.kun)
in ((ORec (l)), (_158_341)))
in Typ_name (_158_342))
in Some (_158_343))
end
| _62_305 -> begin
None
...
(let _158_350 = (FStar_Absyn_Util.ftv l FStar_Absyn_Syntax.mk_Kind_unknown)
in Some (_158_350))
end
| _62_330 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _158_379 = (sigmap env)
in (FStar_Util.smap_try_find _158_379 lid.FStar_Ident.str))) with
| Some (FStar_Absyn_Syntax.Sig_typ_abbrev (lid, tps, k, def, _62_380, _62_382), _62_386) -> begin
(

let t = (let _158_382 = (let _158_381 = (let _158_380 = (FStar_Absyn_Util.close_with_lam tps def)
in ((_158_380), (lid)))
in FStar_Absyn_Syntax.Meta_named (_158_381))
in (FStar_Absyn_Syntax.mk_Typ_meta _158_382))
in Some (t))
end
| _62_391 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _158_389 = (sigmap env)
in (FStar_Util.smap_try_find _158_389 lid.FStar_Ident.str))) with
...
let find_in_sig = (fun lid -> (match ((let _158_401 = (sigmap env)
in (FStar_Util.smap_try_find _158_401 lid.FStar_Ident.str))) with
| Some (FStar_Absyn_Syntax.Sig_let (_62_430), _62_433) -> begin
(let _158_402 = (FStar_Absyn_Util.fvar None lid (FStar_Ident.range_of_lid lid))
in Some (_158_402))
end
| _62_437 -> begin
None
...
let find_in_sig = (fun lid -> (match ((let _158_421 = (sigmap env)
in (FStar_Util.smap_try_find _158_421 lid.FStar_Ident.str))) with
...
let find_in_sig = (fun lid -> (match ((let _158_429 = (sigmap env)
in (FStar_Util.smap_try_find _158_429 lid.FStar_Ident.str))) with
...
| () -> begin
(let _158_443 = (let _158_442 = (let _158_440 = (FStar_ST.read record_cache)
in (FStar_List.hd _158_440))
in (let _158_441 = (FStar_ST.read record_cache)
in (_158_442)::_158_441))
in (FStar_ST.op_Colon_Equals record_cache _158_443))
end))
in (

let pop = (fun _62_511 -> (match (()) with
| () -> begin
(let _158_447 = (let _158_446 = (FStar_ST.read record_cache)
in (FStar_List.tl _158_446))
in (FStar_ST.op_Colon_Equals record_cache _158_447))
end))
in (

let peek = (fun _62_513 -> (match (()) with
| () -> begin
(let _158_450 = (FStar_ST.read record_cache)
in (FStar_List.hd _158_450))
end))
in (

let insert = (fun r -> (let _158_457 = (let _158_456 = (let _158_453 = (peek ())
in (r)::_158_453)
in (let _158_455 = (let _158_454 = (FStar_ST.read record_cache)
in (FStar_List.tl _158_454))
in (_158_456)::_158_455))
in (FStar_ST.op_Colon_Equals record_cache _158_457)))
...
(match ((let _158_528 = (find_dc dc)
in (FStar_All.pipe_left FStar_Util.must _158_528))) with
...
(let _158_532 = (let _158_531 = (let _158_530 = if is_rec then begin
...
in (qual constrname _158_530))
in ((_158_531), (x.FStar_Absyn_Syntax.sort)))
in (_158_532)::[])
end
end
| _62_634 -> begin
...
| (ns, fieldname) -> begin
(let _158_548 = (peek_record_cache ())
in (FStar_Util.find_map _158_548 (fun record -> (
...
(let _158_597 = (let _158_596 = (let _158_595 = (FStar_Absyn_Util.genident (Some (id.FStar_Ident.idRange)))
in ((id), (_158_595)))
in (FStar_Absyn_Util.mkbvd _158_596))
in FStar_Util.Inl (_158_597))
end
| Binding_var (id) -> begin
(let _158_600 = (let _158_599 = (let _158_598 = (FStar_Absyn_Util.genident (Some (id.FStar_Ident.idRange)))
in ((id), (_158_598)))
in (FStar_Absyn_Util.mkbvd _158_599))
in FStar_Util.Inr (_158_600))
end
| _62_745 -> begin
...
let sopt = (let _158_631 = (sigmap env)
in (FStar_Util.smap_try_find _158_631 l.FStar_Ident.str))
in (

let r = (match (sopt) with
| Some (se, _62_793) -> begin
(match ((let _158_632 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_Util.find_opt (FStar_Ident.lid_equals l) _158_632))) with
| Some (l) -> begin
...
in (let _158_635 = (let _158_634 = (let _158_633 = (FStar_Util.format2 "Duplicate top-level names [%s]; previously declared at %s" (FStar_Ident.text_of_lid l) r)
in ((_158_633), ((FStar_Ident.range_of_lid l))))
in FStar_Absyn_Syntax.Error (_158_634))
in (Prims.raise _158_635)))))
in (
...
(let _158_639 = (FStar_List.map (fun se -> (let _158_638 = (FStar_Absyn_Util.lids_of_sigelt se)
in ((_158_638), (se)))) ses)
in ((env), (_158_639)))
end
| _62_833 -> begin
(let _158_642 = (let _158_641 = (let _158_640 = (FStar_Absyn_Util.lids_of_sigelt s)
in ((_158_640), (s)))
in (_158_641)::[])
in ((env), (_158_642)))
end)
...
| (lids, se) -> begin
(FStar_All.pipe_right lids (FStar_List.iter (fun lid -> (let _158_645 = (sigmap env)
in (FStar_Util.smap_add _158_645 lid.FStar_Ident.str ((se), ((env.iface && (not (env.admitted_iface))))))))))
end))))
in env)
end)))))
...
(let _158_659 = (let _158_658 = (let _158_657 = (FStar_Util.format1 "Module %s is already defined" x.FStar_Ident.idText)
in ((_158_657), (x.FStar_Ident.idRange)))
in FStar_Absyn_Syntax.Error (_158_658))
...
let _62_880 = (let _158_673 = (let _158_672 = (FStar_Range.string_of_range (FStar_Ident.range_of_lid l))
in (let _158_671 = (FStar_Absyn_Print.sli l)
in (FStar_Util.format2 "%s: Warning: Admitting %s without a definition\n" _158_672 _158_671)))
in (FStar_Util.print_string _158_673))
in (let _158_674 = (sigmap env)
in (FStar_Util.smap_add _158_674 l.FStar_Ident.str ((FStar_Absyn_Syntax.Sig_val_decl (((l), (t), ((FStar_Absyn_Syntax.Assumption)::quals), (r)))), (false)))))
end
| Some (_62_883) -> begin
()
end)
...
(let _158_681 = (sigmap env)
in (FStar_Util.smap_remove _158_681 lid.FStar_Ident.str))
end
| _62_913 -> begin
()
end))))
...
if (FStar_List.contains FStar_Absyn_Syntax.Private quals) then begin
(let _158_682 = (sigmap env)
in (FStar_Util.smap_remove _158_682 lid.FStar_Ident.str))
end else begin
()
end
end
...
let _62_931 = env
in (let _158_687 = (let _158_686 = (let _158_685 = (sigmap env)
in (FStar_Util.smap_copy _158_685))
in (_158_686)::env.sigmap)
in {curmodule = _62_931.curmodule; modules = _62_931.modules; open_namespaces = _62_931.open_namespaces; modul_abbrevs = _62_931.modul_abbrevs; sigaccum = _62_931.sigaccum; localbindings = _62_931.localbindings; recbindings = _62_931.recbindings; phase = _62_931.phase; sigmap = _158_687; default_result_effect = _62_931.default_result_effect; iface = _62_931.iface; admitted_iface = _62_931.admitted_iface}))))
...
(let _158_721 = (let _158_720 = (let _158_719 = (FStar_Util.format1 "Duplicate module or interface name: %s" mname.FStar_Ident.str)
in ((_158_719), ((FStar_Ident.range_of_lid mname))))
in FStar_Absyn_Syntax.Error (_158_720))
in (Prims.raise _158_721))
end)))
...
| Some (r) -> begin
(let _158_736 = (FStar_Range.string_of_range r)
in (FStar_Util.format1 "(Possible clash with related name at %s)" _158_736))
end)
in (let _158_739 = (let _158_738 = (let _158_737 = (FStar_Util.format2 "Identifier not found: [%s] %s" (FStar_Ident.text_of_lid lid) msg)
in ((_158_737), ((FStar_Ident.range_of_lid lid))))
in FStar_Absyn_Syntax.Error (_158_738))
in (Prims.raise _158_739))))
end
| Some (r) -> begin
r
end))
