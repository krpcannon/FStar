...
in {ftvs = _125_1342; fxvs = _29_427.fxvs}))
end
...
in {ftvs = _29_431.ftvs; fxvs = _125_1343}))
end)) no_fvs)))
...
let vars = (let _125_1652 = (FStar_All.pipe_right vars (FStar_List.map (fun v -> (let _125_1651 = (FStar_List.map (fun _29_2 -> (match (_29_2) with
...
in {ftvs = _125_1760; fxvs = _29_833.fxvs}))
end
...
in {ftvs = _29_840.ftvs; fxvs = _125_1761}))
end)) no_fvs)))
