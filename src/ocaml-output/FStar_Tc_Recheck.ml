...
(let _138_40 = (FStar_Absyn_Util.compress_typ t)
in (recompute_kind _138_40))
end
...
(let _138_42 = (let _138_41 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "UNKNOWN KIND FOR %s" _138_41))
in (FStar_All.failwith _138_42))
end
| _42_99 -> begin
...
(let _138_44 = (let _138_43 = (recompute_kind body)
in ((binders), (_138_43)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _138_44 t.FStar_Absyn_Syntax.pos))
end
...
| (_42_165, []) -> begin
(let _138_51 = (FStar_Absyn_Syntax.mk_Kind_arrow ((bs), (k)) t.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _138_51 (FStar_Absyn_Util.subst_kind subst)))
end
| ((b)::bs, (a)::args) -> begin
(

let subst = (let _138_52 = (FStar_Absyn_Util.subst_formal b a)
in (_138_52)::subst)
in (aux subst bs args))
end
| _42_177 -> begin
(let _138_58 = (let _138_57 = (FStar_Range.string_of_range t.FStar_Absyn_Syntax.pos)
in (let _138_56 = (FStar_Absyn_Print.kind_to_string k1)
in (let _138_55 = (FStar_Absyn_Print.tag_of_typ t)
in (let _138_54 = (FStar_Absyn_Print.kind_to_string k)
in (let _138_53 = (FStar_All.pipe_right (FStar_List.length args) FStar_Util.string_of_int)
in (FStar_Util.format5 "(%s) HEAD KIND is %s\nToo many arguments in type %s; result kind is %s\nwith %s remaining args\n" _138_57 _138_56 _138_55 _138_54 _138_53))))))
in (FStar_All.failwith _138_58))
end))
in (aux [] bs args))
end)))
end)
...
(let _138_63 = (FStar_Absyn_Util.compress_exp e)
in (recompute_typ _138_63))
end
...
(let _138_66 = (let _138_65 = (let _138_64 = (recompute_typ body)
in (FStar_Absyn_Syntax.mk_Total _138_64))
in ((bs), (_138_65)))
in (FStar_Absyn_Syntax.mk_Typ_fun _138_66 None e.FStar_Absyn_Syntax.pos))
end
...
| (_42_222, []) -> begin
(let _138_73 = (FStar_Absyn_Syntax.mk_Typ_fun ((bs), (c)) None e.FStar_Absyn_Syntax.pos)
in (FStar_All.pipe_right _138_73 (FStar_Absyn_Util.subst_typ subst)))
end
| ((b)::bs, (a)::args) -> begin
(

let subst = (let _138_74 = (FStar_Absyn_Util.subst_formal b a)
in (_138_74)::subst)
in (aux subst bs args))
end
| _42_234 -> begin
