...
let _48_197 = (let _144_310 = (all_terms ())
...
let projs = (let _144_469 = (FStar_All.pipe_right projectors (FStar_List.mapi (fun i _48_570 -> (match (_48_570) with
| (name, s) -> begin
(
...
| Caption (c) -> begin
(let _144_517 = (FStar_All.pipe_right (FStar_Util.splitlines c) (fun _48_7 -> (match (_48_7) with
| [] -> begin
""
end
| (h)::t -> begin
