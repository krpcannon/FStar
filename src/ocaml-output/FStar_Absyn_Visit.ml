...
let _31_507 = (match ((let _127_299 = (compress_typ t)
...
let collect_from_typ = (fun f env t -> (let _127_589 = (reduce_typ (fun _31_1260 _31_1262 _31_1264 env _31_1267 k -> ((k), (env))) (fun _31_1242 vt _31_1245 env bvs t -> (
