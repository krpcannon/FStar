...
let subst_to_string = (fun s -> (let _132_3 = (FStar_All.pipe_right s (FStar_List.map (fun _36_12 -> (match (_36_12) with
| (b, _36_11) -> begin
b.FStar_Syntax_Syntax.ppname.FStar_Ident.idText
end))))
in (FStar_All.pipe_right _132_3 (FStar_String.concat ", "))))
...
let apply_until_some_then_map = (fun f s g t -> (let _132_31 = (apply_until_some f s)
in (FStar_All.pipe_right _132_31 (map_some_curry g t))))
...
let t' = (let _132_49 = (c ())
in (force_delayed_thunk _132_49))
in (
...
(let _132_61 = (let _132_60 = (let _132_59 = (FStar_Syntax_Syntax.range_of_bv a)
in (FStar_Syntax_Syntax.set_range_of_bv x _132_59))
in (FStar_Syntax_Syntax.bv_to_name _132_60))
in Some (_132_61))
end
| _36_105 -> begin
None
...
(let _132_67 = (FStar_Syntax_Syntax.bv_to_tm (
...
(let _132_82 = (subst_univ s u)
in FStar_Syntax_Syntax.U_succ (_132_82))
end
| FStar_Syntax_Syntax.U_max (us) -> begin
(let _132_83 = (FStar_List.map (subst_univ s) us)
in FStar_Syntax_Syntax.U_max (_132_83))
end)))
...
(let _132_86 = (FStar_Syntax_Syntax.set_range_of_bv bv r)
in FStar_Syntax_Syntax.Tm_bvar (_132_86))
end
| FStar_Syntax_Syntax.Tm_name (bv) -> begin
(let _132_87 = (FStar_Syntax_Syntax.set_range_of_bv bv r)
in FStar_Syntax_Syntax.Tm_name (_132_87))
end
...
| Some (r) -> begin
(let _132_90 = (FStar_Range.set_use_range (FStar_Ident.range_of_lid l) r)
in (FStar_Ident.set_lid_range l _132_90))
end))
...
(let _132_115 = (let _132_113 = (subst_univ (Prims.fst s) u)
in FStar_Syntax_Syntax.Tm_type (_132_113))
in (let _132_114 = (mk_range t0.FStar_Syntax_Syntax.pos s)
in (FStar_Syntax_Syntax.mk _132_115 None _132_114)))
end
| _36_233 -> begin
(let _132_117 = (mk_range t.FStar_Syntax_Syntax.pos s)
in (FStar_Syntax_Syntax.mk_Tm_delayed (FStar_Util.Inl (((t0), (s)))) _132_117))
end))
end)))
...
(let _132_121 = (subst' s a)
in FStar_Syntax_Syntax.DECREASES (_132_121))
end
| f -> begin
f
end)))))
...
let _36_251 = t
in (let _132_130 = (FStar_List.map (subst_univ (Prims.fst s)) t.FStar_Syntax_Syntax.comp_univs)
in (let _132_129 = (tag_lid_with_range t.FStar_Syntax_Syntax.effect_name s)
in (let _132_128 = (subst' s t.FStar_Syntax_Syntax.result_typ)
in (let _132_127 = (FStar_List.map (fun _36_255 -> (match (_36_255) with
| (t, imp) -> begin
(let _132_125 = (subst' s t)
in ((_132_125), (imp)))
end)) t.FStar_Syntax_Syntax.effect_args)
in (let _132_126 = (subst_flags' s t.FStar_Syntax_Syntax.flags)
in {FStar_Syntax_Syntax.comp_univs = _132_130; FStar_Syntax_Syntax.effect_name = _132_129; FStar_Syntax_Syntax.result_typ = _132_128; FStar_Syntax_Syntax.effect_args = _132_127; FStar_Syntax_Syntax.flags = _132_126}))))))
end))
...
(let _132_134 = (subst' s t)
in (let _132_133 = (FStar_Option.map (subst_univ (Prims.fst s)) uopt)
in (FStar_Syntax_Syntax.mk_Total' _132_134 _132_133)))
end
| FStar_Syntax_Syntax.GTotal (t, uopt) -> begin
(let _132_136 = (subst' s t)
in (let _132_135 = (FStar_Option.map (subst_univ (Prims.fst s)) uopt)
in (FStar_Syntax_Syntax.mk_GTotal' _132_136 _132_135)))
end
| FStar_Syntax_Syntax.Comp (ct) -> begin
(let _132_137 = (subst_comp_typ' s ct)
in (FStar_Syntax_Syntax.mk_Comp _132_137))
end)
end))
...
let shift_subst' = (fun n s -> (let _132_148 = (FStar_All.pipe_right (Prims.fst s) (FStar_List.map (shift_subst n)))
in ((_132_148), ((Prims.snd s)))))
...
let _36_306 = x
in (let _132_151 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_306.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_306.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_151}))
in ((_132_152), (imp)))
end))
...
(let _132_157 = (shift_subst' i s)
in (subst_binder' _132_157 b))
end))))
...
let ps = (FStar_List.map (fun p -> (let _132_177 = (aux n p)
in (Prims.fst _132_177))) ps)
in (((
...
let _36_361 = x
in (let _132_180 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_361.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_361.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_180}))
in (((
...
let _36_369 = x
in (let _132_181 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_369.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_369.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_181}))
in (((
...
let _36_379 = x
in (let _132_182 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_379.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_379.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_182}))
in (
...
(let _132_189 = (let _132_188 = (

let _36_395 = l
in (let _132_187 = (subst' s l.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = _36_395.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _132_187; FStar_Syntax_Syntax.cflags = _36_395.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _36_397 -> (match (()) with
| () -> begin
(let _132_186 = (l.FStar_Syntax_Syntax.comp ())
in (subst_comp' s _132_186))
end))}))
in FStar_Util.Inl (_132_188))
in Some (_132_189))
end))
...
let mk = (fun t' -> (let _132_196 = (mk_range t.FStar_Syntax_Syntax.pos s)
in (FStar_Syntax_Syntax.mk t' None _132_196)))
...
in (let _132_200 = (FStar_Syntax_Syntax.mk_Tm_uinst t' us)
in (tag_with_range _132_200 s)))
end
| FStar_Syntax_Syntax.Tm_app (t0, args) -> begin
(let _132_204 = (let _132_203 = (let _132_202 = (subst' s t0)
in (let _132_201 = (subst_args' s args)
in ((_132_202), (_132_201))))
in FStar_Syntax_Syntax.Tm_app (_132_203))
in (mk _132_204))
end
| FStar_Syntax_Syntax.Tm_ascribed (t0, FStar_Util.Inl (t1), lopt) -> begin
(let _132_209 = (let _132_208 = (let _132_207 = (subst' s t0)
in (let _132_206 = (let _132_205 = (subst' s t1)
in FStar_Util.Inl (_132_205))
in ((_132_207), (_132_206), (lopt))))
in FStar_Syntax_Syntax.Tm_ascribed (_132_208))
in (mk _132_209))
end
| FStar_Syntax_Syntax.Tm_ascribed (t0, FStar_Util.Inr (c), lopt) -> begin
(let _132_214 = (let _132_213 = (let _132_212 = (subst' s t0)
in (let _132_211 = (let _132_210 = (subst_comp' s c)
in FStar_Util.Inr (_132_210))
in ((_132_212), (_132_211), (lopt))))
in FStar_Syntax_Syntax.Tm_ascribed (_132_213))
in (mk _132_214))
end
...
let s' = (shift_subst' n s)
in (let _132_219 = (let _132_218 = (let _132_217 = (subst_binders' s bs)
in (let _132_216 = (subst' s' body)
in (let _132_215 = (push_subst_lcomp s' lopt)
in ((_132_217), (_132_216), (_132_215)))))
in FStar_Syntax_Syntax.Tm_abs (_132_218))
in (mk _132_219))))
end
...
let n = (FStar_List.length bs)
in (let _132_224 = (let _132_223 = (let _132_222 = (subst_binders' s bs)
in (let _132_221 = (let _132_220 = (shift_subst' n s)
in (subst_comp' _132_220 comp))
in ((_132_222), (_132_221))))
in FStar_Syntax_Syntax.Tm_arrow (_132_223))
in (mk _132_224)))
end
...
let _36_461 = x
in (let _132_225 = (subst' s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_461.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_461.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_225}))
in (

let phi = (let _132_226 = (shift_subst' (Prims.parse_int "1") s)
in (subst' _132_226 phi))
...
(let _132_234 = (let _132_233 = (let _132_232 = (subst' s t0)
in (let _132_231 = (let _132_230 = (FStar_All.pipe_right ps (FStar_List.map (subst_args' s)))
in FStar_Syntax_Syntax.Meta_pattern (_132_230))
in ((_132_232), (_132_231))))
in FStar_Syntax_Syntax.Tm_meta (_132_233))
in (mk _132_234))
end
| FStar_Syntax_Syntax.Tm_meta (t0, FStar_Syntax_Syntax.Meta_monadic (m, t)) -> begin
(let _132_240 = (let _132_239 = (let _132_238 = (subst' s t0)
in (let _132_237 = (let _132_236 = (let _132_235 = (subst' s t)
in ((m), (_132_235)))
in FStar_Syntax_Syntax.Meta_monadic (_132_236))
in ((_132_238), (_132_237))))
in FStar_Syntax_Syntax.Tm_meta (_132_239))
in (mk _132_240))
end
| FStar_Syntax_Syntax.Tm_meta (t, m) -> begin
(let _132_243 = (let _132_242 = (let _132_241 = (subst' s t)
in ((_132_241), (m)))
in FStar_Syntax_Syntax.Tm_meta (_132_242))
in (mk _132_243))
end)))
...
let t' = (let _132_246 = (push_subst s t)
in (compress _132_246))
in (
...
let closing_subst = (fun bs -> (let _132_265 = (FStar_List.fold_right (fun _36_558 _36_561 -> (match (((_36_558), (_36_561))) with
| ((x, _36_557), (subst, n)) -> begin
(((FStar_Syntax_Syntax.NM (((x), (n))))::subst), ((n + (Prims.parse_int "1"))))
end)) bs (([]), ((Prims.parse_int "0"))))
in (FStar_All.pipe_right _132_265 Prims.fst)))
...
in (let _132_271 = (subst o x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_572.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_572.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_271}))
in (

let o = (let _132_272 = (shift_subst (Prims.parse_int "1") o)
in (FStar_Syntax_Syntax.DB ((((Prims.parse_int "0")), (x'))))::_132_272)
in (
...
let open_binders : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.binders = (fun bs -> (let _132_275 = (open_binders' bs)
in (Prims.fst _132_275)))
...
| (bs', opening) -> begin
(let _132_280 = (subst opening t)
in ((bs'), (_132_280), (opening)))
end)))
...
| (bs', opening) -> begin
(let _132_289 = (subst_comp opening t)
in ((bs'), (_132_289)))
end)))
...
let _36_612 = p
in (let _132_302 = (let _132_301 = (let _132_300 = (FStar_All.pipe_right pats (FStar_List.map (fun _36_616 -> (match (_36_616) with
| (p, b) -> begin
(let _132_299 = (aux_disj sub renaming p)
in ((_132_299), (b)))
end))))
in ((fv), (_132_300)))
in FStar_Syntax_Syntax.Pat_cons (_132_301))
in {FStar_Syntax_Syntax.v = _132_302; FStar_Syntax_Syntax.ty = _36_612.FStar_Syntax_Syntax.ty; FStar_Syntax_Syntax.p = _36_612.FStar_Syntax_Syntax.p}))
end
| FStar_Syntax_Syntax.Pat_var (x) -> begin
(
...
in (let _132_304 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_627.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_627.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_304}))
end
| Some (y) -> begin
y
end)
...
in (let _132_305 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_636.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_636.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_305}))
in (
...
let _36_645 = x
in (let _132_306 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_645.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_645.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_306}))
in (
...
in (let _132_315 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_694.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_694.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_315}))
in (

let sub = (let _132_316 = (shift_subst (Prims.parse_int "1") sub)
in (FStar_Syntax_Syntax.DB ((((Prims.parse_int "0")), (x'))))::_132_316)
in (((
...
in (let _132_317 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_702.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_702.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_317}))
in (

let sub = (let _132_318 = (shift_subst (Prims.parse_int "1") sub)
in (FStar_Syntax_Syntax.DB ((((Prims.parse_int "0")), (x'))))::_132_318)
in (((
...
let _36_712 = x
in (let _132_319 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_712.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_712.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_319}))
in (
...
let close : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.term  ->  FStar_Syntax_Syntax.term = (fun bs t -> (let _132_327 = (closing_subst bs)
in (subst _132_327 t)))


let close_comp : FStar_Syntax_Syntax.binders  ->  FStar_Syntax_Syntax.comp  ->  FStar_Syntax_Syntax.comp = (fun bs c -> (let _132_332 = (closing_subst bs)
in (subst_comp _132_332 c)))
...
let _36_749 = x
in (let _132_339 = (subst s x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_749.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_749.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_339}))
in (

let s' = (let _132_340 = (shift_subst (Prims.parse_int "1") s)
in (FStar_Syntax_Syntax.NM (((x), ((Prims.parse_int "0")))))::_132_340)
in (let _132_341 = (aux s' tl)
in (((x), (imp)))::_132_341)))
end))
in (aux [] bs)))
...
let _36_756 = lc
in (let _132_348 = (subst s lc.FStar_Syntax_Syntax.res_typ)
in {FStar_Syntax_Syntax.eff_name = _36_756.FStar_Syntax_Syntax.eff_name; FStar_Syntax_Syntax.res_typ = _132_348; FStar_Syntax_Syntax.cflags = _36_756.FStar_Syntax_Syntax.cflags; FStar_Syntax_Syntax.comp = (fun _36_758 -> (match (()) with
| () -> begin
(let _132_347 = (lc.FStar_Syntax_Syntax.comp ())
in (subst_comp s _132_347))
end))}))))
...
let ps = (FStar_List.map (fun p -> (let _132_356 = (aux sub p)
in (Prims.fst _132_356))) ps)
in (((
...
let _36_799 = x
in (let _132_359 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_799.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_799.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_359}))
in (

let sub = (let _132_360 = (shift_subst (Prims.parse_int "1") sub)
in (FStar_Syntax_Syntax.NM (((x), ((Prims.parse_int "0")))))::_132_360)
in (((
...
let _36_807 = x
in (let _132_361 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_807.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_807.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_361}))
in (

let sub = (let _132_362 = (shift_subst (Prims.parse_int "1") sub)
in (FStar_Syntax_Syntax.NM (((x), ((Prims.parse_int "0")))))::_132_362)
in (((
...
let _36_817 = x
in (let _132_363 = (subst sub x.FStar_Syntax_Syntax.sort)
in {FStar_Syntax_Syntax.ppname = _36_817.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _36_817.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _132_363}))
in (
...
let _36_842 = (let _132_371 = (FStar_All.pipe_right us (FStar_List.mapi (fun i u -> (
...
in (FStar_All.pipe_right _132_371 FStar_List.unzip))
...
let x = (let _132_399 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in (FStar_Syntax_Syntax.freshen_bv _132_399))
...
let _36_892 = lb
in (let _132_403 = (subst u_let_rec_opening lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _36_892.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = us; FStar_Syntax_Syntax.lbtyp = _36_892.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _36_892.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _132_403}))
end)))))
in (
...
| (i, out) -> begin
(let _132_413 = (let _132_412 = (let _132_411 = (let _132_410 = (FStar_Util.left lb.FStar_Syntax_Syntax.lbname)
in ((_132_410), (i)))
in FStar_Syntax_Syntax.NM (_132_411))
in (_132_412)::out)
in (((i + (Prims.parse_int "1"))), (_132_413)))
end)) lbs (((Prims.parse_int "0")), ([])))
...
let _36_914 = lb
in (let _132_417 = (subst u_let_rec_closing lb.FStar_Syntax_Syntax.lbdef)
in {FStar_Syntax_Syntax.lbname = _36_914.FStar_Syntax_Syntax.lbname; FStar_Syntax_Syntax.lbunivs = _36_914.FStar_Syntax_Syntax.lbunivs; FStar_Syntax_Syntax.lbtyp = _36_914.FStar_Syntax_Syntax.lbtyp; FStar_Syntax_Syntax.lbeff = _36_914.FStar_Syntax_Syntax.lbeff; FStar_Syntax_Syntax.lbdef = _132_417}))
end)))))
in (
