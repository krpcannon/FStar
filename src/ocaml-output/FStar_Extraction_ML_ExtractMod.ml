...
let _79_11 = (FStar_Util.prefix x.FStar_Ident.ns)
in (match (_79_11) with
...
let _79_16 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _175_25 = (let _175_24 = (FStar_Absyn_Print.sigelt_to_string se)
...
let _79_32 = (FStar_Extraction_ML_ExtractTyp.extractSigElt g se)
in (match (_79_32) with
| (c, tds) -> begin
((c), (tds))
end))
end
| FStar_Absyn_Syntax.Sig_let (lbs, r, _79_36, quals) -> begin
(

let elet = (FStar_Absyn_Syntax.mk_Exp_let ((lbs), (FStar_Absyn_Const.exp_false_bool)) None r)
in (

let _79_46 = (FStar_Extraction_ML_ExtractExp.synth_exp g elet)
in (match (_79_46) with
| (ml_let, _79_43, _79_45) -> begin
(match (ml_let.FStar_Extraction_ML_Syntax.expr) with
| FStar_Extraction_ML_Syntax.MLE_Let ((flavor, _79_49, bindings), _79_53) -> begin
(

let _79_85 = (FStar_List.fold_left2 (fun _79_58 ml_lb _79_66 -> (match (((_79_58), (_79_66))) with
| ((env, ml_lbs), {FStar_Absyn_Syntax.lbname = lbname; FStar_Absyn_Syntax.lbtyp = t; FStar_Absyn_Syntax.lbeff = _79_63; FStar_Absyn_Syntax.lbdef = _79_61}) -> begin
(

let _79_82 = if (FStar_All.pipe_right quals (FStar_Util.for_some (fun _79_1 -> (match (_79_1) with
| FStar_Absyn_Syntax.Projector (_79_69) -> begin
true
end
| _79_72 -> begin
false
...
let _79_75 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = _79_75.FStar_Extraction_ML_Syntax.mllb_name; FStar_Extraction_ML_Syntax.mllb_tysc = _79_75.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = _79_75.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = _79_75.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = false})
in ((env), ((

let _79_78 = ml_lb
in {FStar_Extraction_ML_Syntax.mllb_name = (((Prims.snd mname)), ((Prims.parse_int "0"))); FStar_Extraction_ML_Syntax.mllb_tysc = _79_78.FStar_Extraction_ML_Syntax.mllb_tysc; FStar_Extraction_ML_Syntax.mllb_add_unit = _79_78.FStar_Extraction_ML_Syntax.mllb_add_unit; FStar_Extraction_ML_Syntax.mllb_def = _79_78.FStar_Extraction_ML_Syntax.mllb_def; FStar_Extraction_ML_Syntax.print_typ = _79_78.FStar_Extraction_ML_Syntax.print_typ}))))))
end else begin
...
let _79_104 = (extract_sig g se)
in (match (_79_104) with
| (g, mlm) -> begin
(

let is_record = (FStar_Util.for_some (fun _79_2 -> (match (_79_2) with
| FStar_Absyn_Syntax.RecordType (_79_107) -> begin
true
end
| _79_110 -> begin
false
end)) quals)
in (match ((FStar_Util.find_map quals (fun _79_3 -> (match (_79_3) with
...
| _79_120 -> begin
(match ((FStar_Util.find_map quals (fun _79_4 -> (match (_79_4) with
| FStar_Absyn_Syntax.Projector (l, _79_124) -> begin
Some (l)
end
| _79_128 -> begin
None
...
let _79_143 = (FStar_Extraction_ML_ExtractExp.synth_exp g e)
in (match (_79_143) with
| (ml_main, _79_140, _79_142) -> begin
...
let _79_166 = (FStar_Absyn_Util.reset_gensym ())
in (
...
let _79_169 = g
in {FStar_Extraction_ML_Env.tcenv = _79_169.FStar_Extraction_ML_Env.tcenv; FStar_Extraction_ML_Env.gamma = _79_169.FStar_Extraction_ML_Env.gamma; FStar_Extraction_ML_Env.tydefs = _79_169.FStar_Extraction_ML_Env.tydefs; FStar_Extraction_ML_Env.currentModule = name})
...
let _79_175 = (FStar_Util.fold_map extract_sig g m.FStar_Absyn_Syntax.declarations)
in (match (_79_175) with
| (g, sigs) -> begin
(
