...
let modules_to_sigtables = (fun mods -> (let _137_65 = (FStar_List.collect (fun _41_41 -> (match (_41_41) with
| (_41_39, m) -> begin
...
in {solver = _41_136.solver; range = _41_136.range; curmodule = _41_136.curmodule; gamma = _41_136.gamma; modules = _41_136.modules; expected_typ = _41_136.expected_typ; level = _41_136.level; sigtab = _137_322; is_pattern = _41_136.is_pattern; instantiate_targs = _41_136.instantiate_targs; instantiate_vargs = _41_136.instantiate_vargs; effects = _41_136.effects; generalize = _41_136.generalize; letrecs = _41_136.letrecs; top_level = _41_136.top_level; check_uvars = _41_136.check_uvars; use_eq = _41_136.use_eq; is_iface = _41_136.is_iface; admit = _41_136.admit; default_effects = _41_136.default_effects}))))
...
(let _137_571 = (FStar_List.map (fun _41_489 -> (match (_41_489) with
| (x, _41_488) -> begin
...
(let _137_620 = (let _137_619 = (FStar_List.map (fun _41_578 -> (match (_41_578) with
| (x, _41_577) -> begin
((x), (Some (FStar_Absyn_Syntax.Implicit (true))))
end)) tps)
...
in {FStar_Absyn_Syntax.n = _41_633.FStar_Absyn_Syntax.n; FStar_Absyn_Syntax.tk = _41_633.FStar_Absyn_Syntax.tk; FStar_Absyn_Syntax.pos = _137_623; FStar_Absyn_Syntax.fvs = _41_633.FStar_Absyn_Syntax.fvs; FStar_Absyn_Syntax.uvs = _41_633.FStar_Absyn_Syntax.uvs}))
end
| None -> begin
(not_found ())
end))))
...
in (FStar_Util.smap_fold _137_780 (fun _41_1021 v keys -> (let _137_779 = (FStar_Absyn_Util.lids_of_sigelt v)
