...
let r = (fun l dd -> (let _162_69 = (let _162_68 = (FStar_Syntax_Syntax.lid_as_fv (FStar_Ident.set_lid_range l rng) dd None)
in (FStar_All.pipe_right _162_68 FStar_Syntax_Syntax.fv_to_tm))
in Some (_162_69)))
in (
...
in (match ((let _162_72 = (compile_op_lid arity s rng)
in (FStar_Parser_Env.try_lookup_lid env _162_72))) with
| Some (t) -> begin
Some ((Prims.fst t))
end
| _66_186 -> begin
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _162_79 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _162_79)))
...
(let _162_86 = (free_type_vars env term)
in ((env), (_162_86)))
end
...
(let _162_87 = (free_type_vars env t)
in ((env), (_162_87)))
end))
and free_type_vars : FStar_Parser_Env.env  ->  FStar_Parser_AST.term  ->  FStar_Ident.ident Prims.list = (fun env t -> (match ((let _162_90 = (unparen t)
in _162_90.FStar_Parser_AST.tm)) with
...
(let _162_93 = (free_type_vars env t1)
in (let _162_92 = (free_type_vars env t2)
in (FStar_List.append _162_93 _162_92)))
end
...
| (env, f) -> begin
(let _162_94 = (free_type_vars env t)
in (FStar_List.append f _162_94))
end))
end
...
| (env, free) -> begin
(let _162_97 = (free_type_vars env body)
in (FStar_List.append free _162_97))
end))
end
...
let rec aux = (fun args t -> (match ((let _162_104 = (unparen t)
in _162_104.FStar_Parser_AST.tm)) with
...
let ftv = (let _162_109 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _162_109))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _162_113 = (let _162_112 = (let _162_111 = (tm_type x.FStar_Ident.idRange)
in ((x), (_162_111)))
in FStar_Parser_AST.TAnnotated (_162_112))
in (FStar_Parser_AST.mk_binder _162_113 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _162_118 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _162_118))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _162_122 = (let _162_121 = (let _162_120 = (tm_type x.FStar_Ident.idRange)
in ((x), (_162_120)))
in FStar_Parser_AST.TAnnotated (_162_121))
in (FStar_Parser_AST.mk_binder _162_122 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (

let t = (match ((let _162_123 = (unparen t)
in _162_123.FStar_Parser_AST.tm)) with
...
(let _162_141 = (let _162_140 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_162_140))
in ((_162_141), (args), (None)))
end
...
| (None, k) -> begin
(let _162_178 = (FStar_Syntax_Syntax.null_binder k)
in ((_162_178), (env)))
end
| (Some (a), k) -> begin
(
...
let tm' = (let _162_191 = (let _162_190 = (let _162_186 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.sread_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_186))
in (let _162_189 = (let _162_188 = (let _162_187 = (FStar_Syntax_Syntax.as_implicit false)
in ((tm), (_162_187)))
in (_162_188)::[])
in ((_162_190), (_162_189))))
in FStar_Syntax_Syntax.Tm_app (_162_191))
in (FStar_Syntax_Syntax.mk tm' None tm.FStar_Syntax_Syntax.pos)))


let mk_ref_alloc = (fun tm -> (

let tm' = (let _162_198 = (let _162_197 = (let _162_193 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.salloc_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_193))
in (let _162_196 = (let _162_195 = (let _162_194 = (FStar_Syntax_Syntax.as_implicit false)
in ((tm), (_162_194)))
in (_162_195)::[])
in ((_162_197), (_162_196))))
in FStar_Syntax_Syntax.Tm_app (_162_198))
in (FStar_Syntax_Syntax.mk tm' None tm.FStar_Syntax_Syntax.pos)))


let mk_ref_assign = (fun t1 t2 pos -> (

let tm = (let _162_210 = (let _162_209 = (let _162_202 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.swrite_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_202))
in (let _162_208 = (let _162_207 = (let _162_203 = (FStar_Syntax_Syntax.as_implicit false)
in ((t1), (_162_203)))
in (let _162_206 = (let _162_205 = (let _162_204 = (FStar_Syntax_Syntax.as_implicit false)
in ((t2), (_162_204)))
in (_162_205)::[])
in (_162_207)::_162_206))
in ((_162_209), (_162_208))))
in FStar_Syntax_Syntax.Tm_app (_162_210))
...
| (p, _66_535) -> begin
(let _162_259 = (pat_vars p)
in (FStar_Util.set_union out _162_259))
...
(let _162_295 = (let _162_294 = (let _162_293 = (let _162_292 = (let _162_291 = (compile_op (Prims.parse_int "0") op)
in (FStar_Ident.id_of_text _162_291))
in ((_162_292), (None)))
in FStar_Parser_AST.PatVar (_162_293))
in {FStar_Parser_AST.pat = _162_294; FStar_Parser_AST.prange = p.FStar_Parser_AST.prange})
in (aux loc env _162_295))
end
...
let t = (let _162_298 = (close_fun env t)
in (desugar_term env _162_298))
in LocalBinder ((((
...
in (let _162_299 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_wild (x)))
in ((loc), (env), (LocalBinder (((x), (None)))), (_162_299), (false))))
end
| FStar_Parser_AST.PatConst (c) -> begin
(

let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _162_300 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_constant (c)))
...
| (loc, env, xbv) -> begin
(let _162_301 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_var (xbv)))
in ((loc), (env), (LocalBinder (((xbv), (aq)))), (_162_301), (imp)))
end))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _162_302 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), ([])))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_162_302), (false)))))
end
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _162_305 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_162_305), (false)))))
end))
end
...
let pat = (let _162_318 = (let _162_317 = (let _162_313 = (FStar_Range.end_range p.FStar_Parser_AST.prange)
in (pos_r _162_313))
in (let _162_316 = (let _162_315 = (let _162_314 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.nil_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_162_314), ([])))
in FStar_Syntax_Syntax.Pat_cons (_162_315))
in (FStar_All.pipe_left _162_317 _162_316)))
in (FStar_List.fold_right (fun hd tl -> (

let r = (FStar_Range.union_ranges hd.FStar_Syntax_Syntax.p tl.FStar_Syntax_Syntax.p)
in (let _162_312 = (let _162_311 = (let _162_310 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.cons_lid FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor)))
in ((_162_310), ((((hd), (false)))::(((tl), (false)))::[])))
in FStar_Syntax_Syntax.Pat_cons (_162_311))
in (FStar_All.pipe_left (pos_r r) _162_312)))) pats _162_318))
in (
...
let x = (FStar_Syntax_Syntax.new_bv (Some (p.FStar_Parser_AST.prange)) FStar_Syntax_Syntax.tun)
in (let _162_321 = (FStar_All.pipe_left pos (FStar_Syntax_Syntax.Pat_cons (((l), (args)))))
in ((loc), (env), (LocalBinder (((x), (None)))), (_162_321), (false)))))
end))))
end))
end
...
| (f, p) -> begin
(let _162_323 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.qualify_field_to_record env record) f)
in ((_162_323), (p)))
end))))
in (
...
(let _162_332 = (let _162_331 = (let _162_330 = (

let _66_799 = fv
in (let _162_329 = (let _162_328 = (let _162_327 = (let _162_326 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_Env.typename), (_162_326)))
in FStar_Syntax_Syntax.Record_ctor (_162_327))
in Some (_162_328))
in {FStar_Syntax_Syntax.fv_name = _66_799.FStar_Syntax_Syntax.fv_name; FStar_Syntax_Syntax.fv_delta = _66_799.FStar_Syntax_Syntax.fv_delta; FStar_Syntax_Syntax.fv_qual = _162_329}))
in ((_162_330), (args)))
in FStar_Syntax_Syntax.Pat_cons (_162_331))
in (FStar_All.pipe_left pos _162_332))
end
| _66_802 -> begin
p
end)
...
let _66_812 = (let _162_333 = (check_linear_pattern_variables p)
in (FStar_All.pipe_left Prims.ignore _162_333))
in ((env), (b), (p)))
end)))))))))
...
let mklet = (fun x -> (let _162_342 = (let _162_341 = (let _162_340 = (FStar_Parser_Env.qualify env x)
in ((_162_340), (FStar_Syntax_Syntax.tun)))
in LetBinder (_162_341))
in ((env), (_162_342), (None))))
in if top then begin
(match (p.FStar_Parser_AST.pat) with
| FStar_Parser_AST.PatOp (x) -> begin
(let _162_344 = (let _162_343 = (compile_op (Prims.parse_int "0") x)
in (FStar_Ident.id_of_text _162_343))
in (mklet _162_344))
end
...
(let _162_348 = (let _162_347 = (let _162_346 = (FStar_Parser_Env.qualify env x)
in (let _162_345 = (desugar_term env t)
in ((_162_346), (_162_345))))
in LetBinder (_162_347))
in ((env), (_162_348), (None)))
end
| _66_839 -> begin
...
| None -> begin
(let _162_364 = (FStar_Util.format1 "%s not in scope\n" (FStar_Ident.text_of_lid lid))
in (FStar_All.failwith _162_364))
end)
in (

let repr = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_int (((repr), (None))))) None range)
in (let _162_369 = (let _162_368 = (let _162_367 = (let _162_366 = (let _162_365 = (FStar_Syntax_Syntax.as_implicit false)
in ((repr), (_162_365)))
in (_162_366)::[])
in ((lid), (_162_367)))
in FStar_Syntax_Syntax.Tm_app (_162_368))
in (FStar_Syntax_Syntax.mk _162_369 None range))))))
end))
...
in (match ((let _162_377 = (unparen top)
in _162_377.FStar_Parser_AST.tm)) with
...
| FStar_Parser_AST.Op ("*", (_66_934)::(_66_932)::[]) when (let _162_378 = (op_as_term env (Prims.parse_int "2") top.FStar_Parser_AST.range "*")
in (FStar_All.pipe_right _162_378 FStar_Option.isNone)) -> begin
(

let rec flatten = (fun t -> (match (t.FStar_Parser_AST.tm) with
| FStar_Parser_AST.Op ("*", (t1)::(t2)::[]) -> begin
(let _162_381 = (flatten t1)
in (FStar_List.append _162_381 ((t2)::[])))
end
| _66_947 -> begin
(t)::[]
end))
...
let targs = (let _162_385 = (let _162_382 = (unparen top)
in (flatten _162_382))
in (FStar_All.pipe_right _162_385 (FStar_List.map (fun t -> (let _162_384 = (desugar_typ env t)
in (FStar_Syntax_Syntax.as_arg _162_384))))))
in (

let _66_953 = (let _162_386 = (FStar_Syntax_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) _162_386))
...
| FStar_Parser_AST.Tvar (a) -> begin
(let _162_388 = (let _162_387 = (FStar_Parser_Env.fail_or2 (FStar_Parser_Env.try_lookup_id env) a)
in (Prims.fst _162_387))
in (FStar_All.pipe_left setpos _162_388))
end
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _162_390 = (desugar_term env t)
in ((_162_390), (None))))))
...
| FStar_Parser_AST.Var ({FStar_Ident.ns = (eff)::rest; FStar_Ident.ident = {FStar_Ident.idText = txt; FStar_Ident.idRange = _66_1015}; FStar_Ident.nsstr = _66_1013; FStar_Ident.str = _66_1011}) when ((is_special_effect_combinator txt) && (let _162_391 = (FStar_Ident.lid_of_ids ((eff)::rest))
in (FStar_Parser_Env.is_effect_name env _162_391))) -> begin
(match ((let _162_392 = (FStar_Ident.lid_of_ids ((eff)::rest))
in (FStar_Parser_Env.try_lookup_effect_defn env _162_392))) with
| Some (ed) -> begin
(let _162_393 = (FStar_Ident.lid_of_path (FStar_Ident.path_of_text (Prims.strcat (FStar_Ident.text_of_lid ed.FStar_Syntax_Syntax.mname) (Prims.strcat "_" txt))) FStar_Range.dummyRange)
in (FStar_Syntax_Syntax.fvar _162_393 (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None))
end
| None -> begin
...
(let _162_396 = (let _162_395 = (let _162_394 = (mk_ref_read tm)
in ((_162_394), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Mutable_rval))))
in FStar_Syntax_Syntax.Tm_meta (_162_395))
in (FStar_All.pipe_left mk _162_396))
end else begin
tm
end)
end))
...
let _66_1051 = (let _162_397 = (mk (FStar_Syntax_Syntax.Tm_fvar (head)))
in ((_162_397), (true)))
...
| None -> begin
(let _162_401 = (FStar_Syntax_Syntax.new_bv (Some (top.FStar_Parser_AST.range)) FStar_Syntax_Syntax.tun)
in ((env), (_162_401)))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _162_405 = (let _162_404 = (let _162_403 = (let _162_402 = (no_annot_abs tparams t)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _162_402))
in (_162_403)::[])
in (FStar_List.append typs _162_404))
in ((env), ((FStar_List.append tparams (((((

let _66_1089 = x
in {FStar_Syntax_Syntax.ppname = _66_1089.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _66_1089.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = t})), (None)))::[]))), (_162_405)))
end))
end))
...
let _66_1099 = (let _162_406 = (FStar_Syntax_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) _162_406))
...
in (let _162_413 = (FStar_Syntax_Util.arrow (FStar_List.rev bs) cod)
in (FStar_All.pipe_left setpos _162_413)))
end
| (hd)::tl -> begin
(
...
in (let _162_414 = (FStar_Syntax_Util.refine x f)
in (FStar_All.pipe_left setpos _162_414)))
end))
end)
end
...
(let _162_418 = (let _162_417 = (free_type_vars env t)
in (FStar_List.append _162_417 ftvs))
in ((env), (_162_418)))
end
| _66_1152 -> begin
((env), (ftvs))
...
let binders = (let _162_420 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append _162_420 binders))
in (
...
let body = (let _162_430 = (let _162_429 = (FStar_Syntax_Syntax.pat_bvs pat)
in (FStar_All.pipe_right _162_429 (FStar_List.map FStar_Syntax_Syntax.mk_binder)))
in (FStar_Syntax_Subst.close _162_430 body))
in (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_match (((sc), ((((pat), (None), (body)))::[])))) None body.FStar_Syntax_Syntax.pos))
end
| None -> begin
body
end)
in (let _162_431 = (no_annot_abs (FStar_List.rev bs) body)
in (setpos _162_431))))
end
| (p)::rest -> begin
(
...
| (Some (p), None) -> begin
(let _162_433 = (let _162_432 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_162_432), (p)))
in Some (_162_433))
end
...
let tup2 = (let _162_434 = (FStar_Syntax_Util.mk_tuple_data_lid (Prims.parse_int "2") top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _162_434 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = (let _162_442 = (let _162_441 = (let _162_440 = (mk (FStar_Syntax_Syntax.Tm_fvar (tup2)))
in (let _162_439 = (let _162_438 = (FStar_Syntax_Syntax.as_arg sc)
in (let _162_437 = (let _162_436 = (let _162_435 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _162_435))
in (_162_436)::[])
in (_162_438)::_162_437))
in ((_162_440), (_162_439))))
in FStar_Syntax_Syntax.Tm_app (_162_441))
in (FStar_Syntax_Syntax.mk _162_442 None top.FStar_Parser_AST.range))
in (

let p = (let _162_443 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tup2), ((((p'), (false)))::(((p), (false)))::[])))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _162_443))
in Some (((sc), (p))))))
end
| (FStar_Syntax_Syntax.Tm_app (_66_1213, args), FStar_Syntax_Syntax.Pat_cons (_66_1218, pats)) -> begin
(

let tupn = (let _162_444 = (FStar_Syntax_Util.mk_tuple_data_lid ((Prims.parse_int "1") + (FStar_List.length args)) top.FStar_Parser_AST.range)
in (FStar_Syntax_Syntax.lid_as_fv _162_444 FStar_Syntax_Syntax.Delta_constant (Some (FStar_Syntax_Syntax.Data_ctor))))
in (

let sc = (let _162_451 = (let _162_450 = (let _162_449 = (mk (FStar_Syntax_Syntax.Tm_fvar (tupn)))
in (let _162_448 = (let _162_447 = (let _162_446 = (let _162_445 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _162_445))
in (_162_446)::[])
in (FStar_List.append args _162_447))
in ((_162_449), (_162_448))))
in FStar_Syntax_Syntax.Tm_app (_162_450))
in (mk _162_451))
in (

let p = (let _162_452 = (FStar_Range.union_ranges p'.FStar_Syntax_Syntax.p p.FStar_Syntax_Syntax.p)
in (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_cons (((tupn), ((FStar_List.append pats ((((p), (false)))::[])))))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n _162_452))
in Some (((sc), (p))))))
end
| _66_1227 -> begin
(FStar_All.failwith "Impossible")
...
in (let _162_460 = (let _162_459 = (let _162_458 = (FStar_Syntax_Syntax.fvar a FStar_Syntax_Syntax.Delta_equational None)
in (let _162_457 = (let _162_456 = (FStar_Syntax_Syntax.as_arg phi)
in (let _162_455 = (let _162_454 = (let _162_453 = (mk (FStar_Syntax_Syntax.Tm_constant (FStar_Const.Const_unit)))
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _162_453))
in (_162_454)::[])
in (_162_456)::_162_455))
in ((_162_458), (_162_457))))
in FStar_Syntax_Syntax.Tm_app (_162_459))
in (mk _162_460))))
end
| FStar_Parser_AST.App (_66_1246) -> begin
(

let rec aux = (fun args e -> (match ((let _162_465 = (unparen e)
in _162_465.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, t, imp) -> begin
(

let arg = (let _162_466 = (desugar_term env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _162_466))
in (aux ((arg)::args) e))
end
| _66_1258 -> begin
(
...
(let _162_469 = (let _162_468 = (let _162_467 = (desugar_term env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((_162_467), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Sequence))))
in FStar_Syntax_Syntax.Tm_meta (_162_468))
in (mk _162_469))
end
...
(let _162_473 = (destruct_app_pattern env top_level p)
in ((_162_473), (def)))
end else begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _162_474 = (destruct_app_pattern env top_level p)
in ((_162_474), (def)))
end
| _66_1291 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(let _162_477 = (let _162_476 = (let _162_475 = (FStar_Parser_Env.qualify env id)
in FStar_Util.Inr (_162_475))
in ((_162_476), ([]), (Some (t))))
in ((_162_477), (def)))
end else begin
...
| (env, xx) -> begin
(let _162_484 = (let _162_483 = (FStar_Syntax_Syntax.mk_binder xx)
in (_162_483)::rec_bindings)
in ((env), (FStar_Util.Inl (xx)), (_162_484)))
end))
end
| FStar_Util.Inr (l) -> begin
(let _162_485 = (FStar_Parser_Env.push_top_level_rec_binding env l.FStar_Ident.ident FStar_Syntax_Syntax.Delta_equational)
in ((_162_485), (FStar_Util.Inr (l)), (rec_bindings)))
end)
...
in (let _162_493 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t)))) _162_493 FStar_Parser_AST.Expr)))
end)
in (
...
| FStar_Util.Inr (l) -> begin
(let _162_495 = (let _162_494 = (FStar_Syntax_Util.incr_delta_qualifier body)
in (FStar_Syntax_Syntax.lid_as_fv l _162_494 None))
in FStar_Util.Inr (_162_495))
end)
in (
...
let body = (desugar_term env' body)
in (let _162_498 = (let _162_497 = (let _162_496 = (FStar_Syntax_Subst.close rec_bindings body)
in ((((is_rec), (lbs))), (_162_496)))
in FStar_Syntax_Syntax.Tm_let (_162_497))
in (FStar_All.pipe_left mk _162_498))))))
end))))
end))
in (
...
let fv = (let _162_505 = (FStar_Syntax_Util.incr_delta_qualifier t1)
in (FStar_Syntax_Syntax.lid_as_fv l _162_505 None))
...
| Some (pat) -> begin
(let _162_510 = (let _162_509 = (let _162_508 = (FStar_Syntax_Syntax.bv_to_name x)
in (let _162_507 = (let _162_506 = (FStar_Syntax_Util.branch ((pat), (None), (body)))
in (_162_506)::[])
in ((_162_508), (_162_507))))
in FStar_Syntax_Syntax.Tm_match (_162_509))
in (FStar_Syntax_Syntax.mk _162_510 None body.FStar_Syntax_Syntax.pos))
end)
in (let _162_515 = (let _162_514 = (let _162_513 = (let _162_512 = (let _162_511 = (FStar_Syntax_Syntax.mk_binder x)
in (_162_511)::[])
in (FStar_Syntax_Subst.close _162_512 body))
in ((((false), (((mk_lb ((FStar_Util.Inl (x)), (x.FStar_Syntax_Syntax.sort), (t1))))::[]))), (_162_513)))
in FStar_Syntax_Syntax.Tm_let (_162_514))
in (FStar_All.pipe_left mk _162_515))))
end)
...
in (let _162_526 = (let _162_525 = (let _162_524 = (desugar_term env t1)
in (let _162_523 = (let _162_522 = (let _162_517 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_constant (FStar_Const.Const_bool (true))) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t2.FStar_Parser_AST.range)
in (let _162_516 = (desugar_term env t2)
in ((_162_517), (None), (_162_516))))
in (let _162_521 = (let _162_520 = (let _162_519 = (FStar_Syntax_Syntax.withinfo (FStar_Syntax_Syntax.Pat_wild (x)) FStar_Syntax_Syntax.tun.FStar_Syntax_Syntax.n t3.FStar_Parser_AST.range)
in (let _162_518 = (desugar_term env t3)
in ((_162_519), (None), (_162_518))))
in (_162_520)::[])
in (_162_522)::_162_521))
in ((_162_524), (_162_523))))
in FStar_Syntax_Syntax.Tm_match (_162_525))
in (mk _162_526)))
end
...
| Some (e) -> begin
(let _162_529 = (desugar_term env e)
in Some (_162_529))
end)
in (
...
in (let _162_533 = (let _162_532 = (let _162_531 = (desugar_term env e)
in (let _162_530 = (FStar_List.map desugar_branch branches)
in ((_162_531), (_162_530))))
in FStar_Syntax_Syntax.Tm_match (_162_532))
in (FStar_All.pipe_left mk _162_533)))
end
...
in ((_162_534), (annot), (None)))
in FStar_Syntax_Syntax.Tm_ascribed (_162_535))
...
(match (xopt) with
| None -> begin
(let _162_547 = (let _162_546 = (let _162_545 = (FStar_Util.format1 "Field %s is missing" (FStar_Ident.text_of_lid f))
in ((_162_545), (top.FStar_Parser_AST.range)))
in FStar_Syntax_Syntax.Error (_162_546))
in (Prims.raise _162_547))
end
| Some (x) -> begin
(let _162_548 = (qfn fn)
in ((_162_548), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Project (((x), (f)))) x.FStar_Parser_AST.range x.FStar_Parser_AST.level))))
end)
end))))
in (
...
| None -> begin
(let _162_553 = (let _162_552 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1492 -> (match (_66_1492) with
| (f, _66_1491) -> begin
(let _162_551 = (let _162_550 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _162_550))
in ((_162_551), (FStar_Parser_AST.Nothing)))
end))))
in ((record.FStar_Parser_Env.constrname), (_162_552)))
in FStar_Parser_AST.Construct (_162_553))
end
| Some (e) -> begin
(
...
let xterm = (let _162_555 = (let _162_554 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_162_554))
in (FStar_Parser_AST.mk_term _162_555 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let record = (let _162_558 = (let _162_557 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map (fun _66_1500 -> (match (_66_1500) with
| (f, _66_1499) -> begin
(get_field (Some (xterm)) f)
end))))
in ((None), (_162_557)))
in FStar_Parser_AST.Record (_162_558))
...
let e = (let _162_565 = (let _162_564 = (let _162_563 = (let _162_562 = (let _162_561 = (let _162_560 = (let _162_559 = (FStar_All.pipe_right record.FStar_Parser_Env.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_Env.typename), (_162_559)))
in FStar_Syntax_Syntax.Record_ctor (_162_560))
in Some (_162_561))
in (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v e.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant _162_562))
in ((_162_563), (args)))
in FStar_Syntax_Syntax.Tm_app (_162_564))
in (FStar_All.pipe_left mk _162_565))
...
in (let _162_570 = (let _162_569 = (let _162_568 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range fieldname (FStar_Ident.range_of_lid f)) FStar_Syntax_Syntax.Delta_equational qual)
in (let _162_567 = (let _162_566 = (FStar_Syntax_Syntax.as_arg e)
in (_162_566)::[])
in ((_162_568), (_162_567))))
in FStar_Syntax_Syntax.Tm_app (_162_569))
in (FStar_All.pipe_left mk _162_570)))))
end))
end
...
| (a, imp) -> begin
(let _162_574 = (desugar_term env a)
in (arg_withimp_e imp _162_574))
end)))))
...
| (t, _66_1594) -> begin
(match ((let _162_582 = (unparen t)
in _162_582.FStar_Parser_AST.tm)) with
...
| (t, _66_1604) -> begin
(match ((let _162_585 = (unparen t)
in _162_585.FStar_Parser_AST.tm)) with
...
(let _162_594 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_effect_name env) l)
in ((_162_594), (args)))
end
| FStar_Parser_AST.Name (l) when ((let _162_595 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _162_595 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "Tot")) -> begin
(((FStar_Ident.set_lid_range FStar_Syntax_Const.effect_Tot_lid head.FStar_Parser_AST.range)), (args))
end
| FStar_Parser_AST.Name (l) when ((let _162_596 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals _162_596 FStar_Syntax_Const.prims_lid)) && (l.FStar_Ident.ident.FStar_Ident.idText = "GTot")) -> begin
...
| _66_1670 -> begin
(let _162_598 = (let _162_597 = (FStar_Parser_AST.term_to_string t)
in (FStar_Util.format1 "%s is not an effect" _162_597))
in (fail _162_598))
end)
end)))
in (
...
(let _162_600 = (let _162_599 = (FStar_Syntax_Print.lid_to_string eff)
in (FStar_Util.format1 "Not enough args to effect %s" _162_599))
in (fail _162_600))
end else begin
()
end
...
let _66_1678 = (let _162_602 = (FStar_List.hd args)
in (let _162_601 = (FStar_List.tl args)
in ((_162_602), (_162_601))))
...
let pattern = (let _162_605 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range FStar_Syntax_Const.pattern_lid pat.FStar_Syntax_Syntax.pos) FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.mk_Tm_uinst _162_605 ((FStar_Syntax_Syntax.U_zero)::[])))
in (FStar_Syntax_Syntax.mk_Tm_app nil ((((pattern), (Some (FStar_Syntax_Syntax.imp_tag))))::[]) None pat.FStar_Syntax_Syntax.pos)))
end
| _66_1733 -> begin
pat
end)
in (let _162_609 = (let _162_608 = (let _162_607 = (let _162_606 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_meta (((pat), (FStar_Syntax_Syntax.Meta_desugared (FStar_Syntax_Syntax.Meta_smt_pat))))) None pat.FStar_Syntax_Syntax.pos)
in ((_162_606), (aq)))
in (_162_607)::[])
in (ens)::_162_608)
in (req)::_162_609))
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _162_644 = (desugar_term env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _162_644)))))) pats))
in (match (tk) with
| (Some (a), k) -> begin
(
...
let body = (let _162_647 = (let _162_646 = (let _162_645 = (FStar_Syntax_Syntax.mk_binder a)
in (_162_645)::[])
in (no_annot_abs _162_646 body))
in (FStar_All.pipe_left setpos _162_647))
in (let _162_652 = (let _162_651 = (let _162_650 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) (FStar_Syntax_Syntax.Delta_defined_at_level ((Prims.parse_int "1"))) None)
in (let _162_649 = (let _162_648 = (FStar_Syntax_Syntax.as_arg body)
in (_162_648)::[])
in ((_162_650), (_162_649))))
in FStar_Syntax_Syntax.Tm_app (_162_651))
in (FStar_All.pipe_left mk _162_652)))))))
end))
end
| _66_1788 -> begin
(FStar_All.failwith "impossible")
...
let body = (let _162_667 = (q ((rest), (pats), (body)))
in (let _162_666 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _162_667 _162_666 FStar_Parser_AST.Formula)))
in (let _162_668 = (q (((b)::[]), ([]), (body)))
in (FStar_Parser_AST.mk_term _162_668 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _66_1802 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _162_669 = (unparen f)
in _162_669.FStar_Parser_AST.tm)) with
...
in (let _162_671 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _162_671)))
end
| FStar_Parser_AST.QExists ((_1)::(_2)::_3, pats, body) -> begin
(

let binders = (_1)::(_2)::_3
in (let _162_673 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _162_673)))
end
...
(let _162_680 = (desugar_typ env t)
in ((Some (x)), (_162_680)))
end
| FStar_Parser_AST.TVariable (x) -> begin
(let _162_681 = (FStar_Syntax_Syntax.mk (FStar_Syntax_Syntax.Tm_type (FStar_Syntax_Syntax.U_unknown)) None x.FStar_Ident.idRange)
in ((Some (x)), (_162_681)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _162_682 = (desugar_typ env t)
in ((None), (_162_682)))
end
...
let binders = (let _162_699 = (let _162_698 = (FStar_Syntax_Util.arrow_formals k)
in (Prims.fst _162_698))
in (FStar_List.append tps _162_699))
in (
...
let binders = (let _162_705 = (let _162_704 = (let _162_703 = (let _162_702 = (let _162_701 = (FStar_Syntax_Syntax.lid_as_fv t FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_701))
in (FStar_Syntax_Syntax.mk_Tm_app _162_702 args None p))
in (FStar_All.pipe_left FStar_Syntax_Syntax.null_binder _162_703))
in (_162_704)::[])
in (FStar_List.append imp_binders _162_705))
in (

let disc_type = (let _162_708 = (let _162_707 = (let _162_706 = (FStar_Syntax_Syntax.lid_as_fv FStar_Syntax_Const.bool_lid FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_706))
in (FStar_Syntax_Syntax.mk_Total _162_707))
in (FStar_Syntax_Util.arrow binders _162_708))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (

let disc_name = (FStar_Syntax_Util.mk_discriminator d)
in (let _162_711 = (let _162_710 = (quals ((FStar_Syntax_Syntax.Logic)::(FStar_Syntax_Syntax.Discriminator (d))::[]))
in ((disc_name), ([]), (disc_type), (_162_710), ((FStar_Ident.range_of_lid disc_name))))
in FStar_Syntax_Syntax.Sig_declare_typ (_162_711)))))))))
end)))))))
...
let indices = (FStar_All.pipe_right args (FStar_List.map (fun _66_2036 -> (let _162_743 = (FStar_Syntax_Syntax.new_bv (Some (p)) FStar_Syntax_Syntax.tun)
in (FStar_All.pipe_right _162_743 FStar_Syntax_Syntax.mk_binder)))))
in (

let arg_typ = (let _162_748 = (let _162_744 = (FStar_Syntax_Syntax.lid_as_fv tc FStar_Syntax_Syntax.Delta_constant None)
in (FStar_Syntax_Syntax.fv_to_tm _162_744))
in (let _162_747 = (FStar_All.pipe_right (FStar_List.append tps indices) (FStar_List.map (fun _66_2041 -> (match (_66_2041) with
| (x, imp) -> begin
(let _162_746 = (FStar_Syntax_Syntax.bv_to_name x)
in ((_162_746), (imp)))
end))))
in (FStar_Syntax_Syntax.mk_Tm_app _162_748 _162_747 None p)))
in (

let arg_binder = if (not (refine_domain)) then begin
(let _162_749 = (projectee arg_typ)
in (FStar_Syntax_Syntax.mk_binder _162_749))
end else begin
(
...
in (let _162_756 = (let _162_755 = (let _162_754 = (let _162_753 = (FStar_Syntax_Syntax.fvar (FStar_Ident.set_lid_range disc_name p) FStar_Syntax_Syntax.Delta_equational None)
in (let _162_752 = (let _162_751 = (let _162_750 = (FStar_Syntax_Syntax.bv_to_name x)
in (FStar_All.pipe_left FStar_Syntax_Syntax.as_arg _162_750))
in (_162_751)::[])
in (FStar_Syntax_Syntax.mk_Tm_app _162_753 _162_752 None p)))
in (FStar_Syntax_Util.b2t _162_754))
in (FStar_Syntax_Util.refine x _162_755))
in {FStar_Syntax_Syntax.ppname = _66_2045.FStar_Syntax_Syntax.ppname; FStar_Syntax_Syntax.index = _66_2045.FStar_Syntax_Syntax.index; FStar_Syntax_Syntax.sort = _162_756}))
in (FStar_Syntax_Syntax.mk_binder _162_757))))
end
...
let imp_binders = (let _162_759 = (FStar_All.pipe_right indices (FStar_List.map (fun _66_2055 -> (match (_66_2055) with
| (x, _66_2054) -> begin
((x), (Some (FStar_Syntax_Syntax.imp_tag)))
end))))
in (FStar_List.append imp_tps _162_759))
in (
...
let proj = (let _162_763 = (let _162_762 = (FStar_Syntax_Syntax.lid_as_fv field_name FStar_Syntax_Syntax.Delta_equational None)
in (FStar_Syntax_Syntax.fv_to_tm _162_762))
in (FStar_Syntax_Syntax.mk_Tm_app _162_763 ((arg)::[]) None p))
...
in (let _162_802 = (FStar_All.pipe_right fields (FStar_List.mapi (fun i _66_2076 -> (match (_66_2076) with
| (x, _66_2075) -> begin
(
...
let t = (let _162_767 = (let _162_766 = (FStar_Syntax_Subst.subst subst x.FStar_Syntax_Syntax.sort)
in (FStar_Syntax_Syntax.mk_Total _162_766))
in (FStar_Syntax_Util.arrow binders _162_767))
in (

let only_decl = (((let _162_768 = (FStar_Parser_Env.current_module env)
in (FStar_Ident.lid_equals FStar_Syntax_Const.prims_lid _162_768)) || (fvq <> FStar_Syntax_Syntax.Data_ctor)) || (let _162_770 = (let _162_769 = (FStar_Parser_Env.current_module env)
in _162_769.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _162_770)))
in (
...
(let _162_774 = (FStar_List.filter (fun _66_12 -> (match (_66_12) with
...
in (FStar_Syntax_Syntax.Assumption)::_162_774)
end else begin
q
end)
in (
...
(let _162_778 = (pos (FStar_Syntax_Syntax.Pat_var (projection)))
in ((_162_778), (b)))
end else begin
if (b && (j < ntps)) then begin
(let _162_782 = (let _162_781 = (let _162_780 = (let _162_779 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in ((_162_779), (FStar_Syntax_Syntax.tun)))
in FStar_Syntax_Syntax.Pat_dot_term (_162_780))
in (pos _162_781))
in ((_162_782), (b)))
end else begin
(let _162_785 = (let _162_784 = (let _162_783 = (FStar_Syntax_Syntax.gen_bv x.FStar_Syntax_Syntax.ppname.FStar_Ident.idText None FStar_Syntax_Syntax.tun)
in FStar_Syntax_Syntax.Pat_wild (_162_783))
in (pos _162_784))
in ((_162_785), (b)))
end
end)
...
let pat = (let _162_790 = (let _162_788 = (let _162_787 = (let _162_786 = (FStar_Syntax_Syntax.lid_as_fv lid FStar_Syntax_Syntax.Delta_constant (Some (fvq)))
in ((_162_786), (arg_pats)))
in FStar_Syntax_Syntax.Pat_cons (_162_787))
in (FStar_All.pipe_right _162_788 pos))
in (let _162_789 = (FStar_Syntax_Syntax.bv_to_name projection)
in ((_162_790), (None), (_162_789))))
in (

let body = (let _162_794 = (let _162_793 = (let _162_792 = (let _162_791 = (FStar_Syntax_Util.branch pat)
in (_162_791)::[])
in ((arg_exp), (_162_792)))
in FStar_Syntax_Syntax.Tm_match (_162_793))
in (FStar_Syntax_Syntax.mk _162_794 None p))
in (
...
let lb = (let _162_796 = (let _162_795 = (FStar_Syntax_Syntax.lid_as_fv field_name dd None)
in FStar_Util.Inr (_162_795))
in {FStar_Syntax_Syntax.lbname = _162_796; FStar_Syntax_Syntax.lbunivs = []; FStar_Syntax_Syntax.lbtyp = FStar_Syntax_Syntax.tun; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = imp})
in (

let impl = (let _162_801 = (let _162_800 = (let _162_799 = (let _162_798 = (FStar_All.pipe_right lb.FStar_Syntax_Syntax.lbname FStar_Util.right)
in (FStar_All.pipe_right _162_798 (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in (_162_799)::[])
in ((((false), ((lb)::[]))), (p), (_162_800), (quals)))
in FStar_Syntax_Syntax.Sig_let (_162_801))
...
in (FStar_All.pipe_right _162_802 FStar_List.flatten)))))))))
end)))))))
...
let dd = if (FStar_All.pipe_right quals (FStar_List.contains FStar_Syntax_Syntax.Abstract)) then begin
(let _162_827 = (FStar_Syntax_Util.incr_delta_qualifier t)
in FStar_Syntax_Syntax.Delta_abstract (_162_827))
end else begin
(FStar_Syntax_Util.incr_delta_qualifier t)
end
in (

let lb = (let _162_832 = (let _162_828 = (FStar_Syntax_Syntax.lid_as_fv lid dd None)
in FStar_Util.Inr (_162_828))
in (let _162_831 = (let _162_829 = (FStar_Syntax_Syntax.mk_Total k)
in (FStar_Syntax_Util.arrow typars _162_829))
in (let _162_830 = (no_annot_abs typars t)
in {FStar_Syntax_Syntax.lbname = _162_832; FStar_Syntax_Syntax.lbunivs = uvs; FStar_Syntax_Syntax.lbtyp = _162_831; FStar_Syntax_Syntax.lbeff = FStar_Syntax_Const.effect_Tot_lid; FStar_Syntax_Syntax.lbdef = _162_830})))
...
(let _162_846 = (let _162_845 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_162_845))
in (FStar_Parser_AST.mk_term _162_846 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _162_859 = (let _162_858 = (let _162_857 = (binder_to_term b)
in ((out), (_162_857), ((imp_of_aqual b))))
in FStar_Parser_AST.App (_162_858))
in (FStar_Parser_AST.mk_term _162_859 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _162_865 = (let _162_864 = (let _162_863 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_162_863))
in (FStar_Parser_AST.mk_term _162_864 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _162_865 parms))
in (

let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product (((mfields), ((with_constructor_effect result))))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _162_867 = (FStar_All.pipe_right fields (FStar_List.map (fun _66_2260 -> (match (_66_2260) with
| (x, _66_2257, _66_2259) -> begin
(FStar_Parser_Env.qualify env x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_162_867)))))))
end
| _66_2262 -> begin
(FStar_All.failwith "impossible")
end))
...
let tconstr = (let _162_878 = (let _162_877 = (let _162_876 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_162_876))
in (FStar_Parser_AST.mk_term _162_877 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _162_878 binders))
in (
...
| None -> begin
(let _162_885 = (tm_type_z id.FStar_Ident.idRange)
in Some (_162_885))
end
| _66_2313 -> begin
kopt
...
let _66_2335 = (let _162_887 = (FStar_Range.string_of_range rng)
in (let _162_886 = (FStar_Syntax_Print.lid_to_string l)
...
| _66_2340 -> begin
(let _162_890 = (let _162_889 = (let _162_888 = (FStar_Syntax_Syntax.mk_Total k)
in ((typars), (_162_888)))
in FStar_Syntax_Syntax.Tm_arrow (_162_889))
in (FStar_Syntax_Syntax.mk _162_890 None rng))
end)
...
in (let _162_896 = (let _162_895 = (FStar_Parser_Env.qualify env id)
in (let _162_894 = (FStar_All.pipe_right quals (FStar_List.filter (fun _66_21 -> (match (_66_21) with
| FStar_Syntax_Syntax.Effect -> begin
false
end
| _66_2376 -> begin
...
in ((_162_895), ([]), (typars), (c), (_162_894), (rng))))
in FStar_Syntax_Syntax.Sig_effect_abbrev (_162_896)))))
end else begin
(
...
in (let _162_906 = (let _162_905 = (mk_typ_abbrev id uvs tpars k t ((id)::[]) quals rng)
in (([]), (_162_905)))
in (_162_906)::[]))
end))
end
...
let _66_2515 = (let _162_918 = (FStar_All.pipe_right constrs (FStar_List.map (fun _66_2496 -> (match (_66_2496) with
...
let t = (let _162_910 = (FStar_Parser_Env.default_total env_tps)
in (let _162_909 = (close env_tps t)
in (desugar_term _162_910 _162_909)))
in (
...
in (let _162_917 = (let _162_916 = (let _162_915 = (let _162_914 = (let _162_913 = (let _162_912 = (FStar_All.pipe_right t FStar_Syntax_Util.name_function_binders)
in (FStar_Syntax_Syntax.mk_Total _162_912))
in (FStar_Syntax_Util.arrow data_tpars _162_913))
in ((name), (univs), (_162_914), (tname), (ntps), (quals), (mutuals), (rng)))
in FStar_Syntax_Syntax.Sig_datacon (_162_915))
in ((tps), (_162_916)))
in ((name), (_162_917))))))))
end))))
in (FStar_All.pipe_left FStar_List.split _162_918))
...
let bundle = (let _162_920 = (let _162_919 = (FStar_List.collect FStar_Syntax_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_162_919), (rng)))
in FStar_Syntax_Syntax.Sig_bundle (_162_920))
in (
...
| (env, a) -> begin
(let _162_929 = (let _162_928 = (FStar_Syntax_Syntax.mk_binder (
...
let eff_k = (let _162_964 = (FStar_Parser_Env.default_total env)
in (desugar_term _162_964 eff_kind))
in (
...
| (env, ses) -> begin
(let _162_968 = (let _162_967 = (FStar_List.hd ses)
in (_162_967)::out)
in ((env), (_162_968)))
end))
end)) ((env), ([]))))
...
(let _162_974 = (FStar_Parser_Env.qualify env name)
in (let _162_973 = (let _162_970 = (desugar_term env def)
in (FStar_Syntax_Subst.close binders _162_970))
in (let _162_972 = (let _162_971 = (desugar_typ env cps_type)
in (FStar_Syntax_Subst.close binders _162_971))
in {FStar_Syntax_Syntax.action_name = _162_974; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _162_973; FStar_Syntax_Syntax.action_typ = _162_972})))
end
| FStar_Parser_AST.Tycon (_66_2625, ((FStar_Parser_AST.TyconAbbrev (name, _66_2628, _66_2630, defn), _66_2635))::[]) when for_free -> begin
(let _162_977 = (FStar_Parser_Env.qualify env name)
in (let _162_976 = (let _162_975 = (desugar_term env defn)
in (FStar_Syntax_Subst.close binders _162_975))
in {FStar_Syntax_Syntax.action_name = _162_977; FStar_Syntax_Syntax.action_univs = []; FStar_Syntax_Syntax.action_defn = _162_976; FStar_Syntax_Syntax.action_typ = FStar_Syntax_Syntax.tun}))
end
| _66_2641 -> begin
...
in (let _162_981 = (let _162_980 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_definition env) l)
in (FStar_All.pipe_left (FStar_Syntax_Subst.close binders) _162_980))
in (([]), (_162_981)))))
in (
...
let dummy_tscheme = (let _162_982 = (FStar_Syntax_Syntax.mk FStar_Syntax_Syntax.Tm_unknown None FStar_Range.dummyRange)
in (([]), (_162_982)))
in (let _162_988 = (let _162_987 = (let _162_986 = (let _162_983 = (lookup "repr")
in (Prims.snd _162_983))
in (let _162_985 = (lookup "return")
in (let _162_984 = (lookup "bind")
...
in ((_162_987), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_new_effect_for_free (_162_988)))
end else begin
(
...
in (let _162_1004 = (let _162_1003 = (let _162_1002 = (lookup "return_wp")
in (let _162_1001 = (lookup "bind_wp")
in (let _162_1000 = (lookup "if_then_else")
in (let _162_999 = (lookup "ite_wp")
in (let _162_998 = (lookup "stronger")
in (let _162_997 = (lookup "close_wp")
in (let _162_996 = (lookup "assert_p")
in (let _162_995 = (lookup "assume_p")
in (let _162_994 = (lookup "null_wp")
in (let _162_993 = (lookup "trivial")
in (let _162_992 = if rr then begin
(let _162_989 = (lookup "repr")
in (FStar_All.pipe_left Prims.snd _162_989))
end else begin
FStar_Syntax_Syntax.tun
end
in (let _162_991 = if rr then begin
(lookup "return")
end else begin
un_ts
end
in (let _162_990 = if rr then begin
(lookup "bind")
end else begin
un_ts
end
in {FStar_Syntax_Syntax.qualifiers = qualifiers; FStar_Syntax_Syntax.mname = mname; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = eff_k; FStar_Syntax_Syntax.ret_wp = _162_1002; FStar_Syntax_Syntax.bind_wp = _162_1001; FStar_Syntax_Syntax.if_then_else = _162_1000; FStar_Syntax_Syntax.ite_wp = _162_999; FStar_Syntax_Syntax.stronger = _162_998; FStar_Syntax_Syntax.close_wp = _162_997; FStar_Syntax_Syntax.assert_p = _162_996; FStar_Syntax_Syntax.assume_p = _162_995; FStar_Syntax_Syntax.null_wp = _162_994; FStar_Syntax_Syntax.trivial = _162_993; FStar_Syntax_Syntax.repr = _162_992; FStar_Syntax_Syntax.return_repr = _162_991; FStar_Syntax_Syntax.bind_repr = _162_990; FStar_Syntax_Syntax.actions = actions})))))))))))))
in ((_162_1003), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_new_effect (_162_1004))))
end
in (
...
let env = (FStar_All.pipe_right actions (FStar_List.fold_left (fun env a -> (let _162_1007 = (FStar_Syntax_Util.action_as_lb a)
in (FStar_Parser_Env.push_sigelt env _162_1007))) env))
in (
...
| _66_2679 -> begin
(let _162_1029 = (let _162_1028 = (let _162_1027 = (let _162_1026 = (let _162_1025 = (FStar_Parser_AST.term_to_string head)
in (Prims.strcat _162_1025 " not found"))
in (Prims.strcat "Effect " _162_1026))
in ((_162_1027), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_162_1028))
in (Prims.raise _162_1029))
end)
in (let _162_1030 = (desugar_args env args)
in ((ed), (_162_1030))))
end))
...
in (let _162_1034 = (let _162_1033 = (FStar_Syntax_Subst.subst s x)
in (FStar_Syntax_Subst.close binders _162_1033))
in (([]), (_162_1034)))))
end))
end))
in (

let ed = (let _162_1059 = (FStar_List.map trans_qual quals)
in (let _162_1058 = (FStar_Parser_Env.qualify env0 eff_name)
in (let _162_1057 = (let _162_1035 = (sub (([]), (ed.FStar_Syntax_Syntax.signature)))
in (Prims.snd _162_1035))
in (let _162_1056 = (sub ed.FStar_Syntax_Syntax.ret_wp)
in (let _162_1055 = (sub ed.FStar_Syntax_Syntax.bind_wp)
in (let _162_1054 = (sub ed.FStar_Syntax_Syntax.if_then_else)
in (let _162_1053 = (sub ed.FStar_Syntax_Syntax.ite_wp)
in (let _162_1052 = (sub ed.FStar_Syntax_Syntax.stronger)
in (let _162_1051 = (sub ed.FStar_Syntax_Syntax.close_wp)
in (let _162_1050 = (sub ed.FStar_Syntax_Syntax.assert_p)
in (let _162_1049 = (sub ed.FStar_Syntax_Syntax.assume_p)
in (let _162_1048 = (sub ed.FStar_Syntax_Syntax.null_wp)
in (let _162_1047 = (sub ed.FStar_Syntax_Syntax.trivial)
in (let _162_1046 = (let _162_1036 = (sub (([]), (ed.FStar_Syntax_Syntax.repr)))
in (Prims.snd _162_1036))
in (let _162_1045 = (sub ed.FStar_Syntax_Syntax.return_repr)
in (let _162_1044 = (sub ed.FStar_Syntax_Syntax.bind_repr)
in (let _162_1043 = (FStar_List.map (fun action -> (let _162_1042 = (FStar_Parser_Env.qualify env action.FStar_Syntax_Syntax.action_name.FStar_Ident.ident)
in (let _162_1041 = (let _162_1038 = (sub (([]), (action.FStar_Syntax_Syntax.action_defn)))
in (Prims.snd _162_1038))
in (let _162_1040 = (let _162_1039 = (sub (([]), (action.FStar_Syntax_Syntax.action_typ)))
in (Prims.snd _162_1039))
in {FStar_Syntax_Syntax.action_name = _162_1042; FStar_Syntax_Syntax.action_univs = action.FStar_Syntax_Syntax.action_univs; FStar_Syntax_Syntax.action_defn = _162_1041; FStar_Syntax_Syntax.action_typ = _162_1040})))) ed.FStar_Syntax_Syntax.actions)
in {FStar_Syntax_Syntax.qualifiers = _162_1059; FStar_Syntax_Syntax.mname = _162_1058; FStar_Syntax_Syntax.univs = []; FStar_Syntax_Syntax.binders = binders; FStar_Syntax_Syntax.signature = _162_1057; FStar_Syntax_Syntax.ret_wp = _162_1056; FStar_Syntax_Syntax.bind_wp = _162_1055; FStar_Syntax_Syntax.if_then_else = _162_1054; FStar_Syntax_Syntax.ite_wp = _162_1053; FStar_Syntax_Syntax.stronger = _162_1052; FStar_Syntax_Syntax.close_wp = _162_1051; FStar_Syntax_Syntax.assert_p = _162_1050; FStar_Syntax_Syntax.assume_p = _162_1049; FStar_Syntax_Syntax.null_wp = _162_1048; FStar_Syntax_Syntax.trivial = _162_1047; FStar_Syntax_Syntax.repr = _162_1046; FStar_Syntax_Syntax.return_repr = _162_1045; FStar_Syntax_Syntax.bind_repr = _162_1044; FStar_Syntax_Syntax.actions = _162_1043})))))))))))))))))
in (
...
let env = (FStar_All.pipe_right ed.FStar_Syntax_Syntax.actions (FStar_List.fold_left (fun env a -> (let _162_1062 = (FStar_Syntax_Util.action_as_lb a)
in (FStar_Parser_Env.push_sigelt env _162_1062))) env))
in (
...
(let _162_1066 = (FStar_Parser_Env.push_module_abbrev env x l)
in ((_162_1066), ([])))
end
...
in (let _162_1068 = (FStar_List.map trans_qual qual)
in (desugar_tycon env d.FStar_Parser_AST.drange _162_1068 tcs)))
end
| FStar_Parser_AST.ToplevelLet (quals, isrec, lets) -> begin
(match ((let _162_1070 = (let _162_1069 = (desugar_term_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((isrec), (lets), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Syntax_Subst.compress _162_1069))
in _162_1070.FStar_Syntax_Syntax.n)) with
...
(let _162_1075 = (FStar_All.pipe_right (Prims.snd lbs) (FStar_List.map (fun lb -> (
...
in (((Prims.fst lbs)), (_162_1075)))
end else begin
lbs
end
in (

let s = (let _162_1078 = (let _162_1077 = (FStar_All.pipe_right fvs (FStar_List.map (fun fv -> fv.FStar_Syntax_Syntax.fv_name.FStar_Syntax_Syntax.v)))
in ((lbs), (d.FStar_Parser_AST.drange), (_162_1077), (quals)))
in FStar_Syntax_Syntax.Sig_let (_162_1078))
in (
...
in (let _162_1082 = (let _162_1081 = (let _162_1080 = (let _162_1079 = (FStar_Parser_Env.qualify env id)
in ((_162_1079), (f), ((FStar_Syntax_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Sig_assume (_162_1080))
in (_162_1081)::[])
in ((env), (_162_1082))))
end
...
let t = (let _162_1083 = (close_fun env t)
in (desugar_term env _162_1083))
in (
...
let se = (let _162_1086 = (let _162_1085 = (FStar_Parser_Env.qualify env id)
in (let _162_1084 = (FStar_List.map trans_qual quals)
in ((_162_1085), ([]), (t), (_162_1084), (d.FStar_Parser_AST.drange))))
in FStar_Syntax_Syntax.Sig_declare_typ (_162_1086))
in (
...
let t = (let _162_1091 = (let _162_1087 = (FStar_Syntax_Syntax.null_binder t)
in (_162_1087)::[])
in (let _162_1090 = (let _162_1089 = (let _162_1088 = (FStar_Parser_Env.fail_or env (FStar_Parser_Env.try_lookup_lid env) FStar_Syntax_Const.exn_lid)
in (Prims.fst _162_1088))
in (FStar_All.pipe_left FStar_Syntax_Syntax.mk_Total _162_1089))
in (FStar_Syntax_Util.arrow _162_1091 _162_1090)))
in (
...
| None -> begin
(let _162_1102 = (let _162_1101 = (let _162_1100 = (let _162_1099 = (let _162_1098 = (FStar_Syntax_Print.lid_to_string l)
in (Prims.strcat _162_1098 " not found"))
in (Prims.strcat "Effect name " _162_1099))
in ((_162_1100), (d.FStar_Parser_AST.drange)))
in FStar_Syntax_Syntax.Error (_162_1101))
in (Prims.raise _162_1102))
end
| Some (l) -> begin
l
end))
...
(let _162_1105 = (let _162_1104 = (let _162_1103 = (desugar_term env t)
in (([]), (_162_1103)))
in Some (_162_1104))
in ((_162_1105), (None)))
end
| FStar_Parser_AST.ReifiableLift (wp, t) -> begin
(let _162_1111 = (let _162_1107 = (let _162_1106 = (desugar_term env wp)
in (([]), (_162_1106)))
in Some (_162_1107))
in (let _162_1110 = (let _162_1109 = (let _162_1108 = (desugar_term env t)
in (([]), (_162_1108)))
in Some (_162_1109))
in ((_162_1111), (_162_1110))))
end
| FStar_Parser_AST.LiftForFree (t) -> begin
(let _162_1114 = (let _162_1113 = (let _162_1112 = (desugar_term env t)
in (([]), (_162_1112)))
in Some (_162_1113))
in ((None), (_162_1114)))
end)
...
(let _162_1132 = (FStar_Parser_Env.prepare_module_or_interface true admitted env mname)
in ((_162_1132), (mname), (decls), (true)))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _162_1133 = (FStar_Parser_Env.prepare_module_or_interface false false env mname)
in ((_162_1133), (mname), (decls), (false)))
end)
...
(let _162_1144 = (FStar_Syntax_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _162_1144))
end else begin
()
end
in (let _162_1145 = if pop_when_done then begin
