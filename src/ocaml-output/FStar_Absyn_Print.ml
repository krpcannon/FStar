...
let _33_127 = (let _129_62 = (FStar_Util.substring_from bvd.FStar_Absyn_Syntax.ppname.FStar_Ident.idText (Prims.parse_int "1"))
...
let dec = (let _129_212 = (FStar_All.pipe_right c.FStar_Absyn_Syntax.flags (FStar_List.collect (fun _33_9 -> (match (_33_9) with
...
in (FStar_All.pipe_right _129_319 (FStar_List.filter (fun _33_15 -> (match (_33_15) with
...
in (let _129_336 = (let _129_335 = (FStar_All.pipe_right pats (FStar_List.map (fun _33_607 -> (match (_33_607) with
| (p, wopt, e) -> begin
...
in (let _129_382 = (let _129_381 = (FStar_List.map (fun _33_710 -> (match (_33_710) with
| (x, b) -> begin
(
...
let subst_to_string = (fun subst -> (let _129_394 = (let _129_393 = (FStar_List.map (fun _33_16 -> (match (_33_16) with
