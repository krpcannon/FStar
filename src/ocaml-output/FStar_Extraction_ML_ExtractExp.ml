...
let _78_19 = (let _174_27 = (FStar_Absyn_Print.format_error r msg)
in (FStar_All.pipe_left FStar_Util.print_string _174_27))
in (FStar_All.failwith msg)))


let err_uninst = (fun env e _78_25 -> (match (_78_25) with
| (vars, t) -> begin
...
(FStar_All.pipe_right args (FStar_List.for_all (fun _78_70 -> (match (_78_70) with
| (te, _78_69) -> begin
(match (te) with
| FStar_Util.Inl (_78_72) -> begin
true
end
...
(FStar_All.pipe_right args (FStar_List.for_all (fun _78_1 -> (match (_78_1) with
| (FStar_Util.Inl (te), _78_86) -> begin
true
end
| _78_89 -> begin
false
...
| FStar_Extraction_ML_Syntax.MLE_Record (_78_126, fields) -> begin
(FStar_Util.for_all (fun _78_133 -> (match (_78_133) with
| (_78_131, e) -> begin
(is_ml_value e)
end)) fields)
end
...
let _78_150 = (FStar_Extraction_ML_Env.debug g (fun _78_149 -> (match (()) with
| () -> begin
...
| FStar_Absyn_Syntax.Pat_disj (_78_171) -> begin
...
let _78_203 = (match ((FStar_Extraction_ML_Env.lookup_fv g f)) with
| ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (n); FStar_Extraction_ML_Syntax.mlty = _78_191; FStar_Extraction_ML_Syntax.loc = _78_189}, ttys, _78_197) -> begin
((n), (ttys))
end
| _78_200 -> begin
(FStar_All.failwith "Expected a constructor")
end)
in (match (_78_203) with
| (d, tys) -> begin
(
...
let _78_207 = (FStar_Util.first_N nTyVars pats)
in (match (_78_207) with
| (tysVarPats, restPats) -> begin
(

let _78_214 = (FStar_Util.fold_map (fun g _78_211 -> (match (_78_211) with
| (p, imp) -> begin
(extract_one_pat disj true g p)
end)) g tysVarPats)
in (match (_78_214) with
| (g, tyMLPats) -> begin
(

let _78_228 = (FStar_Util.fold_map (fun g _78_218 -> (match (_78_218) with
| (p, imp) -> begin
(

let _78_221 = (extract_one_pat disj false g p)
...
in (match (_78_228) with
| (g, restMLPats) -> begin
(

let _78_236 = (let _174_130 = (FStar_All.pipe_right (FStar_List.append tyMLPats restMLPats) (FStar_List.collect (fun _78_2 -> (match (_78_2) with
| Some (x) -> begin
(x)::[]
end
| _78_233 -> begin
...
let _78_286 = (extract_one_pat true g p)
in (match (_78_286) with
| (g, p) -> begin
(
...
let _78_302 = (FStar_All.pipe_right ps (FStar_List.partition (fun _78_3 -> (match (_78_3) with
| (_78_291, (_78_295)::_78_293) -> begin
true
end
| _78_299 -> begin
false
end))))
in (match (_78_302) with
| (ps_when, rest) -> begin
(

let ps = (FStar_All.pipe_right ps_when (FStar_List.map (fun _78_305 -> (match (_78_305) with
| (x, whens) -> begin
...
let _78_316 = (extract_one_pat false g p)
...
| FStar_Extraction_ML_Syntax.MLTY_Fun (t0, _78_357, t1) -> begin
(
...
| FStar_Extraction_ML_Syntax.MLTY_Named (_78_363, _78_365) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_CTor (_78_374, args), Some (FStar_Absyn_Syntax.Record_ctor (_78_379, fields))) -> begin
(
...
let _78_394 = (eta_args [] residualType)
...
let _78_400 = (FStar_List.unzip eargs)
in (match (_78_400) with
| (binders, eargs) -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (mlp); FStar_Extraction_ML_Syntax.mlty = _78_411; FStar_Extraction_ML_Syntax.loc = _78_409}, (mlarg)::[]), _78_420) when (mlp = FStar_Extraction_ML_Syntax.mlp_lalloc) -> begin
(

let _78_423 = (FStar_Extraction_ML_Env.debug g (fun _78_422 -> (match (()) with
| () -> begin
...
| (FStar_Extraction_ML_Syntax.MLE_App ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Name (mlp); FStar_Extraction_ML_Syntax.mlty = _78_432; FStar_Extraction_ML_Syntax.loc = _78_430}, (mle)::args), Some (FStar_Absyn_Syntax.Record_projector (f))) -> begin
(
...
let _78_495 = (FStar_List.hd l)
in (match (_78_495) with
| (p1, w1, e1) -> begin
(

let _78_499 = (let _174_204 = (FStar_List.tl l)
in (FStar_List.hd _174_204))
in (match (_78_499) with
| (p2, w2, e2) -> begin
...
let _78_529 = (let _174_221 = (check_exp' g e f t)
in (erase g _174_221 f t))
in (match (_78_529) with
| (e, _78_526, _78_528) -> begin
e
end)))
...
let _78_537 = (synth_exp g e)
in (match (_78_537) with
| (e0, f0, t0) -> begin
...
let _78_543 = (synth_exp' g e)
in (match (_78_543) with
| (e, f, t) -> begin
(erase g e f t)
end)))
and synth_exp' : FStar_Extraction_ML_Env.env  ->  FStar_Absyn_Syntax.exp  ->  (FStar_Extraction_ML_Syntax.mlexpr * FStar_Extraction_ML_Syntax.e_tag * FStar_Extraction_ML_Syntax.mlty) = (fun g e -> (

let _78_547 = (FStar_Extraction_ML_Env.debug g (fun u -> (let _174_233 = (let _174_232 = (FStar_Absyn_Print.tag_of_exp e)
...
let _78_577 = (FStar_Extraction_ML_Env.lookup_var g e)
in (match (_78_577) with
| ((x, mltys, _78_574), qual) -> begin
(match (mltys) with
| ([], t) -> begin
...
let rec synth_app = (fun is_data _78_591 _78_594 restArgs -> (match (((_78_591), (_78_594))) with
| ((mlhead, mlargs_f), (f, t)) -> begin
(match (((restArgs), (t))) with
| ([], _78_598) -> begin
(

let _78_609 = if ((FStar_Absyn_Util.is_primop head) || (FStar_Extraction_ML_Util.codegen_fsharp ())) then begin
(let _174_248 = (FStar_All.pipe_right (FStar_List.rev mlargs_f) (FStar_List.map Prims.fst))
in (([]), (_174_248)))
end else begin
(FStar_List.fold_left (fun _78_602 _78_605 -> (match (((_78_602), (_78_605))) with
...
let l_app = (FStar_List.fold_right (fun _78_613 out -> (match (_78_613) with
| (x, arg) -> begin
...
| (((FStar_Util.Inl (tt), _78_620))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (tunit, f', t)) -> begin
...
| (((FStar_Util.Inr (e0), _78_633))::rest, FStar_Extraction_ML_Syntax.MLTY_Fun (tExpected, f', t)) -> begin
(

let e0_rng = e0.FStar_Absyn_Syntax.pos
in (

let _78_646 = (synth_exp g e0)
in (match (_78_646) with
...
let synth_app_maybe_projector = (fun is_data mlhead _78_658 args -> (match (_78_658) with
| (f, t) -> begin
(match (is_data) with
| Some (FStar_Absyn_Syntax.Record_projector (_78_661)) -> begin
(

let rec remove_implicits = (fun args f t -> (match (((args), (t))) with
| (((FStar_Util.Inr (ee), Some (FStar_Absyn_Syntax.Implicit (_78_672))))::args, FStar_Extraction_ML_Syntax.MLTY_Fun (_78_678, f', t)) -> begin
...
let _78_689 = (remove_implicits args f t)
in (match (_78_689) with
| (args, f, t) -> begin
...
let _78_706 = (FStar_Extraction_ML_Env.lookup_var g head)
in (match (_78_706) with
| ((head_ml, (vars, t), inst_ok), qual) -> begin
(

let has_typ_apps = (match (args) with
| ((FStar_Util.Inl (_78_710), _78_713))::_78_708 -> begin
true
end
| _78_717 -> begin
false
...
let _78_759 = (match (vars) with
| (_78_722)::_78_720 when ((not (has_typ_apps)) && inst_ok) -> begin
((head_ml), (t), (args))
end
| _78_725 -> begin
(
...
let _78_729 = (FStar_Util.first_N n args)
...
let _78_738 = head_ml
in {FStar_Extraction_ML_Syntax.expr = _78_738.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = t; FStar_Extraction_ML_Syntax.loc = _78_738.FStar_Extraction_ML_Syntax.loc})
end
| FStar_Extraction_ML_Syntax.MLE_App (head, ({FStar_Extraction_ML_Syntax.expr = FStar_Extraction_ML_Syntax.MLE_Const (FStar_Extraction_ML_Syntax.MLC_Unit); FStar_Extraction_ML_Syntax.mlty = _78_744; FStar_Extraction_ML_Syntax.loc = _78_742})::[]) -> begin
(FStar_All.pipe_right (FStar_Extraction_ML_Syntax.MLE_App ((((

let _78_751 = head
in {FStar_Extraction_ML_Syntax.expr = _78_751.FStar_Extraction_ML_Syntax.expr; FStar_Extraction_ML_Syntax.mlty = FStar_Extraction_ML_Syntax.MLTY_Fun (((FStar_Extraction_ML_Syntax.ml_unit_ty), (FStar_Extraction_ML_Syntax.E_PURE), (t))); FStar_Extraction_ML_Syntax.loc = _78_751.FStar_Extraction_ML_Syntax.loc})), ((FStar_Extraction_ML_Syntax.ml_unit)::[])))) (FStar_Extraction_ML_Syntax.with_ty t))
end
| _78_754 -> begin
(FStar_All.failwith "Impossible")
end)
...
let _78_768 = (synth_exp g head)
in (match (_78_768) with
| (head, f, t) -> begin
...
let _78_791 = (FStar_List.fold_left (fun _78_775 _78_779 -> (match (((_78_775), (_78_779))) with
| ((ml_bs, env), (b, _78_778)) -> begin
(match (b) with
...
let _78_796 = (synth_exp env body)
in (match (_78_796) with
| (ml_body, f, t) -> begin
(

let _78_806 = (FStar_List.fold_right (fun _78_800 _78_803 -> (match (((_78_800), (_78_803))) with
| ((_78_798, targ), (f, t)) -> begin
((FStar_Extraction_ML_Syntax.E_PURE), (FStar_Extraction_ML_Syntax.MLTY_Fun (((targ), (f), (t)))))
end)) ml_bs ((f), (t)))
in (match (_78_806) with
| (f, tfun) -> begin
...
let maybe_generalize = (fun _78_818 -> (match (_78_818) with
...
let _78_842 = (match ((FStar_Util.prefix_until (fun _78_4 -> (match (_78_4) with
| (FStar_Util.Inr (_78_827), _78_830) -> begin
true
end
| _78_833 -> begin
false
...
let _78_851 = (FStar_Util.first_N n bs)
in (match (_78_851) with
...
let targs = (FStar_All.pipe_right targs (FStar_List.map (fun _78_5 -> (match (_78_5) with
| (FStar_Util.Inl (a), _78_860) -> begin
a
end
| _78_863 -> begin
(FStar_All.failwith "Impossible")
...
let check_lb = (fun env _78_897 -> (match (_78_897) with
...
let _78_926 = (FStar_List.fold_right (fun lb _78_907 -> (match (_78_907) with
| (env, lbs) -> begin
(

let _78_920 = lb
in (match (_78_920) with
| (lbname, _78_910, (t, (_78_913, polytype)), add_unit, _78_919) -> begin
(

let _78_923 = (FStar_Extraction_ML_Env.extend_lb env lbname t polytype add_unit true)
in (match (_78_923) with
| (env, nm) -> begin
((env), ((((nm), (lb)))::lbs))
end))
end))
end)) lbs ((g), ([])))
in (match (_78_926) with
| (env_body, lbs) -> begin
(
...
let _78_933 = (synth_exp env_body e')
in (match (_78_933) with
| (e', f', t') -> begin
(
...
let _78_943 = (synth_exp g scrutinee)
in (match (_78_943) with
| (e, f_e, t_e) -> begin
(

let _78_947 = (check_pats_for_ite pats)
...
let _78_959 = (synth_exp g then_e)
in (match (_78_959) with
| (then_mle, f_then, t_then) -> begin
(

let _78_963 = (synth_exp g else_e)
in (match (_78_963) with
| (else_mle, f_else, t_else) -> begin
(

let _78_966 = if (type_leq g t_then t_else) then begin
((t_else), (no_lift))
end else begin
...
let mlbranches = (FStar_All.pipe_right pats (FStar_List.collect (fun _78_972 -> (match (_78_972) with
| (pat, when_opt, branch) -> begin
(

let _78_975 = (extract_pat g pat)
in (match (_78_975) with
| (env, p) -> begin
(

let _78_986 = (match (when_opt) with
| None -> begin
...
let _78_982 = (synth_exp env w)
in (match (_78_982) with
| (w, f_w, t_w) -> begin
(
...
in (match (_78_986) with
| (when_opt, f_when) -> begin
(

let _78_990 = (synth_exp env branch)
in (match (_78_990) with
| (mlbranch, f_branch, t_branch) -> begin
(FStar_All.pipe_right p (FStar_List.map (fun _78_993 -> (match (_78_993) with
| (p, wopt) -> begin
(
...
let _78_1002 = (FStar_Extraction_ML_Env.lookup_fv g (FStar_Absyn_Util.fv FStar_Absyn_Const.failwith_lid))
in (match (_78_1002) with
| (fw, _78_999, _78_1001) -> begin
...
| ((_78_1005, _78_1007, (_78_1009, f_first, t_first)))::rest -> begin
(

let _78_1035 = (FStar_List.fold_left (fun _78_1017 _78_1027 -> (match (((_78_1017), (_78_1027))) with
| ((topt, f), (_78_1019, _78_1021, (_78_1023, f_branch, t_branch))) -> begin
(
...
in (match (_78_1035) with
| (topt, f_match) -> begin
(

let mlbranches = (FStar_All.pipe_right mlbranches (FStar_List.map (fun _78_1046 -> (match (_78_1046) with
| (p, (wopt, _78_1039), (b, _78_1043, t)) -> begin
(
...
| FStar_Absyn_Syntax.Exp_meta (FStar_Absyn_Syntax.Meta_desugared (e, _78_1059)) -> begin
(synth_exp g e)
end
...
let _78_1071 = (FStar_Util.incr c)
...
| FStar_Absyn_Syntax.Typ_fun (binders, _78_1079) -> begin
(let _174_361 = (FStar_All.pipe_right binders (FStar_List.filter (fun _78_6 -> (match (_78_6) with
| (_78_1084, Some (FStar_Absyn_Syntax.Implicit (_78_1086))) -> begin
true
end
| _78_1091 -> begin
false
end))))
in (FStar_All.pipe_right _174_361 (FStar_List.map (fun _78_1092 -> (let _174_360 = (fresh "_")
