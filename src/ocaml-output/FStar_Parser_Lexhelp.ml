...
let _68_6 = (FStar_Util.smap_add strings s s)
in s)
end)))
...
let _68_19 = (FStar_Bytes.emit_int_as_byte buf (c mod (Prims.parse_int "256")))
...
let _68_32 = (let _164_44 = (((FStar_Bytes.length bytes) / (Prims.parse_int "2")) - (Prims.parse_int "1"))
...
let stringKeywords : Prims.string Prims.list = (FStar_List.map (fun _68_61 -> (match (_68_61) with
| (_68_57, w, _68_60) -> begin
w
end)) keywords)


let unreserve_words : Prims.string Prims.list = (FStar_List.choose (fun _68_66 -> (match (_68_66) with
| (mode, keyword, _68_65) -> begin
...
let _68_72 = (FStar_List.iter (fun _68_71 -> (match (_68_71) with
...
let mkLexargs = (fun _68_81 -> (match (_68_81) with
