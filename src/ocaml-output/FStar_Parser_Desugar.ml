...
let kind_star : FStar_Range.range  ->  FStar_Parser_AST.term = (fun r -> (let _159_17 = (let _159_16 = (FStar_Ident.lid_of_path (("Type")::[]) r)
in FStar_Parser_AST.Name (_159_16))
in (FStar_Parser_AST.mk_term _159_17 r FStar_Parser_AST.Kind)))
...
(let _159_28 = (let _159_26 = (FStar_Util.char_at s i)
in (name_of_char _159_26))
in (let _159_27 = (aux (i + (Prims.parse_int "1")))
in (_159_28)::_159_27))
end)
in (let _159_30 = (let _159_29 = (aux (Prims.parse_int "0"))
in (FStar_String.concat "_" _159_29))
in (Prims.strcat "op_" _159_30)))))


let compile_op_lid : Prims.int  ->  Prims.string  ->  FStar_Range.range  ->  FStar_Absyn_Syntax.lident = (fun n s r -> (let _159_40 = (let _159_39 = (let _159_38 = (let _159_37 = (compile_op n s)
in ((_159_37), (r)))
in (FStar_Absyn_Syntax.mk_ident _159_38))
in (_159_39)::[])
in (FStar_All.pipe_right _159_40 FStar_Absyn_Syntax.lid_of_ids)))
...
in (match ((let _159_53 = (compile_op_lid arity s rng)
in (FStar_Parser_DesugarEnv.try_lookup_lid env _159_53))) with
...
| s -> begin
(match ((let _159_64 = (compile_op_lid arity s rng)
in (FStar_Parser_DesugarEnv.try_lookup_typ_name env _159_64))) with
...
(match ((let _159_71 = (unparen t)
in _159_71.FStar_Parser_AST.tm)) with
...
(let _159_76 = (FStar_Parser_DesugarEnv.push_local_tbinding env id)
in (FStar_All.pipe_right _159_76 Prims.fst))
end
| _63_346 -> begin
env
end)
...
(match ((let _159_79 = (unparen t)
in _159_79.FStar_Parser_AST.tm)) with
...
let sort_ftv : FStar_Ident.ident Prims.list  ->  FStar_Ident.ident Prims.list = (fun ftv -> (let _159_90 = (FStar_Util.remove_dups (fun x y -> (x.FStar_Ident.idText = y.FStar_Ident.idText)) ftv)
in (FStar_All.pipe_left (FStar_Util.sort_with (fun x y -> (FStar_String.compare x.FStar_Ident.idText y.FStar_Ident.idText))) _159_90)))
...
(let _159_97 = (free_type_vars env term)
in ((env), (_159_97)))
end
...
(let _159_98 = (free_type_vars env t)
in ((env), (_159_98)))
end))
and free_type_vars : FStar_Parser_DesugarEnv.env  ->  FStar_Parser_AST.term  ->  FStar_Ident.ident Prims.list = (fun env t -> (match ((let _159_101 = (unparen t)
in _159_101.FStar_Parser_AST.tm)) with
...
(let _159_104 = (free_type_vars env t1)
in (let _159_103 = (free_type_vars env t2)
in (FStar_List.append _159_104 _159_103)))
end
...
| (env, f) -> begin
(let _159_105 = (free_type_vars env t)
in (FStar_List.append f _159_105))
end))
end
...
| (env, free) -> begin
(let _159_108 = (free_type_vars env body)
in (FStar_List.append free _159_108))
end))
end
...
let rec aux = (fun args t -> (match ((let _159_115 = (unparen t)
in _159_115.FStar_Parser_AST.tm)) with
...
let ftv = (let _159_120 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _159_120))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _159_124 = (let _159_123 = (let _159_122 = (kind_star x.FStar_Ident.idRange)
in ((x), (_159_122)))
in FStar_Parser_AST.TAnnotated (_159_123))
in (FStar_Parser_AST.mk_binder _159_124 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (
...
let ftv = (let _159_129 = (free_type_vars env t)
in (FStar_All.pipe_left sort_ftv _159_129))
in if ((FStar_List.length ftv) = (Prims.parse_int "0")) then begin
t
end else begin
(

let binders = (FStar_All.pipe_right ftv (FStar_List.map (fun x -> (let _159_133 = (let _159_132 = (let _159_131 = (kind_star x.FStar_Ident.idRange)
in ((x), (_159_131)))
in FStar_Parser_AST.TAnnotated (_159_132))
in (FStar_Parser_AST.mk_binder _159_133 x.FStar_Ident.idRange FStar_Parser_AST.Type (Some (FStar_Parser_AST.Implicit)))))))
in (

let t = (match ((let _159_134 = (unlabel t)
in _159_134.FStar_Parser_AST.tm)) with
...
(let _159_148 = (let _159_147 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_147))
in ((_159_148), (args), (None)))
end
...
(let _159_201 = (FStar_Absyn_Syntax.null_t_binder k)
in ((_159_201), (env)))
end
| FStar_Util.Inr (None, t) -> begin
(let _159_202 = (FStar_Absyn_Syntax.null_v_binder t)
in ((_159_202), (env)))
end
...
| _63_773 -> begin
(let _159_213 = (FStar_Range.string_of_range f.FStar_Parser_AST.range)
in (FStar_Util.format2 "%s at %s" tag _159_213))
end)
...
(let _159_217 = (let _159_216 = (aux g)
in FStar_Parser_AST.Paren (_159_216))
in (FStar_Parser_AST.mk_term _159_217 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.Op ("/\\", (f1)::(f2)::[]) -> begin
(let _159_223 = (let _159_222 = (let _159_221 = (let _159_220 = (aux f1)
in (let _159_219 = (let _159_218 = (aux f2)
in (_159_218)::[])
in (_159_220)::_159_219))
in (("/\\"), (_159_221)))
in FStar_Parser_AST.Op (_159_222))
in (FStar_Parser_AST.mk_term _159_223 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.If (f1, f2, f3) -> begin
(let _159_227 = (let _159_226 = (let _159_225 = (aux f2)
in (let _159_224 = (aux f3)
in ((f1), (_159_225), (_159_224))))
in FStar_Parser_AST.If (_159_226))
in (FStar_Parser_AST.mk_term _159_227 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| FStar_Parser_AST.Abs (binders, g) -> begin
(let _159_230 = (let _159_229 = (let _159_228 = (aux g)
in ((binders), (_159_228)))
in FStar_Parser_AST.Abs (_159_229))
in (FStar_Parser_AST.mk_term _159_230 f.FStar_Parser_AST.range f.FStar_Parser_AST.level))
end
| _63_795 -> begin
(label f)
end))
...
let _63_879 = (let _159_302 = (FStar_Absyn_Syntax.pat_vars pat)
in (Prims.ignore _159_302))
...
(let _159_304 = (let _159_303 = (desugar_kind env t)
in ((x), (_159_303), (aq)))
in TBinder (_159_304))
end
...
in (let _159_306 = (let _159_305 = (desugar_typ env t)
in ((x), (_159_305), (aq)))
in VBinder (_159_306)))
end)
...
in (let _159_307 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_twild ((FStar_Absyn_Util.bvd_to_bvar_s a FStar_Absyn_Syntax.kun))))
in ((loc), (env), (TBinder (((a), (FStar_Absyn_Syntax.kun), (aq)))), (_159_307), (imp))))
end else begin
(
...
| (loc, env, abvd) -> begin
(let _159_308 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_tvar ((FStar_Absyn_Util.bvd_to_bvar_s abvd FStar_Absyn_Syntax.kun))))
in ((loc), (env), (TBinder (((abvd), (FStar_Absyn_Syntax.kun), (aq)))), (_159_308), (imp)))
end))
end))
end
...
in (let _159_309 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_wild ((FStar_Absyn_Util.bvd_to_bvar_s y FStar_Absyn_Syntax.tun))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_309), (false)))))
end
| FStar_Parser_AST.PatConst (c) -> begin
(

let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_310 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_constant (c)))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_310), (false))))
end
...
| (loc, env, xbvd) -> begin
(let _159_311 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_var ((FStar_Absyn_Util.bvd_to_bvar_s xbvd FStar_Absyn_Syntax.tun))))
in ((loc), (env), (VBinder (((xbvd), (FStar_Absyn_Syntax.tun), (aq)))), (_159_311), (imp)))
end))))
end
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_312 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), ([])))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_312), (false)))))
end
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_315 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), (args)))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_315), (false)))))
end))
end
...
let pat = (let _159_322 = (let _159_321 = (let _159_320 = (FStar_Range.end_range p.FStar_Parser_AST.prange)
in (pos_r _159_320))
in (FStar_All.pipe_left _159_321 (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv FStar_Absyn_Const.nil_lid)), (Some (FStar_Absyn_Syntax.Data_ctor)), ([]))))))
in (FStar_List.fold_right (fun hd tl -> (

let r = (FStar_Range.union_ranges hd.FStar_Absyn_Syntax.p tl.FStar_Absyn_Syntax.p)
in (FStar_All.pipe_left (pos_r r) (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv FStar_Absyn_Const.cons_lid)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((((hd), (false)))::(((tl), (false)))::[]))))))) pats _159_322))
in (
...
let x = (FStar_Absyn_Util.new_bvd (Some (p.FStar_Parser_AST.prange)))
in (let _159_325 = (FStar_All.pipe_left pos (FStar_Absyn_Syntax.Pat_cons (((l), (Some (FStar_Absyn_Syntax.Data_ctor)), (args)))))
in ((loc), (env), (VBinder (((x), (FStar_Absyn_Syntax.tun), (None)))), (_159_325), (false))))))))
end))
end
...
| (f, p) -> begin
(let _159_327 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.qualify_field_to_record env record) f)
in ((_159_327), (p)))
end))))
in (
...
(let _159_335 = (let _159_334 = (let _159_333 = (let _159_332 = (let _159_331 = (let _159_330 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_DesugarEnv.typename), (_159_330)))
in FStar_Absyn_Syntax.Record_ctor (_159_331))
in Some (_159_332))
in ((fv), (_159_333), (args)))
in FStar_Absyn_Syntax.Pat_cons (_159_334))
in (FStar_All.pipe_left pos _159_335))
end
| _63_1083 -> begin
p
end)
...
(let _159_341 = (let _159_340 = (let _159_339 = (FStar_Parser_DesugarEnv.qualify env x)
in ((_159_339), (FStar_Absyn_Syntax.tun)))
in LetBinder (_159_340))
in ((env), (_159_341), (None)))
end
...
(let _159_345 = (let _159_344 = (let _159_343 = (FStar_Parser_DesugarEnv.qualify env x)
in (let _159_342 = (desugar_typ env t)
in ((_159_343), (_159_342))))
in LetBinder (_159_344))
in ((env), (_159_345), (None)))
end
| _63_1113 -> begin
...
(let _159_355 = (desugar_typ env t)
in FStar_Util.Inl (_159_355))
end else begin
(let _159_356 = (desugar_exp env t)
in FStar_Util.Inr (_159_356))
end)
...
in (match ((let _159_376 = (unparen top)
in _159_376.FStar_Parser_AST.tm)) with
...
let args = (FStar_All.pipe_right args (FStar_List.map (fun t -> (let _159_380 = (desugar_typ_or_exp env t)
in ((_159_380), (None))))))
in (let _159_381 = (FStar_Absyn_Util.mk_exp_app op args)
in (FStar_All.pipe_left setpos _159_381))))
end)
end
...
(let _159_382 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_lid env) l)
in (FStar_All.pipe_left setpos _159_382))
end
end
| FStar_Parser_AST.Construct (l, args) -> begin
(

let dt = (let _159_387 = (let _159_386 = (let _159_385 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_datacon env) l)
in ((_159_385), (Some (FStar_Absyn_Syntax.Data_ctor))))
in (FStar_Absyn_Syntax.mk_Exp_fvar _159_386))
in (FStar_All.pipe_left pos _159_387))
in (match (args) with
| [] -> begin
dt
end
...
in (let _159_392 = (let _159_391 = (let _159_390 = (let _159_389 = (FStar_Absyn_Util.mk_exp_app dt args)
in ((_159_389), (FStar_Absyn_Syntax.Data_app)))
in FStar_Absyn_Syntax.Meta_desugared (_159_390))
in (FStar_Absyn_Syntax.mk_Exp_meta _159_391))
in (FStar_All.pipe_left setpos _159_392)))
end))
end
...
let ftvs = (let _159_395 = (free_type_vars env t)
in (FStar_List.append _159_395 ftvs))
in (let _159_397 = (let _159_396 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (FStar_All.pipe_left Prims.fst _159_396))
in ((_159_397), (ftvs))))
end
| FStar_Parser_AST.PatTvar (a, _63_1208) -> begin
(let _159_399 = (let _159_398 = (FStar_Parser_DesugarEnv.push_local_tbinding env a)
in (FStar_All.pipe_left Prims.fst _159_398))
in ((_159_399), (ftvs)))
end
| FStar_Parser_AST.PatAscribed (_63_1212, t) -> begin
(let _159_401 = (let _159_400 = (free_type_vars env t)
in (FStar_List.append _159_400 ftvs))
in ((env), (_159_401)))
end
| _63_1217 -> begin
((env), (ftvs))
...
let binders = (let _159_403 = (FStar_All.pipe_right ftv (FStar_List.map (fun a -> (FStar_Parser_AST.mk_pattern (FStar_Parser_AST.PatTvar (((a), (Some (FStar_Parser_AST.Implicit))))) top.FStar_Parser_AST.range))))
in (FStar_List.append _159_403 binders))
in (
...
| TBinder (a, k, aq) -> begin
(let _159_412 = (binder_of_bnd b)
in ((_159_412), (sc_pat_opt)))
end
| VBinder (x, t, aq) -> begin
(
...
| (Some (p), None) -> begin
(let _159_414 = (let _159_413 = (FStar_Absyn_Util.bvar_to_exp b)
in ((_159_413), (p)))
in Some (_159_414))
end
...
let sc = (let _159_421 = (let _159_420 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) tup top.FStar_Parser_AST.range)
in (let _159_419 = (let _159_418 = (FStar_Absyn_Syntax.varg sc)
in (let _159_417 = (let _159_416 = (let _159_415 = (FStar_Absyn_Util.bvar_to_exp b)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_415))
in (_159_416)::[])
in (_159_418)::_159_417))
in ((_159_420), (_159_419))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_421 None top.FStar_Parser_AST.range))
in (

let p = (let _159_422 = (FStar_Range.union_ranges p'.FStar_Absyn_Syntax.p p.FStar_Absyn_Syntax.p)
in (FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv tup)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((((p'), (false)))::(((p), (false)))::[])))) None _159_422))
in Some (((sc), (p))))))
end
...
let sc = (let _159_428 = (let _159_427 = (FStar_Absyn_Util.fvar (Some (FStar_Absyn_Syntax.Data_ctor)) tup top.FStar_Parser_AST.range)
in (let _159_426 = (let _159_425 = (let _159_424 = (let _159_423 = (FStar_Absyn_Util.bvar_to_exp b)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_423))
in (_159_424)::[])
in (FStar_List.append args _159_425))
in ((_159_427), (_159_426))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_428 None top.FStar_Parser_AST.range))
in (

let p = (let _159_429 = (FStar_Range.union_ranges p'.FStar_Absyn_Syntax.p p.FStar_Absyn_Syntax.p)
in (FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv tup)), (Some (FStar_Absyn_Syntax.Data_ctor)), ((FStar_List.append pats ((((p), (false)))::[])))))) None _159_429))
in Some (((sc), (p))))))
end
| _63_1300 -> begin
(FStar_All.failwith "Impossible")
...
in (let _159_439 = (let _159_438 = (let _159_437 = (FStar_Absyn_Util.fvar None a (FStar_Ident.range_of_lid a))
in (let _159_436 = (let _159_435 = (FStar_All.pipe_left FStar_Absyn_Syntax.targ phi)
in (let _159_434 = (let _159_433 = (let _159_432 = (FStar_Absyn_Syntax.mk_Exp_constant FStar_Const.Const_unit None top.FStar_Parser_AST.range)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_432))
in (_159_433)::[])
in (_159_435)::_159_434))
in ((_159_437), (_159_436))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_438))
in (FStar_All.pipe_left pos _159_439)))
end
| FStar_Parser_AST.App (_63_1319) -> begin
(

let rec aux = (fun args e -> (match ((let _159_444 = (unparen e)
in _159_444.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, t, imp) -> begin
(

let arg = (let _159_445 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_e imp) _159_445))
in (aux ((arg)::args) e))
end
| _63_1331 -> begin
(
...
(let _159_451 = (let _159_450 = (let _159_449 = (let _159_448 = (desugar_exp env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((FStar_Parser_AST.NoLetQualifier), (((((FStar_Parser_AST.mk_pattern FStar_Parser_AST.PatWild t1.FStar_Parser_AST.range)), (t1)))::[]), (t2)))) top.FStar_Parser_AST.range FStar_Parser_AST.Expr))
in ((_159_448), (FStar_Absyn_Syntax.Sequence)))
in FStar_Absyn_Syntax.Meta_desugared (_159_449))
in (FStar_Absyn_Syntax.mk_Exp_meta _159_450))
in (FStar_All.pipe_left setpos _159_451))
end
...
(let _159_455 = (destruct_app_pattern env top_level p)
in ((_159_455), (def)))
end else begin
(match ((FStar_Parser_AST.un_function p def)) with
| Some (p, def) -> begin
(let _159_456 = (destruct_app_pattern env top_level p)
in ((_159_456), (def)))
end
| _63_1361 -> begin
(match (p.FStar_Parser_AST.pat) with
...
(let _159_459 = (let _159_458 = (let _159_457 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_457))
in ((_159_458), ([]), (Some (t))))
in ((_159_459), (def)))
end else begin
...
if top_level then begin
(let _159_462 = (let _159_461 = (let _159_460 = (FStar_Parser_DesugarEnv.qualify env id)
in FStar_Util.Inr (_159_460))
in ((_159_461), ([]), (None)))
in ((_159_462), (def)))
end else begin
...
(let _159_465 = (FStar_Parser_DesugarEnv.push_rec_binding env (FStar_Parser_DesugarEnv.Binding_let (l)))
in ((_159_465), (FStar_Util.Inr (l))))
end)
...
| Some (t) -> begin
(let _159_472 = (FStar_Range.union_ranges t.FStar_Parser_AST.range def.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term (FStar_Parser_AST.Ascribed (((def), (t)))) _159_472 FStar_Parser_AST.Expr))
end)
in (
...
| Some (pat) -> begin
(let _159_484 = (let _159_483 = (FStar_Absyn_Util.bvd_to_exp x t)
in ((_159_483), ((((pat), (None), (body)))::[])))
in (FStar_Absyn_Syntax.mk_Exp_match _159_484 None body.FStar_Absyn_Syntax.pos))
end)
...
(let _159_497 = (let _159_496 = (let _159_495 = (desugar_exp env t1)
in (let _159_494 = (let _159_493 = (let _159_489 = (desugar_exp env t2)
in (((FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_constant (FStar_Const.Const_bool (true))) None t2.FStar_Parser_AST.range)), (None), (_159_489)))
in (let _159_492 = (let _159_491 = (let _159_490 = (desugar_exp env t3)
in (((FStar_Absyn_Util.withinfo (FStar_Absyn_Syntax.Pat_constant (FStar_Const.Const_bool (false))) None t3.FStar_Parser_AST.range)), (None), (_159_490)))
in (_159_491)::[])
in (_159_493)::_159_492))
in ((_159_495), (_159_494))))
in (FStar_Absyn_Syntax.mk_Exp_match _159_496))
in (FStar_All.pipe_left pos _159_497))
end
...
| Some (e) -> begin
(let _159_500 = (desugar_exp env e)
in Some (_159_500))
end)
in (
...
in (let _159_506 = (let _159_505 = (let _159_504 = (desugar_exp env e)
in (let _159_503 = (FStar_List.map desugar_branch branches)
in ((_159_504), (_159_503))))
in (FStar_Absyn_Syntax.mk_Exp_match _159_505))
in (FStar_All.pipe_left pos _159_506)))
end
| FStar_Parser_AST.Ascribed (e, t) -> begin
(let _159_512 = (let _159_511 = (let _159_510 = (desugar_exp env e)
in (let _159_509 = (desugar_typ env t)
in ((_159_510), (_159_509), (None))))
in (FStar_Absyn_Syntax.mk_Exp_ascribed _159_511))
in (FStar_All.pipe_left pos _159_512))
end
...
(match (xopt) with
| None -> begin
(let _159_523 = (let _159_522 = (let _159_521 = (FStar_Util.format1 "Field %s is missing" (FStar_Ident.text_of_lid f))
in ((_159_521), (top.FStar_Parser_AST.range)))
in FStar_Absyn_Syntax.Error (_159_522))
in (Prims.raise _159_523))
end
| Some (x) -> begin
(let _159_524 = (qfn fn)
in ((_159_524), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Project (((x), (f)))) x.FStar_Parser_AST.range x.FStar_Parser_AST.level))))
end)
end))))
in (
...
| None -> begin
(let _159_529 = (let _159_528 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _63_1542 -> (match (_63_1542) with
| (f, _63_1541) -> begin
(let _159_527 = (let _159_526 = (get_field None f)
in (FStar_All.pipe_left Prims.snd _159_526))
in ((_159_527), (FStar_Parser_AST.Nothing)))
end))))
in ((record.FStar_Parser_DesugarEnv.constrname), (_159_528)))
in FStar_Parser_AST.Construct (_159_529))
end
| Some (e) -> begin
(
...
let xterm = (let _159_531 = (let _159_530 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_159_530))
in (FStar_Parser_AST.mk_term _159_531 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
in (

let record = (let _159_534 = (let _159_533 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map (fun _63_1550 -> (match (_63_1550) with
| (f, _63_1549) -> begin
(get_field (Some (xterm)) f)
end))))
in ((None), (_159_533)))
in FStar_Parser_AST.Record (_159_534))
...
let e = (let _159_544 = (let _159_543 = (let _159_542 = (let _159_541 = (let _159_540 = (let _159_539 = (let _159_538 = (let _159_537 = (FStar_All.pipe_right record.FStar_Parser_DesugarEnv.fields (FStar_List.map Prims.fst))
in ((record.FStar_Parser_DesugarEnv.typename), (_159_537)))
in FStar_Absyn_Syntax.Record_ctor (_159_538))
in Some (_159_539))
in ((fv), (_159_540)))
in (FStar_Absyn_Syntax.mk_Exp_fvar _159_541 None e.FStar_Absyn_Syntax.pos))
in ((_159_542), (args)))
in (FStar_Absyn_Syntax.mk_Exp_app _159_543))
in (FStar_All.pipe_left pos _159_544))
...
in (let _159_551 = (let _159_550 = (let _159_549 = (FStar_Absyn_Util.fvar qual fieldname (FStar_Ident.range_of_lid f))
in (let _159_548 = (let _159_547 = (FStar_Absyn_Syntax.varg e)
in (_159_547)::[])
in ((_159_549), (_159_548))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_550))
in (FStar_All.pipe_left pos _159_551)))))
end))
end
...
let rec aux = (fun args t -> (match ((let _159_574 = (unparen t)
in _159_574.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (t, arg, imp) -> begin
(aux ((((arg), (imp)))::args) t)
end
| FStar_Parser_AST.Construct (l, args') -> begin
...
(let _159_575 = (desugar_exp env t)
in (FStar_All.pipe_right _159_575 FStar_Absyn_Util.b2t))
end)
end
...
(let _159_576 = (desugar_exp env t)
in (FStar_All.pipe_right _159_576 FStar_Absyn_Util.b2t))
end)
end
...
(let _159_579 = (flatten t1)
in (FStar_List.append _159_579 ((t2)::[])))
end
| _63_1658 -> begin
(t)::[]
end))
...
let targs = (let _159_582 = (flatten top)
in (FStar_All.pipe_right _159_582 (FStar_List.map (fun t -> (let _159_581 = (desugar_typ env t)
in (FStar_Absyn_Syntax.targ _159_581))))))
in (

let tup = (let _159_583 = (FStar_Absyn_Util.mk_tuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) _159_583))
in (FStar_All.pipe_left wpos (FStar_Absyn_Syntax.mk_Typ_app ((tup), (targs)))))))
end else begin
(let _159_589 = (let _159_588 = (let _159_587 = (let _159_586 = (FStar_Parser_AST.term_to_string t1)
in (FStar_Util.format1 "The operator \"*\" is resolved here as multiplication since \"%s\" is a term, although a type was expected" _159_586))
in ((_159_587), (top.FStar_Parser_AST.range)))
in FStar_Absyn_Syntax.Error (_159_588))
in (Prims.raise _159_589))
end
end
...
| None -> begin
(let _159_590 = (desugar_exp env top)
in (FStar_All.pipe_right _159_590 FStar_Absyn_Util.b2t))
end
| Some (l) -> begin
(

let args = (FStar_List.map (fun t -> (let _159_592 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_592))) args)
in (let _159_593 = (FStar_Absyn_Util.ftv l FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _159_593 args)))
end)
end
| FStar_Parser_AST.Tvar (a) -> begin
(let _159_594 = (FStar_Parser_DesugarEnv.fail_or2 (FStar_Parser_DesugarEnv.try_lookup_typ_var env) a)
in (FStar_All.pipe_left setpos _159_594))
end
| (FStar_Parser_AST.Var (l)) | (FStar_Parser_AST.Name (l)) when ((FStar_List.length l.FStar_Ident.ns) = (Prims.parse_int "0")) -> begin
(match ((FStar_Parser_DesugarEnv.try_lookup_typ_var env l.FStar_Ident.ident)) with
| Some (t) -> begin
...
| None -> begin
(let _159_595 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (FStar_All.pipe_left setpos _159_595))
end)
end
| (FStar_Parser_AST.Var (l)) | (FStar_Parser_AST.Name (l)) -> begin
(
...
in (let _159_596 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (FStar_All.pipe_left setpos _159_596)))
end
| FStar_Parser_AST.Construct (l, args) -> begin
(

let t = (let _159_597 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) l)
in (FStar_All.pipe_left setpos _159_597))
in (

let args = (FStar_List.map (fun _63_1694 -> (match (_63_1694) with
| (t, imp) -> begin
(let _159_599 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_599))
end)) args)
...
(match (pat) with
| Some (q) -> begin
(let _159_611 = (let _159_610 = (let _159_609 = (let _159_608 = (FStar_Absyn_Print.pat_to_string q)
in (FStar_Util.format1 "Pattern matching at the type level is not supported; got %s\n" _159_608))
in ((_159_609), (hd.FStar_Parser_AST.prange)))
in FStar_Absyn_Syntax.Error (_159_610))
in (Prims.raise _159_611))
end
| None -> begin
(
...
let rec aux = (fun args e -> (match ((let _159_616 = (unparen e)
in _159_616.FStar_Parser_AST.tm)) with
| FStar_Parser_AST.App (e, arg, imp) -> begin
(

let arg = (let _159_617 = (desugar_typ_or_exp env arg)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_617))
in (aux ((arg)::args) e))
end
| _63_1730 -> begin
(
...
(let _159_628 = (desugar_exp env f)
in (FStar_All.pipe_right _159_628 FStar_Absyn_Util.b2t))
end
...
(let _159_636 = (let _159_635 = (let _159_634 = (desugar_typ env t)
in (let _159_633 = (desugar_kind env k)
in ((_159_634), (_159_633))))
in (FStar_Absyn_Syntax.mk_Typ_ascribed' _159_635))
in (FStar_All.pipe_left wpos _159_636))
end
...
| None -> begin
(let _159_639 = (FStar_Absyn_Util.new_bvd (Some (top.FStar_Parser_AST.range)))
in ((env), (_159_639)))
end
| Some (x) -> begin
...
| (env, x) -> begin
(let _159_643 = (let _159_642 = (let _159_641 = (let _159_640 = (FStar_Absyn_Util.close_with_lam tparams t)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_640))
in (_159_641)::[])
in (FStar_List.append typs _159_642))
in ((env), ((FStar_List.append tparams ((((FStar_Util.Inr ((FStar_Absyn_Util.bvd_to_bvar_s x t))), (None)))::[]))), (_159_643)))
end))
end))
...
let tup = (let _159_644 = (FStar_Absyn_Util.mk_dtuple_lid (FStar_List.length targs) top.FStar_Parser_AST.range)
in (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) _159_644))
in (FStar_All.pipe_left wpos (FStar_Absyn_Syntax.mk_Typ_app ((tup), (targs)))))
end))
end
...
| (arg, _63_1853) -> begin
(match ((let _159_656 = (unparen arg)
in _159_656.FStar_Parser_AST.tm)) with
...
| FStar_Parser_AST.Name (tot) when (((tot.FStar_Ident.ident.FStar_Ident.idText = "Tot") && (not ((FStar_Parser_DesugarEnv.is_effect_name env FStar_Absyn_Const.effect_Tot_lid)))) && (let _159_657 = (FStar_Parser_DesugarEnv.current_module env)
in (FStar_Ident.lid_equals _159_657 FStar_Absyn_Const.prims_lid))) -> begin
(

let args = (FStar_List.map (fun _63_1887 -> (match (_63_1887) with
| (t, imp) -> begin
(let _159_659 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t imp) _159_659))
end)) args)
in (let _159_660 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.effect_Tot_lid FStar_Absyn_Syntax.kun)
in (FStar_Absyn_Util.mk_typ_app _159_660 args)))
end
| _63_1890 -> begin
(desugar_typ env t)
end)
...
| (head, args) -> begin
(match ((let _159_662 = (let _159_661 = (FStar_Absyn_Util.compress_typ head)
in _159_661.FStar_Absyn_Syntax.n)
in ((_159_662), (args)))) with
...
(let _159_669 = (let _159_668 = (let _159_667 = (let _159_666 = (let _159_665 = (FStar_Absyn_Syntax.mk_Exp_meta (FStar_Absyn_Syntax.Meta_desugared (((pat), (FStar_Absyn_Syntax.Meta_smt_pat)))))
in FStar_Util.Inr (_159_665))
in ((_159_666), (aq)))
in (_159_667)::[])
in (ens)::_159_668)
in (req)::_159_669)
...
(let _159_671 = (let _159_670 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "%s is not an effect" _159_670))
in (fail _159_671))
end
end)
end))
...
(let _159_673 = (let _159_672 = (FStar_Absyn_Print.typ_to_string t)
in (FStar_Util.format1 "%s is not an effect" _159_672))
in (fail _159_673))
end
end)
end))))))
...
(match ((let _159_685 = (FStar_Parser_DesugarEnv.qualify_lid env l)
in (FStar_Parser_DesugarEnv.find_kind_abbrev env _159_685))) with
| Some (l) -> begin
...
| [] -> begin
(let _159_696 = (let _159_695 = (let _159_694 = (desugar_kind env k)
in (((FStar_List.rev bs)), (_159_694)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _159_695))
in (FStar_All.pipe_left pos _159_696))
end
| (hd)::tl -> begin
(

let _63_2027 = (let _159_698 = (let _159_697 = (FStar_Parser_DesugarEnv.default_ml env)
in (desugar_binder _159_697 hd))
in (FStar_All.pipe_right _159_698 (as_binder env hd.FStar_Parser_AST.aqual)))
...
in (let _159_700 = (desugar_typ_or_exp env t)
in ((_159_700), (qual))))
end)) args)
...
let desugar_pats = (fun env pats -> (FStar_List.map (fun es -> (FStar_All.pipe_right es (FStar_List.map (fun e -> (let _159_736 = (desugar_typ_or_exp env e)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_736)))))) pats))
in (match (tk) with
| FStar_Util.Inl (Some (a), k) -> begin
(
...
| _63_2085 -> begin
(let _159_737 = (FStar_Absyn_Syntax.mk_Typ_meta (FStar_Absyn_Syntax.Meta_pattern (((body), (pats)))))
in (FStar_All.pipe_left setpos _159_737))
end)
in (

let body = (let _159_743 = (let _159_742 = (let _159_741 = (let _159_740 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_159_740)::[])
in ((_159_741), (body)))
in (FStar_Absyn_Syntax.mk_Typ_lam _159_742))
in (FStar_All.pipe_left pos _159_743))
in (let _159_747 = (let _159_746 = (FStar_Absyn_Util.ftv (FStar_Ident.set_lid_range qt b.FStar_Parser_AST.brange) FStar_Absyn_Syntax.kun)
in (let _159_745 = (let _159_744 = (FStar_Absyn_Syntax.targ body)
in (_159_744)::[])
in (FStar_Absyn_Util.mk_typ_app _159_746 _159_745)))
in (FStar_All.pipe_left setpos _159_747))))))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
(
...
let body = (let _159_753 = (let _159_752 = (let _159_751 = (let _159_750 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_159_750)::[])
in ((_159_751), (body)))
in (FStar_Absyn_Syntax.mk_Typ_lam _159_752))
in (FStar_All.pipe_left pos _159_753))
in (let _159_757 = (let _159_756 = (FStar_Absyn_Util.ftv (FStar_Ident.set_lid_range q b.FStar_Parser_AST.brange) FStar_Absyn_Syntax.kun)
in (let _159_755 = (let _159_754 = (FStar_Absyn_Syntax.targ body)
in (_159_754)::[])
in (FStar_Absyn_Util.mk_typ_app _159_756 _159_755)))
in (FStar_All.pipe_left setpos _159_757))))))
end))
end
| _63_2104 -> begin
(FStar_All.failwith "impossible")
...
let body = (let _159_772 = (q ((rest), (pats), (body)))
in (let _159_771 = (FStar_Range.union_ranges b'.FStar_Parser_AST.brange body.FStar_Parser_AST.range)
in (FStar_Parser_AST.mk_term _159_772 _159_771 FStar_Parser_AST.Formula)))
in (let _159_773 = (q (((b)::[]), ([]), (body)))
in (FStar_Parser_AST.mk_term _159_773 f.FStar_Parser_AST.range FStar_Parser_AST.Formula))))
end
| _63_2118 -> begin
(FStar_All.failwith "impossible")
end))
in (match ((let _159_774 = (unparen f)
in _159_774.FStar_Parser_AST.tm)) with
...
let args = (FStar_List.map (fun t -> (let _159_776 = (desugar_typ_or_exp env t)
in (FStar_All.pipe_left (arg_withimp_t FStar_Parser_AST.Nothing) _159_776))) args)
in (
...
(let _159_780 = (FStar_Absyn_Util.ftv (FStar_Ident.set_lid_range conn f.FStar_Parser_AST.range) FStar_Absyn_Syntax.kun)
in (let _159_779 = (FStar_List.map (fun x -> (let _159_778 = (desugar_formula env x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_778))) args)
in (FStar_Absyn_Util.mk_typ_app _159_780 _159_779)))
end
| _63_2149 -> begin
if (is_type env f) then begin
(desugar_typ env f)
end else begin
(let _159_781 = (desugar_exp env f)
in (FStar_All.pipe_right _159_781 FStar_Absyn_Util.b2t))
end
end)
end
| FStar_Parser_AST.If (f1, f2, f3) -> begin
(let _159_785 = (FStar_Absyn_Util.ftv (FStar_Ident.set_lid_range FStar_Absyn_Const.ite_lid f.FStar_Parser_AST.range) FStar_Absyn_Syntax.kun)
in (let _159_784 = (FStar_List.map (fun x -> (match ((desugar_typ_or_exp env x)) with
| FStar_Util.Inl (t) -> begin
(FStar_Absyn_Syntax.targ t)
end
| FStar_Util.Inr (v) -> begin
(let _159_783 = (FStar_Absyn_Util.b2t v)
in (FStar_All.pipe_left FStar_Absyn_Syntax.targ _159_783))
end)) ((f1)::(f2)::(f3)::[]))
in (FStar_Absyn_Util.mk_typ_app _159_785 _159_784)))
end
...
in (let _159_787 = (push_quant (fun x -> FStar_Parser_AST.QForall (x)) binders pats body)
in (desugar_formula env _159_787)))
end
| FStar_Parser_AST.QExists ((_1)::(_2)::_3, pats, body) -> begin
(

let binders = (_1)::(_2)::_3
in (let _159_789 = (push_quant (fun x -> FStar_Parser_AST.QExists (x)) binders pats body)
in (desugar_formula env _159_789)))
end
...
(let _159_790 = (desugar_exp env f)
in (FStar_All.pipe_left FStar_Absyn_Util.b2t _159_790))
end
end)))))))
...
(let _159_795 = (desugar_type_binder env b)
in FStar_Util.Inl (_159_795))
end else begin
(let _159_796 = (desugar_exp_binder env b)
in FStar_Util.Inr (_159_796))
end)
...
(let _159_803 = (desugar_typ env t)
in ((Some (x)), (_159_803)))
end
| FStar_Parser_AST.TVariable (t) -> begin
(let _159_804 = (FStar_Parser_DesugarEnv.fail_or2 (FStar_Parser_DesugarEnv.try_lookup_typ_var env) t)
in ((None), (_159_804)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _159_805 = (desugar_typ env t)
in ((None), (_159_805)))
end
...
(let _159_810 = (desugar_kind env t)
in ((Some (x)), (_159_810)))
end
| FStar_Parser_AST.NoName (t) -> begin
(let _159_811 = (desugar_kind env t)
in ((None), (_159_811)))
end
| FStar_Parser_AST.TVariable (x) -> begin
((Some (x)), ((
...
in (let _159_820 = (aux tps k)
in (FStar_All.pipe_right _159_820 FStar_Absyn_Util.name_binders))))
...
let binders = (let _159_841 = (let _159_840 = (let _159_839 = (let _159_838 = (let _159_837 = (FStar_Absyn_Util.ftv t FStar_Absyn_Syntax.kun)
in (let _159_836 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in ((_159_837), (_159_836))))
in (FStar_Absyn_Syntax.mk_Typ_app' _159_838 None p))
in (FStar_All.pipe_left FStar_Absyn_Syntax.null_v_binder _159_839))
in (_159_840)::[])
in (FStar_List.append imp_binders _159_841))
in (

let disc_type = (let _159_844 = (let _159_843 = (let _159_842 = (FStar_Absyn_Util.ftv FStar_Absyn_Const.bool_lid FStar_Absyn_Syntax.ktype)
in (FStar_Absyn_Util.total_comp _159_842 p))
in ((binders), (_159_843)))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_844 None p))
in (FStar_All.pipe_right datas (FStar_List.map (fun d -> (

let disc_name = (FStar_Absyn_Util.mk_discriminator d)
in (let _159_847 = (let _159_846 = (quals ((FStar_Absyn_Syntax.Logic)::(FStar_Absyn_Syntax.Discriminator (d))::[]))
in ((disc_name), (disc_type), (_159_846), ((FStar_Ident.range_of_lid disc_name))))
in FStar_Absyn_Syntax.Sig_val_decl (_159_847)))))))))))))
...
let projectee = (let _159_858 = (FStar_Absyn_Syntax.mk_ident (("projectee"), (p)))
in (let _159_857 = (FStar_Absyn_Util.genident (Some (p)))
in {FStar_Absyn_Syntax.ppname = _159_858; FStar_Absyn_Syntax.realname = _159_857}))
in (
...
let arg_typ = (let _159_861 = (let _159_860 = (FStar_Absyn_Util.ftv tc FStar_Absyn_Syntax.kun)
in (let _159_859 = (FStar_Absyn_Util.args_of_non_null_binders binders)
in ((_159_860), (_159_859))))
in (FStar_Absyn_Syntax.mk_Typ_app' _159_861 None p))
...
in (let _159_871 = (let _159_870 = (let _159_869 = (let _159_868 = (let _159_867 = (let _159_866 = (let _159_865 = (FStar_Absyn_Util.fvar None disc_name p)
in (let _159_864 = (let _159_863 = (let _159_862 = (FStar_Absyn_Util.bvar_to_exp x)
in (FStar_All.pipe_left FStar_Absyn_Syntax.varg _159_862))
in (_159_863)::[])
in ((_159_865), (_159_864))))
in (FStar_Absyn_Syntax.mk_Exp_app _159_866 None p))
in (FStar_Absyn_Util.b2t _159_867))
in ((x), (_159_868)))
in (FStar_Absyn_Syntax.mk_Typ_refine _159_869 None p))
in (FStar_All.pipe_left (FStar_Absyn_Util.bvd_to_bvar_s projectee) _159_870))
in (FStar_All.pipe_left FStar_Absyn_Syntax.v_binder _159_871))))
end)
in (
...
let subst = (let _159_879 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i f -> (match ((Prims.fst f)) with
...
let proj = (let _159_876 = (let _159_875 = (FStar_Absyn_Util.ftv field_name FStar_Absyn_Syntax.kun)
in ((_159_875), ((arg)::[])))
in (FStar_Absyn_Syntax.mk_Typ_app _159_876 None p))
...
let proj = (let _159_878 = (let _159_877 = (FStar_Absyn_Util.fvar None field_name p)
in ((_159_877), ((arg)::[])))
in (FStar_Absyn_Syntax.mk_Exp_app _159_878 None p))
in (FStar_Util.Inr (((x.FStar_Absyn_Syntax.v), (proj))))::[])
end))
end))))
in (FStar_All.pipe_right _159_879 FStar_List.flatten))
in (

let ntps = (FStar_List.length tps)
in (

let all_params = (let _159_881 = (FStar_All.pipe_right tps (FStar_List.map (fun _63_2363 -> (match (_63_2363) with
| (b, _63_2362) -> begin
((b), (Some (imp_tag)))
end))))
in (FStar_List.append _159_881 formals))
in (let _159_911 = (FStar_All.pipe_right formals (FStar_List.mapi (fun i ax -> (match ((Prims.fst ax)) with
| FStar_Util.Inl (a) -> begin
(
...
let kk = (let _159_885 = (let _159_884 = (FStar_Absyn_Util.subst_kind subst a.FStar_Absyn_Syntax.sort)
in ((binders), (_159_884)))
in (FStar_Absyn_Syntax.mk_Kind_arrow _159_885 p))
...
let t = (let _159_888 = (let _159_887 = (let _159_886 = (FStar_Absyn_Util.subst_typ subst x.FStar_Absyn_Syntax.sort)
in (FStar_Absyn_Util.total_comp _159_886 p))
in ((binders), (_159_887)))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_888 None p))
in (
...
let impl = if (((let _159_891 = (FStar_Parser_DesugarEnv.current_module env)
in (FStar_Ident.lid_equals FStar_Absyn_Const.prims_lid _159_891)) || (fvq <> FStar_Absyn_Syntax.Data_ctor)) || (let _159_893 = (let _159_892 = (FStar_Parser_DesugarEnv.current_module env)
in _159_892.FStar_Ident.str)
in (FStar_Options.dont_gen_projectors _159_893))) then begin
[]
end else begin
(
...
let arg_pats = (let _159_908 = (FStar_All.pipe_right all_params (FStar_List.mapi (fun j by -> (match (by) with
| (FStar_Util.Inl (_63_2396), imp) -> begin
if (j < ntps) then begin
[]
end else begin
(let _159_901 = (let _159_900 = (let _159_899 = (let _159_898 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.kun)
in FStar_Absyn_Syntax.Pat_tvar (_159_898))
in (pos _159_899))
in ((_159_900), ((as_imp imp))))
in (_159_901)::[])
end
end
| (FStar_Util.Inr (_63_2401), imp) -> begin
if ((i + ntps) = j) then begin
(let _159_903 = (let _159_902 = (pos (FStar_Absyn_Syntax.Pat_var (projection)))
in ((_159_902), ((as_imp imp))))
in (_159_903)::[])
end else begin
if (j < ntps) then begin
[]
end else begin
(let _159_907 = (let _159_906 = (let _159_905 = (let _159_904 = (FStar_Absyn_Util.gen_bvar FStar_Absyn_Syntax.tun)
in FStar_Absyn_Syntax.Pat_wild (_159_904))
in (pos _159_905))
in ((_159_906), ((as_imp imp))))
in (_159_907)::[])
end
end
end))))
in (FStar_All.pipe_right _159_908 FStar_List.flatten))
in (

let pat = (let _159_910 = (FStar_All.pipe_right (FStar_Absyn_Syntax.Pat_cons ((((FStar_Absyn_Util.fv lid)), (Some (fvq)), (arg_pats)))) pos)
in (let _159_909 = (FStar_Absyn_Util.bvar_to_exp projection)
in ((_159_910), (None), (_159_909))))
in (
...
in (FStar_All.pipe_right _159_911 FStar_List.flatten))))))))))))))
end))
...
(let _159_931 = (let _159_930 = (FStar_Ident.lid_of_ids ((x)::[]))
in FStar_Parser_AST.Var (_159_930))
in (FStar_Parser_AST.mk_term _159_931 x.FStar_Ident.idRange FStar_Parser_AST.Expr))
end
...
in (FStar_List.fold_left (fun out b -> (let _159_944 = (let _159_943 = (let _159_942 = (binder_to_term b)
in ((out), (_159_942), ((imp_of_aqual b))))
in FStar_Parser_AST.App (_159_943))
in (FStar_Parser_AST.mk_term _159_944 out.FStar_Parser_AST.range out.FStar_Parser_AST.level))) t binders)))
in (
...
let result = (let _159_950 = (let _159_949 = (let _159_948 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_159_948))
in (FStar_Parser_AST.mk_term _159_949 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _159_950 parms))
in (

let constrTyp = (FStar_Parser_AST.mk_term (FStar_Parser_AST.Product (((mfields), ((with_constructor_effect result))))) id.FStar_Ident.idRange FStar_Parser_AST.Type)
in (let _159_952 = (FStar_All.pipe_right fields (FStar_List.map (fun _63_2546 -> (match (_63_2546) with
| (x, _63_2543, _63_2545) -> begin
(FStar_Parser_DesugarEnv.qualify env x)
end))))
in ((FStar_Parser_AST.TyconVariant (((id), (parms), (kopt), ((((constrName), (Some (constrTyp)), (None), (false)))::[])))), (_159_952)))))))
end
| _63_2548 -> begin
(FStar_All.failwith "impossible")
end))
...
let tconstr = (let _159_963 = (let _159_962 = (let _159_961 = (FStar_Ident.lid_of_ids ((id)::[]))
in FStar_Parser_AST.Var (_159_961))
in (FStar_Parser_AST.mk_term _159_962 id.FStar_Ident.idRange FStar_Parser_AST.Type))
in (apply_binders _159_963 binders))
in (
...
let _63_2601 = (let _159_973 = (FStar_Range.string_of_range rng)
in (let _159_972 = (let _159_971 = (let _159_970 = (FStar_Absyn_Util.lids_of_sigelt se)
in (FStar_All.pipe_right _159_970 (FStar_List.map FStar_Absyn_Print.sli)))
in (FStar_All.pipe_right _159_971 (FStar_String.concat ", ")))
...
in (let _159_979 = (let _159_978 = (FStar_Parser_DesugarEnv.qualify env id)
in (let _159_977 = (FStar_All.pipe_right quals (FStar_List.filter (fun _63_24 -> (match (_63_24) with
| FStar_Absyn_Syntax.Effect -> begin
false
end
| _63_2633 -> begin
...
in ((_159_978), (typars), (c), (_159_977), (rng))))
in FStar_Absyn_Syntax.Sig_effect_abbrev (_159_979)))
end else begin
(

let t = (desugar_typ env' t)
in (let _159_981 = (let _159_980 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_980), (typars), (k), (t), (quals), (rng)))
in FStar_Absyn_Syntax.Sig_typ_abbrev (_159_981)))
end
in (
...
let _63_2758 = (let _159_997 = (FStar_All.pipe_right constrs (FStar_List.map (fun _63_2740 -> (match (_63_2740) with
...
let t = (let _159_992 = (FStar_Parser_DesugarEnv.default_total env_tps)
in (let _159_991 = (close env_tps t)
in (desugar_typ _159_992 _159_991)))
in (
...
in (let _159_996 = (let _159_995 = (let _159_994 = (FStar_All.pipe_right t FStar_Absyn_Util.name_function_binders)
in ((name), (_159_994), (tycon), (quals), (mutuals), (rng)))
in FStar_Absyn_Syntax.Sig_datacon (_159_995))
in ((name), (_159_996)))))))
end))))
in (FStar_All.pipe_left FStar_List.split _159_997))
...
let bundle = (let _159_999 = (let _159_998 = (FStar_List.collect FStar_Absyn_Util.lids_of_sigelt sigelts)
in ((sigelts), (quals), (_159_998), (rng)))
in FStar_Absyn_Syntax.Sig_bundle (_159_999))
in (
...
| (env, a) -> begin
(let _159_1008 = (let _159_1007 = (FStar_Absyn_Syntax.t_binder (FStar_Absyn_Util.bvd_to_bvar_s a k))
in (_159_1007)::binders)
in ((env), (_159_1008)))
end))
end
| FStar_Util.Inr (Some (x), t) -> begin
...
| (env, x) -> begin
(let _159_1010 = (let _159_1009 = (FStar_Absyn_Syntax.v_binder (FStar_Absyn_Util.bvd_to_bvar_s x t))
in (_159_1009)::binders)
in ((env), (_159_1010)))
end))
end
| _63_2806 -> begin
...
(let _159_1028 = (FStar_Parser_DesugarEnv.push_module_abbrev env x l)
in ((_159_1028), ([])))
end
...
in (let _159_1030 = (trans_quals qual)
in (desugar_tycon env d.FStar_Parser_AST.drange _159_1030 tcs)))
end
| FStar_Parser_AST.ToplevelLet (quals, isrec, lets) -> begin
(match ((let _159_1032 = (let _159_1031 = (desugar_exp_maybe_top true env (FStar_Parser_AST.mk_term (FStar_Parser_AST.Let (((isrec), (lets), ((FStar_Parser_AST.mk_term (FStar_Parser_AST.Const (FStar_Const.Const_unit)) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))))) d.FStar_Parser_AST.drange FStar_Parser_AST.Expr))
in (FStar_All.pipe_left FStar_Absyn_Util.compress_exp _159_1031))
in _159_1032.FStar_Absyn_Syntax.n)) with
...
in (let _159_1038 = (let _159_1037 = (let _159_1036 = (let _159_1035 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_1035), (f), ((FStar_Absyn_Syntax.Assumption)::[]), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Sig_assume (_159_1036))
in (_159_1037)::[])
in ((env), (_159_1038))))
end
...
let t = (let _159_1039 = (close_fun env t)
in (desugar_typ env _159_1039))
in (

let quals = if (env.FStar_Parser_DesugarEnv.iface && env.FStar_Parser_DesugarEnv.admitted_iface) then begin
(let _159_1040 = (trans_quals quals)
in (FStar_Absyn_Syntax.Assumption)::_159_1040)
end else begin
(trans_quals quals)
end
in (

let se = (let _159_1042 = (let _159_1041 = (FStar_Parser_DesugarEnv.qualify env id)
in ((_159_1041), (t), (quals), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Sig_val_decl (_159_1042))
in (
...
let t = (let _159_1047 = (let _159_1046 = (let _159_1043 = (FStar_Absyn_Syntax.null_v_binder t)
in (_159_1043)::[])
in (let _159_1045 = (let _159_1044 = (FStar_Parser_DesugarEnv.fail_or env (FStar_Parser_DesugarEnv.try_lookup_typ_name env) FStar_Absyn_Const.exn_lid)
in (FStar_Absyn_Syntax.mk_Total _159_1044))
in ((_159_1046), (_159_1045))))
in (FStar_Absyn_Syntax.mk_Typ_fun _159_1047 None d.FStar_Parser_AST.drange))
in (
...
| None -> begin
(let _159_1052 = (let _159_1051 = (let _159_1050 = (let _159_1049 = (let _159_1048 = (FStar_Absyn_Print.sli eff.FStar_Absyn_Syntax.v)
in (Prims.strcat _159_1048 " not found"))
in (Prims.strcat "Effect " _159_1049))
in ((_159_1050), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1051))
in (Prims.raise _159_1052))
end
| Some (ed) -> begin
(
...
let ed = (let _159_1070 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _159_1069 = (trans_quals quals)
in (let _159_1068 = (FStar_Absyn_Util.subst_kind subst ed.FStar_Absyn_Syntax.signature)
in (let _159_1067 = (sub ed.FStar_Absyn_Syntax.ret)
in (let _159_1066 = (sub ed.FStar_Absyn_Syntax.bind_wp)
in (let _159_1065 = (sub ed.FStar_Absyn_Syntax.bind_wlp)
in (let _159_1064 = (sub ed.FStar_Absyn_Syntax.if_then_else)
in (let _159_1063 = (sub ed.FStar_Absyn_Syntax.ite_wp)
in (let _159_1062 = (sub ed.FStar_Absyn_Syntax.ite_wlp)
in (let _159_1061 = (sub ed.FStar_Absyn_Syntax.wp_binop)
in (let _159_1060 = (sub ed.FStar_Absyn_Syntax.wp_as_type)
in (let _159_1059 = (sub ed.FStar_Absyn_Syntax.close_wp)
in (let _159_1058 = (sub ed.FStar_Absyn_Syntax.close_wp_t)
in (let _159_1057 = (sub ed.FStar_Absyn_Syntax.assert_p)
in (let _159_1056 = (sub ed.FStar_Absyn_Syntax.assume_p)
in (let _159_1055 = (sub ed.FStar_Absyn_Syntax.null_wp)
in (let _159_1054 = (sub ed.FStar_Absyn_Syntax.trivial)
in {FStar_Absyn_Syntax.mname = _159_1070; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = _159_1069; FStar_Absyn_Syntax.signature = _159_1068; FStar_Absyn_Syntax.ret = _159_1067; FStar_Absyn_Syntax.bind_wp = _159_1066; FStar_Absyn_Syntax.bind_wlp = _159_1065; FStar_Absyn_Syntax.if_then_else = _159_1064; FStar_Absyn_Syntax.ite_wp = _159_1063; FStar_Absyn_Syntax.ite_wlp = _159_1062; FStar_Absyn_Syntax.wp_binop = _159_1061; FStar_Absyn_Syntax.wp_as_type = _159_1060; FStar_Absyn_Syntax.close_wp = _159_1059; FStar_Absyn_Syntax.close_wp_t = _159_1058; FStar_Absyn_Syntax.assert_p = _159_1057; FStar_Absyn_Syntax.assume_p = _159_1056; FStar_Absyn_Syntax.null_wp = _159_1055; FStar_Absyn_Syntax.trivial = _159_1054})))))))))))))))))
in (
...
| _63_2998 -> begin
(let _159_1074 = (let _159_1073 = (let _159_1072 = (let _159_1071 = (FStar_Absyn_Print.typ_to_string head)
in (Prims.strcat _159_1071 " is not an effect"))
in ((_159_1072), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1073))
in (Prims.raise _159_1074))
end)
end)))
end)))
end
...
| (env, ses) -> begin
(let _159_1078 = (let _159_1077 = (FStar_List.hd ses)
in (_159_1077)::out)
in ((env), (_159_1078)))
end))
end)) ((env), ([]))))
...
let lookup = (fun s -> (match ((let _159_1082 = (let _159_1081 = (FStar_Absyn_Syntax.mk_ident ((s), (d.FStar_Parser_AST.drange)))
in (FStar_Parser_DesugarEnv.qualify env _159_1081))
in (FStar_Parser_DesugarEnv.try_resolve_typ_abbrev env _159_1082))) with
| None -> begin
...
let ed = (let _159_1098 = (FStar_Parser_DesugarEnv.qualify env0 eff_name)
in (let _159_1097 = (trans_quals quals)
in (let _159_1096 = (lookup "return")
in (let _159_1095 = (lookup "bind_wp")
in (let _159_1094 = (lookup "bind_wlp")
in (let _159_1093 = (lookup "if_then_else")
in (let _159_1092 = (lookup "ite_wp")
in (let _159_1091 = (lookup "ite_wlp")
in (let _159_1090 = (lookup "wp_binop")
in (let _159_1089 = (lookup "wp_as_type")
in (let _159_1088 = (lookup "close_wp")
in (let _159_1087 = (lookup "close_wp_t")
in (let _159_1086 = (lookup "assert_p")
in (let _159_1085 = (lookup "assume_p")
in (let _159_1084 = (lookup "null_wp")
in (let _159_1083 = (lookup "trivial")
in {FStar_Absyn_Syntax.mname = _159_1098; FStar_Absyn_Syntax.binders = binders; FStar_Absyn_Syntax.qualifiers = _159_1097; FStar_Absyn_Syntax.signature = eff_k; FStar_Absyn_Syntax.ret = _159_1096; FStar_Absyn_Syntax.bind_wp = _159_1095; FStar_Absyn_Syntax.bind_wlp = _159_1094; FStar_Absyn_Syntax.if_then_else = _159_1093; FStar_Absyn_Syntax.ite_wp = _159_1092; FStar_Absyn_Syntax.ite_wlp = _159_1091; FStar_Absyn_Syntax.wp_binop = _159_1090; FStar_Absyn_Syntax.wp_as_type = _159_1089; FStar_Absyn_Syntax.close_wp = _159_1088; FStar_Absyn_Syntax.close_wp_t = _159_1087; FStar_Absyn_Syntax.assert_p = _159_1086; FStar_Absyn_Syntax.assume_p = _159_1085; FStar_Absyn_Syntax.null_wp = _159_1084; FStar_Absyn_Syntax.trivial = _159_1083}))))))))))))))))
in (
...
| None -> begin
(let _159_1105 = (let _159_1104 = (let _159_1103 = (let _159_1102 = (let _159_1101 = (FStar_Absyn_Print.sli l)
in (Prims.strcat _159_1101 " not found"))
in (Prims.strcat "Effect name " _159_1102))
in ((_159_1103), (d.FStar_Parser_AST.drange)))
in FStar_Absyn_Syntax.Error (_159_1104))
in (Prims.raise _159_1105))
end
| Some (l) -> begin
l
end))
...
let lift = (let _159_1108 = (non_reifiable l.FStar_Parser_AST.lift_op)
in (desugar_typ env _159_1108))
in (
...
(let _159_1133 = (let _159_1132 = (let _159_1130 = (FStar_Absyn_Syntax.lid_of_ids mname.FStar_Ident.ns)
in FStar_Parser_AST.Open (_159_1130))
in (let _159_1131 = (FStar_Absyn_Syntax.range_of_lid mname)
in (FStar_Parser_AST.mk_decl _159_1132 _159_1131 None)))
in (_159_1133)::d)
end else begin
d
end
...
(let _159_1135 = (FStar_Parser_DesugarEnv.prepare_module_or_interface true admitted env mname)
in (let _159_1134 = (open_ns mname decls)
in ((_159_1135), (mname), (_159_1134), (true))))
end
| FStar_Parser_AST.Module (mname, decls) -> begin
(let _159_1137 = (FStar_Parser_DesugarEnv.prepare_module_or_interface false false env mname)
in (let _159_1136 = (open_ns mname decls)
in ((_159_1137), (mname), (_159_1136), (false))))
end)
...
(let _159_1148 = (FStar_Absyn_Print.modul_to_string modul)
in (FStar_Util.print1 "%s\n" _159_1148))
end else begin
()
end
in (let _159_1149 = if pop_when_done then begin
